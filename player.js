...
function HDVBPlayer(options) {
	var o = {
		...
		u: {
			...
			control_line: {
				...
				colorload: 'ffffff',
				colorover: 'ffffff',
				buffer: { on: 0, color: 'ffffff', a: 0.5 },
				position: 'bottom',
				margin: '0 15 50 15',
				handle: 1,
				bgpadding: '5 0 5 0',
			...
			control_full: {
				...
				icon2:
					"<svg width='18' height='18'><path d='M1 12h3.6l-4 4L2 17.4l4-4V17h2v-7H1zM16 .6l-4 4V1h-2v7h7V6h-3.6l4-4z' fill='#ffffff'></path></svg>",
				action: 'fullscreen',
			...
			eventlisteners: 0,
			eventstrackervast: 0,
			hotkey: { seeksides: 1, nums: 0, m: 0, volumewheelfull: 0 },
			hls: 0,
			hlsvastwait: 0,
			hlsdvrtime: 0,
			hlsaudio: 1,
		...
		u9: '',
		y: 'xx???x=xxx???=',
		p: { x: ['preroll', 'pauseroll', 'postroll', 'midroll'] },
		isflash: -1,
		brand: 'HDVB',
		brandurl: '//hdvb.cc',
		motions: [],
	...
	'object' == typeof o_params &&
		Object.keys(o_params.u).length > 0 &&
		Object.keys(o_params.u).forEach(t => {
			'playlist' == t
				? Object.keys(o_params.u.playlist).forEach(t => {
						o.u.playlist[t] = o_params.u.playlist[t]
				  })
				: (o.u[t] = o_params.u[t])
		}),
		'playlist' in o.u && ((o.u.playlist.on = 1), (o.u.playlist.dontplay = 1)),
	...
	function getVastUrl(t, e) {
		...
		return (
			'masterHash' in o.p &&
				'host' in o.p &&
				(n = `${o.p.masterHash}|${o.p.host}`),
			// (n = `${o.p.masterHash}|${e}|${o.p.host}`),
			`${i[0]}${s}cp.host=${n}&cp.ip=${
				'userIp' in o.p ? o.p.userIp : 'VASTIP_Fail'
			}&cp.token=${o.p.movie}&cp.domain=${o.p.host}#${i[1]}`
		)
	}
	customParams.map(t => {
		t in options &&
			('host' != t ||
				('' != options[t] && null !== options[t]) ||
				(options[t] = location.hostname),
			(o.p[t] = options[t]))
	})
	let pointsArr = []
	if ('rek' in options) {
		...
		if ('midroll' in options.rek)
			if (options.rek.midroll.length > 0) {
				...
				options.rek.midroll.map(e => {
					...
					pointsArr.push({ time: i, width: 2 }),
						(o.u['partnermidroll_' + t] = 'hdvb_midroll_' + t),
						(o.u['partnermidrolltimes' + (t > 1 ? t : '')] = e.time),
						(o.u['midroll' + (t > 1 ? t : '')] =
							'prthdvb_midroll_' + t + '_' + e.url),
						t > 1 &&
							((o.u.partnermidrollor = 'and'), (o.u.vast_midroll_limit = t)),
						t++
				})
			} else o.u.midrolls = 0
		else o.u.midrolls = 0
		'pausebanner' in options.rek && options.rek.pausebanner.show
			? (o.u.pausebanner = {
					class: options.rek.pausebanner?.class,
					key: options.rek.pausebanner.key,
					script: options.rek.pausebanner.script,
			  })
			: (o.u.banner = 0),
			'endtag' in options.rek
				? ((o.u.etag = 1), (o.u.endtag = options.rek.endtag))
				: (o.u.etag = 0),
			'starttag' in options.rek
				? ((o.u.stag = 1), (o.u.starttag = options.rek.starttag))
				: (o.u.stag = 0),
		...
		if (1 == v.vast && exist2(o.p)) {
					...
					if (exist(n) && '' != n) {
						...
						if (exist(a)) {
							...
							if (
								...
								'or50' == v['partner' + t.x[e] + 'or' + i] &&
									((a[r] = a[r] + '[50%]'),
									(v['partner' + t.x[e] + 'or' + i] = 'or')),
									'stop' == v['partner' + t.x[e] + 'or' + i] &&
										((a[r] = a[r] + '[stop]'),
										(v['partner' + t.x[e] + 'or' + i] = 'and'))
								var u =
									'prt' +
									(exist(a.cpm) ? 'cpm' + a.cpm : '') +
									(0 == n.indexOf('myvast')
										? n
										: a.title.substr(0, a.title.indexOf(' '))) +
									(exist(a.imp) ? '[imp]' + a.imp : '') +
									'_' +
									(exist(a.pimp) ? '[pimp]' + a.pimp + '**' : '') +
									a[r]
								'midroll' == t.x[e]
									? (v['midroll' + (1 == i ? '' : i)] = u)
									: (v[t.x[e]] +=
			...
			if (1 == v.midrolls)
				for (var p = 1; p < 8; p++) {
					var f = 1 == p ? '' : p
					if (
						'string' == typeof v['midroll' + f] &&
						'prt' == v['midroll' + f].substr(0, 3) &&
						exist(v['partnermidrolltimes' + f]) &&
						exist(v['midroll' + f]) &&
						'' != v['partnermidrolltimes' + f]
					) {
						!o.midrollo && (o.midrollo = [])
						var h = v['partnermidrolltimes' + f].split(',')
						for (e = 0; e < h.length; e++) {
							for (var g = !1, m = 0; m < o.midrollo.length; m++)
								o.midrollo[m].time == trim(h[e]) &&
									((o.midrollo[m].vast =
										o.midrollo[m].vast +
										' ' +
										v.partnermidrollor +
									...
									(g = !0))
							!g &&
								o.midrollo.push({ time: trim(h[e]), vast: v['midroll' + f] })
						}
					}
				}
		}
	...
	function fd0(t) {
		if (-1 == t.indexOf('.')) {
			for (t = t.substr(1), s2 = '', i = 0; i < t.length; i += 3)
				s2 += '%u0' + t.slice(i, i + 3)
			t = unescape(s2)
		}
		return t
	...
	var Alert = function () {
		...
		o.frame.appendChild(e),
			...
			(this.txt = function (o, i) {
				;(e.innerHTML = o),
					show2(e),
					css(t, { height: e.offsetHeight, display: 'block' }),
					(t.style.zIndex = '1005')
				for (var s = 0; s < e.getElementsByTagName('a').length; s++)
					e.getElementsByTagName('a')[s].style.color = '#fff'
				i && setTimeout(this.close, 1e3 * i), (e.style.zIndex = '1006')
			}),
			(this.close = function () {
				hide2(e), hide2(t)
			})
	...
	'object' == typeof o_params &&
		Object.keys(o_params.v).length > 0 &&
		Object.keys(o_params.v).forEach(t => {
	...
	var VastLoader = function (preload) {
				...
				if ((preload && _preloaded.push(x), '' != x)) {
					...
					if (
						...
						if (
							...
							return log('empty vast url'), void ErrorLoad()
			...
			function ChX(t) {
				if (t) {
					o.vast_remove &&
						o.vast_remove.indexOf(t) > -1 &&
						(log('VAST removed'), o.actions.VastError(), (t = ''))
					for (var e = 0; e < no.length; e++)
						t.indexOf('[no_' + no[e] + ']') > -1 &&
							((t = t.replace('[no_' + no[e] + ']', '')),
							o.system[no[e]] &&
								(log('VAST no ' + no[e]), o.actions.VastError(), (t = '')))
				...
				if (vastUrl.indexOf('abfn=') > -1)
					try {
						...
						if (y) {
							...
							y2 &&
								(log('VAST abfn'), (vast.abfn = vastUrl), LoadXml(y2), (z = !0))
						}
					} catch (t) {}
				z ||
			...
			function Parsing(e) {
				...
				if (null == i || '' == vastType)
					...
					if (b.length > 1) {
						...
						for (var m in ((o['wrapper_events' + y] = []), vast.events))
							vast.events.hasOwnProperty(m) &&
								(o['wrapper_events' + y][m] = vast.events[m].slice())
						var x = [],
							_ = []
						for (c = 1; c < b.length; c++) {
							...
							if (w) {
								if (t('VASTAdTagURI', w))
									'' !=
										(k =
											...
											y +
											'</PjsWrapper>' +
											new XMLSerializer().serializeToString(b[c]) +
											'</VAST>') &&
										(('true' != w.getAttribute('allowMultipleAds') &&
											1 != v.vast_adsfalland) ||
								...
								var k =
									...
									'</VAST>'
								1 == v.vast_adsfalland ||
								'true' == b[c].getAttribute('allowMultipleAds')
									? x.push(k)
									: _.push(k)
							}
						}
						x.length > 0 && o.actions.VastInsertAnd(x, _x),
							_.length > 0 && o.actions.VastInsertOr(_, _x)
					}
					if (!a) {
						var S = g('Ad', s),
							T = g('InLine', S),
						...
						if (
							...
							;(vast.isWrapper = !0),
								...
								(vast.wrapper = t('VASTAdTagURI', T))
							var O = P.getAttribute('minVisibility')
							O &&
								O > 0 &&
								exist(o.visibility) &&
								o.visibility < O &&
								(log('Wrapper visibility', o.visibility + '<' + O),
								(vast.file = void 0),
								(vast.isWrapper = !1))
						}
						var C = new XMLSerializer().serializeToString(s.documentElement)
						if ((js('vast_xml', escape(C)), T)) {
							var E, L
							if (
								((o.vast_adid +=
									('' != o.vast_adid ? ' -> ' : '') + S.getAttribute('id')),
								(vast.adsystem = t('AdSystem', T)),
								(E = g('Creatives', T)),
								_Event('Impression', T),
								_Event('Impress', T),
								...
								var A = E.getElementsByTagName('Creative')
								for (c = 0; c < A.length; c++) {
									L = g('Linear', A[c])
									var I = g('NonLinearAds', A[c])
									if (I)
										for (
											var j = I.getElementsByTagName('NonLinear'), M = 0;
											M < j.length;
											M++
										)
											OverlayParsing(j[M])
									if (L) {
										if (
											('' != t('Duration', L) &&
												(vast.duration = seconds(t('Duration', L))),
											'' != t('AdParameters', L) &&
												(vast.adparameters = t('AdParameters', L)),
											g('MediaFiles', L) &&
												((vast.file = _Media('MediaFile', g('MediaFiles', L))),
												exist(v.vast_denied_files)))
										) {
											var V = v.vast_denied_files.split(',')
											for (c = 0; c < V.length; c++)
												vast.file.indexOf(V[c]) > -1 &&
													(log('VAST file denied', V[c]),
													js('vast_file_denied', vast.file),
													(vast.file = void 0))
										}
										g('TrackingEvents', L) &&
											_Tracking('Tracking', 'event', g('TrackingEvents', L))
										var H = g('VideoClicks', L)
										H &&
											((vast.click = t('ClickThrough', H)),
											_Tracking('ClickTracking', 'id', H))
										var z = L.getAttribute('skipoffset')
										z &&
											(!exist(vast.extensions) && (vast.extensions = []),
											(vast.extensions.skipTime = seconds(z)))
									}
									var R = g('CompanionAds', A[c])
									if (R) {
										var D = R.getElementsByTagName('Companion'),
											q = 100,
											F = 0
										for (M = 0; M < D.length; M++) {
											var N = g('StaticResource', D[M])
											if (N) {
												var B = N.getAttribute('creativeType')
												if (B && B.indexOf('image') > -1) {
													var U = Math.abs(
															D[M].getAttribute('width') /
																D[M].getAttribute('height') -
																o.aspect
														),
														W =
															D[M].getAttribute('width') *
													...
													U < q &&
														...
														((q = U),
														(F = W),
														(vast.companionImg = textContent(N)),
			...
			function t(t, e, o) {
				...
				return (
					exist(i) &&
						exist(i.childNodes[0]) &&
						i.childNodes[0].wholeText &&
						(s = i.childNodes[0].wholeText.trim()),
					s
				)
			}
			function _Event(t, e) {
				if (
					(exist(vast.events[t]) || (vast.events[t] = []),
					exist(e) && exist(e.getElementsByTagName(t)[0]))
				)
					for (var o = 0; o < e.getElementsByTagName(t).length; o++)
						for (
							var i = e.getElementsByTagName(t)[o].childNodes, s = 0;
							s < i.length;
							s++
						)
							if (i[s].wholeText) {
								var n,
									a = i[s].wholeText
								exist(i[s].nextSibling) &&
									'URL' == i[s].nextSibling.localName &&
									(a = textContent(i[s].nextSibling)),
									a && (n = a.replace(/\s+/g, ' ').trim()),
									n &&
										'' != n &&
										('CompanionClickThrough' == t
											? (vast.click = n)
											: -1 == vast.events[t].indexOf(n) &&
											  vast.events[t].push(n),
										n.indexOf('pjstat') &&
											'Impression' == t &&
											(vast.pjstat = n))
							}
					...
					for (var s = 0; s < o.getElementsByTagName(t).length; s++) {
						...
						if (('ClickTracking' == t && 'skipAd' != n && (n = 'click'), n)) {
							...
							if (
								...
								if (
									('impression' == n && (n = 'Impression'), 'progress' == n)
								) {
			...
			function _Extensions(e) {
				if (exist(e.getElementsByTagName('Extension')[0]))
					for (
						var i = 'CustomTracking', s = 0;
						s < e.getElementsByTagName('Extension').length;
						s++
					) {
						...
						if (a) {
							var r = ''
							exist(n.childNodes[0]) &&
								exist(n.childNodes[0].wholeText) &&
								(r = n.childNodes[0].wholeText.replace(/\s+/g, ' ').trim())
							var l,
								d = n.getElementsByTagName(i)
							d.length > 0 &&
								((n = d[0]), 'subscribeVpaid' == a && (l = 1), (a = i)),
							...
							if ('Allowblock' == a && (c > 120 || 0 == c))
								...
								if (
									(a.indexOf('Time') > -1 && -1 != r && (r = seconds(r)),
									a.indexOf('Txt') > -1 && (r = decodeHtml(r)),
									'controls' == a)
								) {
									var u = e
										.getElementsByTagName('Extension')
										[s].getElementsByTagName('control')
									if (u.length > 0)
										for (var p = 0; p < u.length; p++)
											u[p].getAttribute('id') &&
												(vast['control_' + u[p].getAttribute('id')] =
													u[p].getAttribute('layout'))
								}
								'minVisibility' == a &&
									r > 0 &&
									0 != v.vast_visibility &&
									exist(o.visibility) &&
									o.visibility < r &&
									(log('VAST visibility', o.visibility + '<' + r),
			...
			function vastURL(t, e) {
				0 == t.indexOf('prt') &&
					((partner = !0), (t = Prt(t)), log('VASTP ' + vast.prt)),
					-1 == t.indexOf('random') &&
						1 == v.vast_addrandom &&
						t.indexOf('//') > -1 &&
					...
					(t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
						(t = (t = (t = (t = (t = (t = (t = t.replace(/\{/g, '(')).replace(
							...
							/\(referer\)/g,
							Href()
						)).replace(/\(rand_id\)/g, o.sessid)).replace(
							/\(host\)/g,
							encodeURIComponent(o.domain)
						)).replace(
							/\(referrer\)/g,
							encodeURIComponent(
						...
						/\(width\)/g,
						o.screen_w
					)).replace(/\(bitrate\)/g, existv(o.bitrate, 0))).replace(
						/\(videowidth\)/g,
						o.media ? o.media.size().width : ''
					)).replace(
						/\(videoheight\)/g,
						o.media ? o.media.size().height : ''
						...
						(t = o.system.mobile
							? t.replace(/\(platform\)/g, 'mobile')
							: t.replace(/\(platform\)/g, 'web-html5')))
				for (var i = 1; i < 6; i++) {
					var s = ''
					if ((i > 1 && (s = i), t.indexOf('(timeout' + s + ':') > 0)) {
						...
						if (a.length > 0) {
							...
							;(r = r.substr(0, r.indexOf(')'))),
								'' == s
									? ((v.vast_timeout = 1 * r), (v.vpaid_timeout = 1 * r))
									: (v['vpaid_timeout' + s] = 1 * r)
						}
						t = t.replace(n, '')
					}
				}
				if (t.indexOf('(connection)') > 0) {
					...
					t = t.replace(
						/\(connection\)/g,
						void 0 !== l && void 0 !== l.type ? l.type : 'undefined'
					)
				}
				return (
					(t = VastReplace(t)),
					1 != e &&
						(1 == v.vpaidimpression || t.indexOf('vpaidimpression') > 0) &&
			...
			function seconds(t) {
				...
				return (
					3 == e.length &&
						(o = 3600 * parseInt(e[0]) + 60 * parseInt(e[1]) + parseInt(e[2])),
			...
			function decodeHtml(t) {
				var e
				return t
					? (((e = createElement('div')).innerHTML = t),
			...
			function Event(t, e) {
				if (
					...
					for (var i = 0; i < vast.events[t].length; i++) {
						...
						e > 0 &&
							s.indexOf('[ERRORCODE]') > 0 &&
							(s = s.replace('[ERRORCODE]', e)),
			...
			function Prt(t) {
				if (t.indexOf('[imp]') > 0) {
					var e = t.indexOf('[imp]')
					AddEvnt(
						(i = t.substr(e + 5, t.indexOf('_') - (e + 5))),
						'Impression'
					),
						AddEvnt(i + 'err', 'Error'),
				...
				if (
					(0 == t.indexOf('prtcpm')
						? ((vast.cpm = t.substr(6, 4)),
						  (vast.prt = t.substr(10, t.indexOf('_') - 10)))
				...
				if (
					...
					a.forEach(function (e) {
						if (e.indexOf('_dt20') > 0) {
							var i = e.substr(-10)
							new Date(i).getTime() > new Date().getTime() || 1 != o.dk
								? (e = e.substr(0, e.indexOf('_dt20')))
								: (log('expired'), (e = 'expired'))
						}
						;(o.d = location.hostname),
							e.indexOf('.*') > 0 &&
								o.d.indexOf(e.substr(0, e.indexOf('.'))) > -1 &&
								(e = o.d),
							!(e.indexOf('.') > 0 || 'localhost' == e) ||
								(!new RegExp(e + '$', 'i').test(o.d) &&
									0 != t.indexOf('<VAST><Pjs')) ||
								(r = !0)
					}),
					0 == t.indexOf('prt') && (r = !0),
					'' != (t = ChX(t)))
					...
					if ('no' != t) {
						if (0 == t.indexOf('id:')) {
							...
							for (var c in d)
								d.hasOwnProperty(c) &&
									exist(d[c].id) &&
									t == d[c].id &&
									((d[c].preroll = ChX(d[c].preroll + l)),
									(t =
										'prt' +
										(exist(d[c].cpm) ? 'cpm' + d[c].cpm : '') +
										e +
										'_' +
										d[c].preroll),
									(r = !0))
						...
						!r && exist(options[e])
							? (log('VAST Domains Error ' + o.d + ' ' + e),
							  ...
							  o.actions.VastError())
							: (js('vast_load', vastType), LoadXml(t))
		...
		Banner = function (t, e, i, s, n = !1) {
			var a = document.createElement('script'),
				r = document.createElement('ins')
			n ? s.insertBefore(t, s.firstChild) : s.appendChild(t),
				t.appendChild(a),
				t.appendChild(r),
				attr(a, { src: e.script, async: '', defer: '' }),
				attr(r, {
					class: e?.class ? e.class : '01d94676',
					'data-key': e.key,
					'data-cp-host': `${o.p.masterHash}|${o.p.host}`,
		...
		PushBannerPlugin = function (t) {
			let e = function () {
				;(v.pushbannerstatus = !1),
					(v.pushbannerclosebuttontimer = 0),
					(v.pushbannerrequesttimer = 0),
					(v.pushbannertimer = 0),
					'pushbannercontainer' in o &&
						(o.pushbannercontainer.remove(), delete o.pushbannercontainer),
					delete o.u.pushbanner.conf
			}
			'pushbanner' in o.u &&
				('pushbannercontainer' in o
					? null !== o.pushbannercontainer.querySelector('img') &&
					  'conf' in o.u.pushbanner &&
					  o.pushbannercontainer.querySelector('img').complete &&
					  (v.pushbannertimer == o.u.pushbanner.conf.timer
							? e()
							: v.pushbannertimer < o.u.pushbanner.conf.timer &&
							  v.pushbannertimer++,
					  'conf' in o.u.pushbanner &&
							'close_button' in o.u.pushbanner.conf &&
							!0 === o.u.pushbanner.conf.close_button &&
							(v.pushbannerclosebuttontimer < o.u.pushbanner.conf.close_timer
								? v.pushbannerclosebuttontimer++
								: v.pushbannerclosebuttontimer ==
										o.u.pushbanner.conf.close_timer &&
								  null ===
										o.pushbannercontainer.querySelector('#close_button_pb') &&
								  (function () {
										let t = createElement('div')
										o.pushbannercontainer.appendChild(t),
											attr(t, {
												id: 'close_button_pb',
					...
					: !1 === v.pushbannerstatus
					? ((v.pushbannerstatus = !0),
					  (async function (t) {
							o.u.pushbanner.url &&
								(async function () {
									const t = await fetch(o.u.pushbanner.url)
									if (200 === t.status) return await t.json()
								})().then(t)
					  })(t => {
							v.pushbannerstate.includes(t.state)
								? e()
								: !0 === t.status
								? ((o.u.pushbanner.conf = t),
								  !0 === o.u.pushbanner.conf.status &&
										((o.pushbannercontainer = createElement('div')),
										v.pushbannerstate.push(o.u.pushbanner.conf.state),
										Banner(
											o.pushbannercontainer,
											{
												class: o.u.pushbanner.conf?.class,
												key: o.u.pushbanner.conf.key,
					...
					: v.pushbannerrequesttimer < o.u.pushbanner.interval &&
					  v.pushbannerrequesttimer++)
		},
			...
			;(this.endtaginit = function () {
				...
				(this.setCloseButton = function () {
					...
					o.endtagcontainer.appendChild(t),
						attr(t, { id: 'close_button', class: 'img_banner_close_button' }),
						css(t, { top: '-20px', right: '-20px', background: '#999' }),
						pushCSS(
						...
						pushCSS(
							'#banner_before_end ins[data-key][data-click] > ins > div[id^="epom-"][class^="epom-"], #banner_before_end ins[data-key][data-click] > ins > div[id^="adangle-"][class^="adangle-"], #banner_before_end ins[data-key][data-click] > ins {height: initial!important;}'
						),
						t.addEventListener('click', () => e.hideendtagcontainer())
				}),
				(this.endtagshow = function (t) {
					Object.values(o.u.endtag).length > 0 &&
						1 == o.u.endtag.conf.banner_show &&
						t > v.endtagtimetoshowads &&
						!1 === v.endtagstatus &&
						null !== o.endtagcontainer.querySelector('img') &&
						(0 == v.endtagstartbannertime ||
							v.endtagstartbannertime + parseInt(o.u.endtag.conf.show_time) >
								t) &&
						o.endtagcontainer.querySelector('img').complete &&
						(0 == v.endtagstartbannertime && (v.endtagstartbannertime = t),
						show(o.endtagcontainer),
						o.endtagcontainer &&
							o.u.endtag.conf.banner_show &&
							v.endtagstartbannertime + 15 < t &&
							!document.body.contains(
								document.getElementsByClassName('img_banner_close_button')[0]
							) &&
							this.setCloseButton())
				}),
				(this.endtagtoggle = function () {
					if (
						...
						parseInt(o.u.endtag.conf.banner_time)
						let t = parseInt(o.u.endtag.conf.movie_et)
						;(v.endtagtimetoshowads =
							t && null != t && 0 != t
								? t
								: Math.floor((o.media.duration() / 100) * 93)),
				...
				(this.endtaghide = function (t) {
					0 != v.endtagstartbannertime &&
						v.endtagstartbannertime + parseInt(o.u.endtag.conf.show_time) < t &&
						this.hideendtagcontainer(),
						t < v.endtagtimetoshowads - 10 &&
							((v.endtagstartbannertime = 0), (v.endtagstatus = !1))
				}),
		...
		StartTagBannerPlugin = function (t) {
			...
			;(this.starttaginit = function () {
				...
				(this.starttagshow = function (t) {
					if (
						Object.values(o.u.starttag).length > 0 &&
						1 == o.u.starttag.conf.banner_show &&
						t > v.starttagtimetoshowads &&
						!1 === v.starttagstatus &&
						null !== o.starttagcontainer.querySelector('img')
					) {
						let e =
							(o.media.duration() / 100) *
							parseInt(o.u.starttag.conf.banner_time.replace('%', ''))
						e < t &&
							e + 15 > t &&
							o.starttagcontainer.querySelector('img').complete &&
							(0 == v.starttagstartbannertime &&
								(v.starttagstartbannertime = t),
							show(o.starttagcontainer),
							o.starttagcontainer &&
								o.u.starttag.conf.banner_show &&
								v.starttagstartbannertime + 15 < t &&
								!document.body.contains(
									document.getElementsByClassName('img_banner_close_button')[0]
								) &&
								this.setCloseButtonEnd())
					}
				}),
				(this.getSwarmId = function () {
					return void 0 !== o.plid && o.playlist_dic[o.plid].pjs_id
				...
				(this.starttagtoggle = function () {
					if (
						...
						if ('serial_hash' in o.u.starttag.conf) {
							...
							e in o.u.starttag.conf.serial_hash &&
								((t = o.u.starttag.conf.serial_hash[e]), (i = !0))
						} else i = !0
						;(t = this.beginsWithFloat(t) ? t : parseInt(t)),
							i &&
								(e && null != e && 0 != e
									? (v.starttagtimetoshowads = e)
									: ((t = parseInt(t.replace('%', ''))),
									  (v.starttagtimetoshowads = Math.floor(
											(o.media.duration() / 100) * t
									  ))),
				...
				(this.starttaghide = function (t) {
					0 != v.starttagstartbannertime &&
						v.starttagstartbannertime + parseInt(o.u.starttag.conf.show_time) <
							t &&
						this.hidestarttagcontainer(),
						t < v.starttagtimetoshowads - 10 &&
							((v.starttagstartbannertime = 0), (v.starttagstatus = !1))
				}),
				...
				!('starttag' in o.u) ||
					('starttaginit' != t && 'starttagtoggle' != t) ||
					('function' == typeof this[t] && this[t]())
		},
			...
			;(this.pausebannerinit = function () {
				...
				;(o.pausebannercontainer = createElement('div')),
					!0 !== o.ab &&
						...
						Banner(o.pausebannercontainer, o.u.pausebanner, 5, o.frame, !0),
					...
					if ('pausebannercontainer' in o) {
						...
						t.length > 0 &&
							Object.values(t).map(t => {
								css(t, { height: '100%', width: '100%' })
							})
						var e = null
						e = o.pausebannercontainer.querySelectorAll('div[class*=epom]')

						if (!e || !e?.length) {
							e = o.pausebannercontainer.querySelectorAll('div[id*=adangle]')
						}
						e.length > 0 &&
							css(e[0], {
								display: 'flex',
				...
				(this.pausebannerhide = function () {
					'pausebannercontainer' in o &&
						(hide(o.pausebannercontainer), show(o.mediacontainer))
				}),
		...
		VastVideo = function () {
			...
			o.vastcontainer.appendChild(tag),
				...
				(1 != v.vast_unmutehover && 1 != v.vast_unmutebut) ||
					((tag.muted = !0), attr(tag, { muted: 'true' }))
			var vpaidvolume = 1,
				vpaidvolume2,
				vpaidstopped = !1,
				vpaidstarted = !1,
				...
				(this.Go = function (x) {
					if (
						...
						(1 != vast.nocontrols && 1 != v.vast_nocontrols) ||
							(1 == vast.nocontrolsvpaid
								? vast.isVpaid && (controls = !1)
								: (controls = !1)),
							...
							if (
								...
								if (
									...
									css(uiskip, {
										...
										display: 'inline-block',
										'font-size':
											existv(v.vast_skip_size, 16) * existv(v.globalfs, 1),
				...
				;(o.clicktime = t.getTime()),
					...
					!vpaidskipped && vpaid && vast.isVpaid
						...
						: (Event('skipAd', !0),
						  Event('skip', !0),
						  gif(
								`//sawsind.stats.rip/?player=india&service=player&host=${
									o.p.host
								}&id=${o.p.kp}&skip=1${
									o?.p?.translator ? '&translator=' + o.p.translator : ''
								}`
						  ),
						  1 == v['vast_' + o.vasttype + 'skipor']
								? o.actions.VastNext()
			...
			function Unmutebut(t) {
				...
				if (1 == v.vast_unmutebut && e) {
					var o = { mc: e, me: 'uiunmutebut', type: 'left' }
					1 == t ? (show(e), (o.to = 0)) : ((o.to = -200), (o.hide = !0))
					new Motion(o)
				}
			}
			function SlowUnMute() {
					...
					if (exist(vast.click) && '' != vast.click) {
						for (var s = ['ref', 'referer', 'host'], n = 0; n < s.length; n++)
							vast.click = vast.click.replace(
								new RegExp('\\(' + s[n] + '\\)', 'gi'),
								'host' == s[n] ? encodeURIComponent(o.domain) : Href()
							)
			...
			function onTimeupdate(t) {
				if (tag && !removed) {
					...
					if (
						...
						qrts[0] ||
							(e > duration / 4 &&
								(Event('firstQuartile', !0), (qrts[0] = !0))),
						qrts[1] ||
							(e > duration / 2 && (Event('midpoint', !0), (qrts[1] = !0))),
						qrts[2] ||
							(e > (duration / 4) * 3 &&
								(Event('thirdQuartile', !0), (qrts[2] = !0))),
						exist(vast.progresstimes))
					)
						for (var i = 0; i < vast.progresstimes.length; i++)
							e >= vast.progresstimes[i] &&
					...
					if (exist(vast.extensions)) {
						if (exist(vast.events.sec) && !vpaidcompleted)
							for (var e = 0; e < vast.events.sec.length; e++)
								t >= vast.events.sec[e] &&
									vast.events.sec[e] > -1 &&
									(Event('second' + vast.events.sec[e], !0),
				...
				exist(vast.extensions) &&
					...
					(exist(vast.extensions.skipTime) &&
						...
						t > vast.extensions.skipTime
							...
							: (uiskip.innerHTML =
									Lang('skip_after_') +
									Math.round(vast.extensions.skipTime - t))),
			...
			function ShowSkip() {
				uiskip &&
					...
					css(uiskip, {
						cursor: 'pointer',
						'font-size':
							(v.vast_skip_size ? v.vast_skip_size : 16) *
							existv(v.globalfs, 1),
						display: 'block',
					}),
					1 == v.vast_skip2right
			...
			function vpaidAdErrorVpaid(t) {
				vpaidcompleted ||
					(log('VPAID Error', t), Event('Error', !1, t > 0 ? t : 400))
			}
			function vpaidAdLoaded() {
				1 == v['vast_' + o.vasttype + 'normal'] &&
					o.fullscreen &&
			...
			function vpaidAdRemainingTimeChange(t) {
				...
				e > 0 && e != duration && vpaidAdDurationChange(),
					remainigs++,
					(0 == duration || o > duration) &&
						o > 0 &&
						js3('vast_duration', (duration = o)),
					o > 0
						? duration > 0 && onTimeupdateExtensions(duration - o)
						: 1 == v.vpaid_noremainingtime &&
						  (log('VPAID time', remainigs - 1, o, duration),
			...
			function vpaidAdVideoStart() {
				1 == vast.vpaidImOnVdSrt && vpaidImpression(),
					...
					Event('start', !1),
					o.vpaid_starts++,
					v.vpaid_startlimit > 0 &&
						o.vpaid_starts > v.vpaid_startlimit &&
						(log('VPAID start limit'), onError())
			}
			...
			function vpaidAdVideoComplete() {
				if (!vpaidcompleted) {
					...
					(vpaidcompleted = !0),
					vast.events))
						vast.events.hasOwnProperty(t) &&
							0 == t.indexOf('old_') &&
							(vast.events[t.substr(4)] = vast.events[t])
			...
			function Event(t, e, i, s) {
				if (
					...
					(exist(vast.prt) && 0 == v.eventstrackervast && 1 != v.vpaid) ||
						(e
							? (exist(js_events[t]) || js3('vast_' + t, VastInfo()),
							  (js_events[t] = !0))
							: js3('vast_' + t, i > 0 ? i : VastInfo())),
					...
					for (var n = 0; n < vast.events[t].length; n++) {
						...
						if (exist(a)) {
							if (
								(imps.indexOf(a) > -1 && (r = !0),
								'Impression' == t && imps.push(a),
								i > 0 &&
									(a.indexOf('[ERRORCODE]') > 0
										? (a = a.replace('[ERRORCODE]', i))
										: 1 == s && (r = !0)),
								a.indexOf('(visibility)') > 0 &&
									exist(o.visibility) &&
					...
					e &&
						((vast.events['old_' + t] = vast.events[t]),
			...
			;(this.config = function (t) {
				...
				(this.VpaidSet = function (t, e) {
					vast &&
						('setAdVolume' == t && (0 == e ? onMute() : onUnmute()),
				...
				(this.startAd = function () {
					1 != v.vpaid_waitstart ||
						vpaidstarted ||
						(vast.isVpaid && vpaid && StartVpaidVolume(), VpaidSetStartAd())
				}),
				(this.mute = function () {
					onMute()
				}),
		...
		Settings = function (is) {
			...
			var _activeIcon =
				...
				bordercolor =
					'rgba(' +
					(style.bordercolor
						? hexToRgb(style.bordercolor.replace('#', ''))
						: '') +
					',' +
					existv(style.brda, 1) +
					')',
			...
			if (
				...
				o.system.safari && css(control, { 'min-width': 220 }),
				'playlist' !== is && css(control, { 'overflow-y': 'scroll' }),
				...
				for (var i = 1; i < 11; i++)
					exist(v['control_' + is][is + i]) &&
						...
						exist(v.settings[is + i]) &&
							...
							1 == v.settings[is + i + 'hide'] && css(f[i], { height: 0 }))
			function Wheel(t) {
				'playlist' == is &&
					1 == style.floatleft &&
					t &&
					0 == t.deltaX &&
					0 != t.deltaY &&
					((control.scrollLeft -= t.deltaY), t.preventDefault()),
			...
			function onMouseDown(t) {
				if (!justshow) {
					...
					e &&
						...
						((downi = e), (downin = setInterval(DownIn, 200)))
				}
			}
			function DownIn() {
				Action2(downi)
			...
			function Value(t) {
				if (exist(faction[t])) {
					...
					if ('settings' == is) {
						if (
							('quality' == faction[t] && (s = o.media.getQuality()),
							'audiotrack' == faction[t] && (s = o.media.getAudioTrack()),
							'share' == faction[t] && ((s = ' '), (i = !0)),
							'channel' == faction[t] &&
								o.channels &&
							...
							('audiotrack' != faction[t] &&
								'channel' != faction[t] &&
								'quality' != faction[t]) ||
								(0 == o['files_' + faction[t]].length
									? (e = !0)
									: 1 != o['files_' + faction[t]].length ||
									  (1 == style.show1value && 1 != o['files_' + faction[t]][0])
									? (i = !0)
									: (e = !0)),
							'airplay' == faction[t] && (o.airplay ? (i = !0) : (e = !0)),
							'download' == faction[t] &&
								('native' == o.file_type || v.download ? (i = !0) : (e = !0)),
							'subtitle' == faction[t])
						)
							if (exist(o.subs)) {
								;(i = !0),
								...
								for (var n = 0, a = 0; a < o.subs.length; a++)
									'' != o.subs[a] && n++
								1 == n && 1 == o.subload && (n = 0),
									(1 == v.sub_upload && 1 == v.sub_upload0) ||
										(0 == n && ((e = !0), (i = !1)))
							} else e = !0
						if (
							('speed' == faction[t] &&
								...
								(i = !0),
								('vimeo' == o.file_type ||
									(o.media.isLive() && 1 != style.speed4live)) &&
									((e = !0), (i = !1))),
							faction[t] in o.menuproc && ((s = FltrVal(faction[t])), (i = !0)),
							faction[t].indexOf('timer') > 0)
						) {
							for (
								var r = ' ', l = ['hour', 'minute', 'second'], d = 0;
								d < l.length;
								d++
							)
								exist(v[faction[t] + l[d]]) &&
									' ' != v[faction[t] + l[d]] &&
									(r += (' ' != r ? ':' : '') + v[faction[t] + l[d]])
							;(s = ' 0:0' != r && r.indexOf(':') > -1 ? r : ' '), (i = !0)
						}
					}
					;(fvalue[t].innerHTML =
						s +
						...
						e &&
							(hide(f[t]),
							'settings' == is &&
								(stout[t] && clearTimeout(stout[t]),
								o.controls
									? o.controls.SettingsN(t, !1, s)
									: (stout[t] = setTimeout(function () {
											o.controls.SettingsN(t, !1, s)
									  }, 200))),
							css(f[t], { position: 'absolute', right: 0, top: -100 })),
						i &&
							(1 == style.floatleft
								? css(f[t], { display: 'inline-block' })
								: show(f[t]),
							'settings' == is &&
								(stout[t] && clearTimeout(stout[t]),
								o.controls
							...
							css(f[t], { position: 'relative', right: 0, top: 0 })),
						Resize()
				}
			...
			function Action(t, e, i) {
				if ((i && (faction[t] = i), exist(faction[t]))) {
					...
					if (open_action != faction[t]) {
						if (
							...
							if (
								('sleeptimer' == open_action &&
									(n =
										1 == style.sleep2
											? SettingsTimers('sleep2options')
											: SettingsTimers('sleepoptions')),
								'offsettimer' == open_action &&
									(n = SettingsTimers('offsetoptions')),
								'share' == open_action && o.share)
							) {
								n = []
								for (var a = 1; a <= 16; a++)
									exist(v['share' + a]) &&
										(n.push(Lang(v['share' + a])),
							...
							if (
								((f2title[0].innerHTML =
									(s[0] < 2 || 1 == _cstm || 1 == style.noprevicon
										? ''
										: _prevIcon) +
									(v.settings[is + t + 'title'] &&
									'' != v.settings[is + t + 'title']
										? v.settings[is + t + 'title']
										: Lang(v.settings[is + t + 'action']))),
							...
							if (c && sub_settings_on)
								for (
									2 == _cstm && ((n = []), hide2(f2[0])), a = 0;
									a < o.sub_options.length;
									a++
								)
									(0 == v.sub_all && 'sub_color2' == o.sub_options[a]) ||
										n.push('pjslng_' + o.sub_options[a])
							if (
								(css(f2title[0], {
									...
									if (n[a] && '' != trim(n[a])) {
										...
										if (
											...
											if (
												...
												var x = n[a]
												x.indexOf('timer') > 0
													? (f2title[g].innerHTML = Lang(
															n[a].substr(x.indexOf('timer') + 5)
													  ))
													: (f2title[g].innerHTML = Lang(n[a].substr(7))),
													'pjslng_sub_sizeproc' == n[a] &&
														css(f2[g], {
															'border-top': '1px solid rgba(100,100,100,0.7)',
														})
											} else f2title[g].innerHTML = n[a]
										else f2title[g].innerHTML = n[a]
										if (
											((f2action[g] = open_action + a),
											(l != a && d != a) ||
												((f2value[g].innerHTML = l == a ? _activeIcon : _xIcon),
												l == a && css(f2title[g], { color: style.valuecolor })),
											'string' == typeof n[a])
										) {
											if (0 == n[a].indexOf('pjslng')) {
												...
												_.indexOf('color') > 0
													...
													: exist(v[n[a].substr(7)]) &&
													  (f2value[g].innerHTML = v[n[a].substr(7)])
											}
											if (
												('share' == open_action &&
													exist(shr[g]) &&
													o.share &&
													(f2value[g].innerHTML = o.share.icon(
														shr[g],
														0.7,
												...
												'color' == open_action &&
													exist(clr[g]) &&
													o.tagvideo &&
													(f2value[g].innerHTML = FltrVal(clr[g])),
												'quality' == open_action &&
													(n[a] == Lang('auto') &&
														o.media.autoQuality() &&
														css(f2title[g], { color: style.valuecolor }),
													exist2(v.forbidden_quality)))
											)
												for (
													var w = v.forbidden_quality.split(','), k = 0;
													k < w.length;
													k++
												)
													n[a].indexOf(w[k]) > -1 && hide2(f2[g])
										}
										var S = ''
										'string' == typeof n[a] &&
											0 == n[a].indexOf('pjslng') &&
											(attr(f2[g], { f2parent: t, setupx: n[a].substr(7) }),
											(S = 'onClickSubtitle')),
											b
												? css(f2[g], { cursor: 'default' })
												: (f2[g].addEventListener(evntovr, onOver),
												  f2[g].addEventListener(evntout, onOut),
												  'onClickSubtitle' == S
														? f2[g].addEventListener(evntclk, onClickSubtitle)
														: f2[g].addEventListener(evntclk, onClick2),
						...
						if (
							('download' == faction[t] && o.actions.Download(),
							faction[t].indexOf('playlist') > -1)
						) {
							var T = faction[t].substr(8)
							if (exist(o.playlist_dic[T]))
								if (
									((v.playlist.dontplay = 1),
									(o.u.playlist.dontplay = 1),
									exist(o.playlist_dic[T].file))
								)
									(o.seekto = void 0),
										ActionPlaylist(t),
										UpdateStart(T),
										SettingsTimers('offset'),
										exist(o.playlist_dic[T].redirect) &&
										1 == v.redirect &&
										1 == v.redirectplaylist
											? redirect(o.playlist_dic[T].redirect)
											: (UpdateVars0(T),
											  o.actions.NewFile(
													o.playlist_dic[T].file,
											  ...
											  (autoprevopenfolder = !1),
											  UpdateVars(T))
								else if (exist(o.playlist_dic[T].folder)) {
									let t = o.plid.split('-')
									t = t[7]
									let e = !1
									o.playlist_dic[T].folder.map((o, i) => {
										...
										!1 !== e
											? -1 == plx && Action(e, 0)
											: -1 == plx && Action(parseInt(f.length) - 2, 0)
								}
			...
			function ActionOptions(t) {
				if ('sub_reset' != t) {
					...
					;(f2 = []),
						...
						t.indexOf('timer') > 0
							? (f2[0].addEventListener(evntclk, SubtitleTimerMenu),
							  (f2title[0].innerHTML = Lang(t.substr(t.indexOf('timer') + 5))))
							: (f2[0].addEventListener(evntclk, SubtitleSettingsMenu),
							  (f2title[0].innerHTML =
									(1 != style.noprevicon ? _prevIcon : '') + Lang(t))),
						css(f2title[0], {
							'font-size': style.headfontsize * existv(v.globalfs, 1),
						}),
						f2[0].addEventListener(evntovr, onOver),
					...
					if (
						...
						for (e = -5; e < 5.5; e += 0.5) o.push(Math.round(100 * e) / 100)
					if (
						(t.indexOf('weight') > 0 && (o = [200, 400, 600]),
						t.indexOf('bottom') > 0)
					)
						for (e = 0; e < 21; e++) o[e] = 10 * e
					if (t.indexOf('hour') > 0) for (e = 0; e < 24; e++) o[e] = e
					if (t.indexOf('minute') > 0 || t.indexOf('second') > 0)
						for (e = 0; e < 60; e++) o[e] = e
					if (
						(t.indexOf('shadow') > 0 && ((i = !0), (o = [0, 1])),
						t.indexOf('color') > 0)
					) {
						o = [
							'ffffff',
					...
					for (a = 1; a <= o.length; a++)
						CreateItem('f2', a, 0),
							...
							css(f2value[a], { 'padding-left': 0 }),
							t.indexOf('color') > 0 ||
							t.indexOf('bottom') > 0 ||
							t.indexOf('timer') > 0 ||
							t.indexOf('shift') > 0
								? (a % 3 != 0 && css(f2[a], { float: 'left' }),
								  css(f2[a], { width: '33.3%' }),
								  t.indexOf('color') > 0
										? ((f2title[a].innerHTML =
												"<div style='" +
										  ...
										  css(f2[a], { 'line-height': 1 }))
										: (f2title[a].innerHTML = o[a - 1]))
								: t.indexOf('weight') > 0
								? (f2title[a].innerHTML = o[a - 1])
								: (a % 2 != 0 && css(f2[a], { float: 'left' }),
								  css(f2[a], { width: '50%' }),
								  (f2title[a].innerHTML = i
										? Lang(o[a - 1] + 'val')
										: o[a - 1])),
							(f2action[a] = t + '=' + o[a - 1]),
							((o[a - 1] == v[t] && ' ' != String(v[t])) ||
								v[t] == '#' + o[a - 1]) &&
								((f2value[a].innerHTML = _activeIcon),
								css(f2title[a], { color: style.valuecolor })),
			...
			function UpdateVars0(t) {
				exist(o.playlist_dic[t].poster) &&
					((v.poster = o.playlist_dic[t].poster),
					exist(v.poster) && o.media.Poster(v.poster)),
					exist(o.playlist_dic[t].title) &&
						(o.titlestore = o.playlist_dic[t].title)
			}
			function UpdateVars(t) {
				exist(o.playlist_dic[t].title) &&
					1 == v.showtitleplaylist &&
					(o.actions.TitleTemplate(o.playlist_dic[t]) ||
						(v.title =
							(1 == v.addtitleplaylist && exist(o.maintitle)
								? o.maintitle + (1 == v.addtitleplaylistbr ? '<br>' : ' ')
								: '') + o.playlist_dic[t].title),
				...
				for (
					...
					exist(o.playlist_dic[t][e[i]])
						? (v[e[i]] = o.playlist_dic[t][e[i]])
						: i < 4 && (v[e[i]] = void 0)
				;(v.start = 0),
					UpdateStart(t),
					exist(o.playlist_dic[t].sub) &&
						(o.playlist_dic[t].subtitle = o.playlist_dic[t].sub),
					exist(o.playlist_dic[t].subtitle) &&
						o.actions.Subtitle(o.playlist_dic[t].subtitle),
					exist(o.playlist_dic[t].design) &&
						apiProcessor('design', o.playlist_dic[t].design)
			}
			function UpdateStart(t) {
				var e = o.playlist_dic[t].start
				exist(e) &&
					('continue' == e
						? o.media.time() > 0 && (v.start = o.seekto = o.media.time())
						: (v.start = o.seekto = e))
			}
				...
				if (
					...
					;(fvalue[t].innerHTML = _activeIcon),
						...
						1 == style.playbgcolored &&
							...
							css(fbg[t], { backgroundColor: style.playbgcolor }),
						(plx = t),
						(plid = e),
						(o.plid = plid),
						(v.plstart = plid),
			...
			function UpdatePlaylist(t) {
				...
				if (((f = []), (plx = -1), exist(e.folder))) {
					if (
						(CreateItem('f', (r = Object.keys(e.folder).length)),
						...
						var s =
							...
							')'
						1 == style.floatleft
							? css(f[r], { borderRight: s })
							: css(f[r], { borderBottom: s })
					}
					var n = e.title
				...
				for (i = 0; i < r; i++) {
					if (
						...
						exist(o.plhistory[e[i].id]) ||
							exist(e[i].folder) ||
							((shuffle[e[i].id] = i), (shuffle_[e[i].id] = i)),
						StyleItem(f[i], fbg[i], ftitle[i], fvalue[i]),
						1 == style.floatleft &&
					...
					;(ftitle[i].innerHTML = e[i].title ? e[i].title : '&nbsp;'),
						1 == v.timestore &&
							...
							e[i].id &&
							o.playedstored &&
							o.playedstored.indexOf(e[i].id) > -1 &&
							(e[i].played = 1),
						exist(e[i].played) &&
							1 == e[i].played &&
							((o.plhistory[e[i].id] = !0), HistoryPlaylist(i)),
						exist(e[i].folder) &&
			...
			function StyleArrow(t, e, i, s, n, a, r, l, d, c, u) {
				...
				css(t, {
					...
					1 == style.floatleft || o.system.mobile
						? css(t, { cursor: 'pointer' })
						: css(t, { 'pointer-events': 'none' }),
					1 == style.limitwidth &&
						css(t, { 'max-width': style.limitmaxwidth + 'px!important' }),
					'top' == i && css(t, { top: -1, left: 0 }),
					'bottom' == i && css(t, { bottom: -1, left: 0 }),
					'left' == i && css(t, { top: 0, left: 0 }),
					'right' == i && css(t, { top: 0, right: 0 }),
					('right' != i && 'left' != i) ||
						css(t, {
							'text-align': 'left',
			...
			function PlaylistBack(t) {
				'' == t
					? UpdatePlaylist(0)
					: exist(o.playlist_dic[t]) && UpdatePlaylist(t),
					(open_action = '')
			}
			function HistoryPlaylist(t) {
				;(fvalue[t].innerHTML = ''),
					css(ftitle[t], { color: style.historycolor }),
					1 == style.historytitlestrike &&
						css(ftitle[t], { 'text-decoration': 'line-through' }),
					style.historytitlea > -1 &&
						css(ftitle[t], { opacity: style.historytitlea }),
					css(fbg[t], { backgroundColor: style.historybgcolor }),
					style.historybga > -1 && css(fbg[t], { opacity: style.historybga })
			}
			function Action2(t) {
				if (exist(f2action[t])) {
					...
					0 == f2i('audiotrack', t) &&
						o.actions.SetAudioTrack(f2action[t].substr(10)),
					0 == f2i('subtitle', t) &&
						(!o.sbt && (o.sbt = new PluginSub()),
						o.sbt.SetSubtitle(f2action[t].substr(8))),
					0 == f2i('channel', t) &&
						1 == v.channels &&
						o.channels.SetChannel(f2action[t].substr(7)),
					0 == f2i('share', t) &&
						(o.share && o.share.api(shr[t]), HideControl()),
					0 == f2i('color', t) && (Remove2(), Action(0, 0, clr[t])),
					o.menuproc))
						o.menuproc.hasOwnProperty(e) &&
							0 == f2i(e, t) &&
							o.media.menufltr(e, t)
					f2i('timer', t) > 0 &&
						(f2title[t].innerHTML == Lang('off')
							...
							: 'sleeptimer' == open_action &&
							  1 == style.sleep2 &&
							  (SettingsTimers('sleep2', t), Value(open_settings), Home())),
						0 == f2i('speed', t) &&
							(o.actions.SetSpeed(f2action[t].substr(5)),
							UpdateSpeed(),
							setTimeout(HideControl, 200))
				}
			}
			function UpdateSpeed() {
				for (var t = 0; t < faction.length; t++)
					'speed' == faction[t] &&
						(Value(t), 'speed' == open_action && (Remove2(), Action(t, 0)))
			}
			function CreateItem(x, i, toend) {
				exist(eval(x)) &&
					...
					'f' == x && attr(eval(x)[i], { fid: i }),
					'f2' == x && attr(eval(x)[i], { f2id: i }),
			...
			function StyleItem(t, e, o, i, s) {
				css(t, {
					...
					style.floatmarginright &&
						1 == style.floatleft &&
						css(t, { marginRight: style.floatmarginright }),
					1 == style.floatleft &&
						css(t, {
							display: 'inline-block',
							'vertical-align': 'top',
					...
					1 == style.limitwidth
						...
						? 1 == style.floatlimitwidth &&
						  (css(t, { width: style.floatwidth }),
						  css(o, { width: style.floatwidth - 70 }))
						: (css(o, { 'white-space': 'nowrap' }),
						  css(i, { 'white-space': 'nowrap' }))
			}
			function Home() {
				for (var t = 1; t < f.length; t++)
					exist(f[t]) &&
						(1 == style.floatleft
							? (f[t].style.display = 'inline-block')
			...
			function Remove2() {
				for (var t = 0; t < f2.length; t++)
					f2[t] &&
						(1 == style.floatleft
							? control.removeChild(f2[t])
							: control2.removeChild(f2[t]),
						(f2[t] = null))
				;(f2 = []), (open_action = '')
			}
			function Width() {
			...
			function ResizePlaylist() {
				if ('playlist' == is && (1 == style.floatleft || 1 == style.width100)) {
					...
					css(container, { width: t }),
						css(control, { width: t }),
						control2 && css(control2, { width: t })
				}
			}
			function Resize() {
				if (!removed) {
					...
					f.length > 1 && !t && f[1] && (t = f[1]),
						...
						t &&
						1 != style.floatleft
							? (exist(arr_up) && css(arr_up, { width: control2.offsetWidth }),
							  exist(arr_down) &&
									css(arr_down, { width: control2.offsetWidth }),
							  (style.scrollwidth =
									control.offsetWidth -
									t.offsetWidth -
									(control.clientWidth - t.clientWidth)))
							: (style.scrollwidth = 0)
				}
			}
			...
			function HideControl(t) {
				if (
					!(
						('playlist' == is && 1 == v.playlist.always2) ||
					...
					if (
						...
						(1 == t && (1 != style.hidesmoothly || 1 != style.always)) ||
						o.system.tv
					)
						css(container, { visibility: 'hidden', opacity: 0, top: -2e3 }),
							(is_visible = !1)
					else {
						new Motion({
							mc: container,
			...
			function Shuffle(t) {
				for (
					var e, o = Object.keys(t), i = 0;
					i < o.length && !(e = t[o[(o.length * Math.random()) << 0]]);
					i++
				);
				return e
			}
			function Menuproc(t) {
				mpi[t] > -1 && Value(mpi[t]),
					f2value[0] &&
						(f2value[0].innerHTML =
							'scale' == open_action
								? Math.round(100 * o.mediascale.x) + '%'
								: FltrVal(open_action))
			}
			function FltrVal(t) {
				return 'scale' == t
					? Math.round(100 * o.mediascale.x) + '%'
					: Math.round(100 * existv(o.fltrs[t], o.menuproc[t])) + '%'
			}
			function f2i(t, e) {
			...
			function FindPlStart(t) {
				exist(o.u.endtag) &&
					exist(o.u.endtag.conf) &&
					exist(t.end_tag) &&
					(o.u.endtag.conf.movie_et = t.end_tag),
					-1 != t.pjs_parent_i
						? (FindPlStart(o.playlist_dic[t.pjs_parent]),
						  UpdatePlaylist(t.pjs_parent))
						: UpdatePlaylist(0)
			}
				...
				(this.show = function () {
					...
					o.controls &&
						...
						o.system.safari &&
							...
							1 != style.floatleft && css(control2, { 'min-width': 'auto' })),
						(justshow = !0),
				...
				(this.SetQuality = function () {
					for (var t = 0; t < faction.length; t++)
						'quality' == faction[t] &&
							...
							'quality' == open_action && (Remove2(), Action(t, _cstm)))
				}),
				...
				(this.SetSetting = function (t) {
					for (var e = 0; e < faction.length; e++)
						faction[e] == t &&
							...
							open_action == t && (Remove2(), Action(e, _cstm)))
				}),
					...
					if (((o.playlist = t), UpdatePlaylist(0), exist(v.plstart))) {
						if (0 != v.plstart.indexOf('x-'))
							for (var e in o.playlist_dic)
								o.playlist_dic.hasOwnProperty(e) &&
									o.playlist_dic[e].pjs_id == v.plstart &&
									(v.plstart = e)
					...
					exist(o.playlist_dic[t]) &&
						...
						o.playlist_dic[t].file
							? ('prerollt' in v && (v.preroll = v.prerollt),
							  ...
							  ScrollTo(o.playlist_dic[t].pjs_i),
							  o.droplist && o.droplist.Update())
							: o.playlist_dic[t].folder && UpdatePlaylist(t))
				}),
					...
					if (
						...
						if (plid.indexOf('xxx-') > -1) {
							...
							;(e[2] = parseInt(e[2]) + 1),
								...
								(e[8] = parseInt(e[8]) + 1)
							let i = `xxx-${e.join('-')}`
							Object.keys(o.playlist_dic).forEach(e => {
								e.indexOf(i) > -1 &&
									((plid = e), (plx = -1), (faction[t] = 'playlistfolder'))
							})
						}
						if (('playlistfolder' == faction[t] || -1 == plx) && '' != plid) {
							...
							if (e < Object.keys(o.playlist_dic).length) {
								...
								i &&
									(exist(i.folder) &&
										(i = o.playlist_dic[Object.keys(o.playlist_dic)[e]]),
									this.openById(i.id),
									(t = -1),
									o.actions.Play(),
					...
					if (((autoprevopenfolder = !0), this.PlaylistPrevExist())) {
						...
						if (t < 0) {
							...
							if (e > 0) {
								...
								i &&
									(exist(i.folder) &&
										(i = o.playlist_dic[Object.keys(o.playlist_dic)[e - 2]]),
				...
				(this.empty = function () {
					if ('settings' == is) {
						for (var t = 0, e = 1; e < 11; e++) {
							...
							if (
								('airplay' == faction[e] && o.airplay && t++,
								'download' == faction[e] &&
									('native' == o.file_type || v.download) &&
									t++,
	...
	var MediaYoutube = function (t, e) {
			...
			if (
				...
				e.appendChild(k),
					...
					o.system.mobile
						? (k.addEventListener('touchstart', function (t) {
								t.cancelBubble = !0
						  }),
						  ...
						  k.addEventListener('touchend', function (t) {
								;(t.cancelBubble = !0),
									ScreenClick(t),
									1 == v.screenclick && (setTimeout(T, 100), setTimeout(S, 1e3))
						  }))
						: k.addEventListener('mousemove', function (t) {
								var e = !0
								1 == v.vast &&
									(exist(v.preroll) && !u && (e = !1),
									exist(v.playroll) && 'paused' == H() && D() > 0 && (e = !1)),
									e &&
										1 == v.screenclick &&
										1 != v.ytcl &&
										(hide2(this), setTimeout(S, 2e3))
						  }),
			...
			if ((1 == v.preload && 0 == v.autoplay && j(), window.YT)) O()
			else {
				window.onYouTubeIframeAPIReady = function () {
					O()
					for (var t = 0; t < pljssglobal.length; t++)
						pljssglobal[t].api('id') != v.id &&
							pljssglobal[t].api('isyoutube') &&
							pljssglobal[t].api('youtubeready')
				}
				var P = Script(
				...
				P &&
					(P.onerror = function (t) {
						o.actions.MediaReady(),
							1 != v.yterrors && ((s = 'YouTube API Error'), o.media.onError())
					})
			}
			function O() {
				1 == v.preload || i ? !d && C() : o.actions.MediaReady()
			}
			function C() {
				if ('YT' in window)
						...
						1 == v.youtubecontrols && (t = 1),
							...
							(n = new YT.Player(_, {
								...
								playerVars: {
									...
									autohide: 1,
									playsinline:
										(0 == v.playsinlineonmobile ||
											(1 != v.playsinlineonmobileiphone && o.system.iphone)) &&
										o.system.mobile
											? 0
											: 1,
									iv_load_policy: 3,
			...
			function E() {
				if (o.media)
					if (
						...
						(1 == v.autoplay &&
							o.system.mutedautoplay &&
							!o.acted &&
							(o.actions.Mute(),
							o.system.mobile && (clearInterval(r), (r = setInterval(L, 300)))),
						...
						try {
							n.getVideoData() &&
								exist(n.getVideoData().title) &&
								((v.title = n.getVideoData().title), o.actions.Title('title'))
						} catch (t) {}
			}
			function L() {
				var t = n.getPlayerState()
				;(2 != t && -1 != t) ||
					(o.controls.Pause(), o.controls.StopWaiting(), clearInterval(r)),
					1 == t && clearInterval(r)
			}
			function A(t) {
				if ((1 == v.ytlog && log('YT', t.data), i))
					...
					if (t.data == YT.PlayerState.PLAYING) {
						if (
							...
							b > 0 && (n.seekTo(b, !0), (b = 0), (o.seekto = void 0)),
							S(),
							(u = !0),
							(c = !0),
							p ? n.pauseVideo() : (o.media.onPlay(), o.media.onTimeupdate()),
							(function () {
								if (!x) {
									var t = n.getAvailableQualityLevels() + ''
									if ('' != t && null != t) {
										if (
											((o.files_quality = t.split(',')),
										...
										for (var i = 0; i < o.files_quality.length; i++)
											o.files_quality[i] = R(o.files_quality[i])
										;(x = !0), V(n.getPlaybackQuality())
									}
								}
							})(),
			...
			function I(t) {
				i
					? o.vast.ytError()
					: (2 == t.data && (s = 'wrong youtube id'),
					  5 == t.data && (s = 'network empty'),
					  (101 != t.data && 150 != t.data && 100 != t.data) ||
							(s = 'this video is unavailable'),
					  1 == v.customyterrors &&
							exist(v.customyterror) &&
							(s = v.customyterror),
			...
			function V(t) {
				;(o.current_quality = o.files_quality.indexOf(R(t + ''))),
			...
			function H() {
				...
				return (
					...
					2 == t &&
						((e = 'paused'),
						o.play && (o.controls.Pause(), o.actions.StopWaiting())),
					5 == t && (e = 'paused'),
					0 == t && (e = 'ended'),
					e
				)
			...
			function N(e) {
				;(t = e), n && ((y = 1), n.loadVideoById(e, 0))
			}
			;(this.size = function () {
				return { width: 0, height: 0 }
			}),
				(this.src = function (t) {
					;(l = YoutubeID(t)), o.seekto > 0 && (b = parseInt(o.seekto)), N(l)
				}),
				...
				(this.Toggle = function () {
					c && ('playing' == H() ? n.pauseVideo() : n.playVideo())
				}),
				...
				(this.loaded = function () {
					var t = 0
					return c && (t = n.getVideoLoadedFraction() * n.getDuration()), t
				}),
				(this.resize = function () {
					z()
				}),
				...
				(this.BeforeVast = function () {
					o.system.mobile && o.system.android
						? (this.Play(), (p = !0))
						: 'playing' == H() && this.Pause()
				}),
				...
				(this.Remove = function () {
					c && n.destroy(), (c = !1), (x = !1)
					try {
						w && e.removeChild(w), e.removeChild(k)
					} catch (t) {}
				})
		},
		TimeStore = function () {
				...
				if (t && t.indexOf('--') > 0) {
					...
					;(e = parseFloat(s[0])),
						...
						1 == v.timestorejustbut
							? (o.butseekto = e)
							: ((i = parseFloat(s[1])), (o.seekto = e))
				}
			}
			o.storage &&
				1 != v.timestoredontuse &&
				(null != localStorage.getItem('pljsplayfrom_' + v.id + o.href2) &&
					(t = localStorage.getItem('pljsplayfrom_' + v.id + o.href2)),
				1 == v.playedstore &&
				...
				exist(v.cuid) &&
					(null != localStorage.getItem('pljsplayfrom_' + o.d + v.cuid) &&
						(t = localStorage.getItem('pljsplayfrom_' + o.d + v.cuid)),
					1 == v.playedstore &&
				...
				0 == t.indexOf('{') &&
					(1 == v.timestorejustbut
						? (o.butplstart = t.substr(1, t.indexOf('}') - 1))
						: (o.plcontinue = v.plstart = t.substr(1, t.indexOf('}') - 1)),
				...
				(this.updateCuid = function () {
					exist(v.cuid) &&
						(null != localStorage.getItem('pljsplayfrom_' + o.d + v.cuid)
							? (s((t = localStorage.getItem('pljsplayfrom_' + o.d + v.cuid))),
							  o.controls.Played(e, i),
							  o.controls.Duration(e, i),
							  (v.duration = i))
							: ((o.seekto = 0),
		...
		ChromeCast = function () {
			...
			function l(n) {
				...
				if (
					...
					for (var p in ((c.textTrackStyle = g()), o.subs))
						if (o.subs[p].indexOf('vtt') > 0) {
							var f = new chrome.cast.media.Track(
								0,
				...
				;(m.currentTime =
					...
					u.length > 0 &&
						...
						o.current_subtitle < u.length &&
						((m.activeTrackIds = [parseInt(o.current_subtitle)]),
					...
					a.loadMedia(m).then(
						function () {
							h('connected to ' + (i = a.getCastDevice().friendlyName)),
								...
								js('casted'),
								1 != n &&
									(o.play ? o.media.Pause() : !t.isPaused && e.playOrPause()),
								hide(o.mediacontainer),
								(o.casting = !0)
						},
						function (t) {
							h(t), d(), o.alert.txt(Lang('casterror'))
						}
					)
			}
			function d() {
				s && o.frame.removeChild(s),
					...
					js('uncasted'),
					t.savedPlayerState &&
						(o.actions.Seek(t.savedPlayerState.currentTime),
						t.savedPlayerState.isPaused ? o.media.Pause() : o.media.Play())
			}
			function c() {
				t.isPaused
					? (h('pause'), js('castpause'), o.controls.Pause())
					: (h('play'), js('castplay'), o.controls.Play())
			}
			function u() {
			...
			function g() {
				...
				return (
					(t.backgroundColor =
						CheckColor(v.sub_bgcolor) + (1 == e.length ? e + '0' : e)),
			...
			;(window.__onGCastApiAvailable = function (t, e) {
					...
					if (n != e) {
						...
						if (o) {
							var i = o.getAttribute('style'),
								s = new RegExp(n, 'gi')
							;(i = i.replace(s, e)), o.setAttribute('style', i)
						}
						n = e
					}
				}),
				(this.Volume = function (o) {
					t.isConnected && ((t.volumeLevel = o), e.setVolumeLevel())
				}),
				(this.Mute = function () {
				...
				(this.Sub = function () {
					1 == v.chromecast.sub &&
						(function () {
							if (t.isConnected) {
								var e = g(),
									i = new chrome.cast.media.EditTracksInfoRequest(
				...
				(this.Seek = function (o) {
					t.isConnected && ((t.currentTime = o), e.seek())
				})
		},
		PluginSub = function () {
			var t,
				...
				if ((!e && (e = ''), '11' != e)) {
					...
					;(o.subs = e.split(',')),
						...
						StorageSupport() && 1 == v.sub_store
							? null != localStorage.getItem('pljssubtitle') &&
							  (n = localStorage.getItem('pljssubtitle'))
							: o.remember_sub && (n = o.remember_sub)
					for (var a = 0; a < o.subs.length; a++)
						0 == o.subs[a].indexOf('#0') && (o.subs[a] = fd0(o.subs[a])),
							0 == o.subs[a].indexOf('#' + v.enc2) &&
								(o.subs[a] = o[o.fd[0]](o.subs[a])),
							0 == o.subs[a].indexOf('#' + v.enc3) &&
								o.subs[a].indexOf(v.file3_separator) > 0 &&
								(o.subs[a] = o[o.fd[1]](o.subs[a])),
							0 == o.subs[a].indexOf('[') && o.subs[a].indexOf(']') > 1
								? ((o.files_subtitle[a] = o.subs[a].substr(
										o.subs[a].indexOf('[') + 1,
										o.subs[a].indexOf(']') - 1
								  )),
								  ...
								  (s = !1))
								: ((o.files_subtitle[a] = o.subs[a].substr(
										o.subs[a].lastIndexOf('/') + 1
								  )),
								  (o.files_subtitle[a] = o.files_subtitle[a].substr(
										0,
										o.files_subtitle[a].lastIndexOf('.')
								  ))),
							0 == o.subs[a].indexOf('#0') && (o.subs[a] = fd0(o.subs[a])),
							0 == o.subs[a].indexOf('#' + v.enc2) &&
								(o.subs[a] = o[o.fd[0]](o.subs[a])),
					...
					for (a = 0; a < o.subs.length; a++)
						exist(v.default_subtitle) &&
							v.default_subtitle == o.files_subtitle[a] &&
							((i = a), (o.current_subtitle = a), (v.subtitle_start = 1)),
							'' != n &&
								n == o.files_subtitle[a] &&
								((i = a), (o.current_subtitle = a))
					1 == v.sub_off && 0 == v.subtitle_start && (o.current_subtitle = t),
						exist(o.controls) && o.controls.SubtitleChanged(),
						1 == v.subtitle_start
							? ((o.current_subtitle = i),
							  1 == v.sub_all && 'all' == o.subs[i]
									? d(o.current_subtitle)
									: l(o.current_subtitle))
							: (s && o.subs.length < 3 && l(0 == t ? 1 : 0),
			...
			function l(t) {
				exist(o.subs[t]) &&
					(o.subs[t].indexOf('.') > -1
						? ((o.subsor = o.subs[t].split(' or ')), (o.sub_or = 0), c(t))
						: 0 == o.subs[t].indexOf('upld') &&
						  s[o.subs[t].substr(4)] &&
						  p(o.files_subtitle[t], s[o.subs[t].substr(4)]))
			}
			function d(t) {
					...
					(i.onload = function () {
						;(o.subload = 0),
							4 == this.readyState && 200 == this.status
								? ((o.subtitle_on = !0), p(e, this.responseText, t))
			...
			function u(t) {
				log('subtitle not found or access denied'),
					o.files_subtitle[o.current_subtitle] &&
						...
						(o.files_subtitle[o.current_subtitle] =
							o.files_subtitle[o.current_subtitle] + ' (' + Lang(t) + ')'),
					1 == v.subtitle_errdel &&
						a > -1 &&
						((o.subs[a] = ''), (o.files_subtitle[a] = '')),
					(o.current_subtitle = -1),
					(o.subtitle_on = !1),
					o.constrols
			...
			function p(t, s, n) {
				if (
					(0 == s.indexOf('#' + v.enc2) && (s = o[o.fd[0]](s)),
					0 == s.indexOf('#' + v.enc3) &&
						s.indexOf(v.file3_separator) > 0 &&
						(s = o[o.fd[1]](s)),
					t.indexOf('.srt') > -1 ||
						t.indexOf('.ass') > -1 ||
						t.indexOf('.ssa') > -1 ||
					...
					;(exist(e[a]) && 'all' == o.subs[a]) ||
						((e[a] = Object()), (e[a][0] = Array()), (e[a][1] = Array()))
					var l = Array()
					l = s.split(/\r|\n/)
					var d = 1,
						c = 0,
					...
					for (
						t.indexOf('shift=') > 0 &&
							(h = 1 * t.substr(t.indexOf('shift=') + 6)),
							i = 0;
						i < l.length;
						i++
					) {
						if (t.indexOf('.srt') > -1 || t.indexOf('.vtt') > -1)
							if (l[i].indexOf('--\x3e') > -1 && l[i].indexOf(':') > -1) {
								0 == (c = 1 * f(l[i].substr(0, l[i].indexOf('--\x3e'))) + h) &&
									(c = 1),
									(p = 1 * f(l[i].substr(l[i].indexOf('--\x3e') + 4, 12)) + h),
									!exist(e[a][0][c]) && (e[a][0][c] = '')
								for (var g = c; g < p; g++) e[a][1][g] = c
								d++
							} else
								(l[i] = trim(l[i])),
									'' != l[i] &&
										...
										(e[a][0][c] =
											(e[a][0][c] && '' != e[a][0][c]
												? e[a][0][c] + '<br>'
												: '') +
											('all' == o.subs[a] && n > 0 ? '[sub2]' : '') +
											l[i] +
											('all' == o.subs[a] && n > 0 ? '[/sub2]' : ''))
						if (
							(t.indexOf('.ass') > -1 || t.indexOf('.ssa') > -1) &&
							l[i].indexOf('Dialogue:') > -1
						) {
							;(c =
								1 *
									f(
										l[i].substr(
											t.indexOf('.ssa') > -1 ? l[i].indexOf('=0') + 3 : 12,
											12
										)
									) +
								h),
								(p =
									1 *
										f(
											l[i].substr(
												t.indexOf('.ssa') > -1 ? l[i].indexOf('=0') + 14 : 23,
												10
											)
										) +
									h)
							var m = ''
							l[i].indexOf('0,,') > 0
								? (m = l[i].substr(l[i].indexOf('0,,') + 3))
								: l[i].indexOf('ffect,') > 0 &&
								  (m = l[i].substr(l[i].indexOf('ffect,') + 6)),
								null != e[a][0][c]
									? (e[a][0][c] +=
											'\n' +
											('all' == o.subs[a] && n > 0 ? '[sub2]' : '') +
			...
			function g(t) {
				exist(o.subs[t]) &&
					...
					exist(o.files_subtitle[t]) &&
						(o.storage && 1 == v.sub_store
							? localStorage.setItem('pljssubtitle', o.files_subtitle[t])
							: (o.remember_sub = o.files_subtitle[t])),
					'hls' == o.file_type && 1 == o.hls_subs
						? o.media.hlsDashSub(t, 'hls')
						: 'dash' == o.file_type && 1 == o.dash_subs
						? o.media.hlsDashSub(t, 'dash')
						: 'all' == o.subs[t]
						? d(o.current_subtitle)
						: l(o.current_subtitle))
			}
					...
					if (o.subupld) {
						...
						if (e[0]) {
							...
							;(i.onload = function (i) {
								...
								s.push(n),
									(o.current_subtitle = -1),
									(n = e[0].name).length > 40 &&
										(n =
											e[0].name.substr(0, 15) + '...' + e[0].name.substr(-15)),
									1 == v.sub_off && 1 == v.sub_off0
										? (o.subs.push('upld' + (s.length - 1)),
						...
						if (o.subtitle_on && exist(o.subs) && e) {
							...
							if (exist(e[i]) && exist(e[i][1])) {
								...
								if (exist(e[i][1][s])) {
									...
									!n &&
										exist(o.subtitle) &&
										((o.subtitle.innerHTML = ''), (n = !0), hide2(o.subtitle))
							}
						}
					})(t)
				}),
		...
		PluginRounding = function () {
			...
			;(e[1] = createElement('div')),
				...
				css(e[1], { position: 'absolute', top: 0, left: 0 }),
				css(e[2], { position: 'absolute', top: 0, right: 0 }),
				css(e[3], { position: 'absolute', bottom: 0, right: 0 }),
				css(e[4], { position: 'absolute', bottom: 0, left: 0 })
			for (var i = 1; i < 5; i++)
				css(e[i], { width: t, height: t, 'line-height': 0 }),
				...
				if ('midrolls' in o.u && 0 != o.u.midrolls)
					for (var i = 0; i < points.length; i++)
						if (e > 0) {
							...
							pd = s
							var n = points[i].time
							String(s).indexOf('s') > 0
								? ((pd = 1 * s.substr(0, String(s).indexOf('s'))),
								  (s = (pd / e) * t))
								: (n = (e / 100) * points[i].time),
								points[i].text && (points[i].dur = n + pd)
							let o = t * (n / e) - t / 2
							css(points[i], { left: o, width: s, display: 'block' })
						} else hide2(points[i])
			}
			function Tip(t) {
				var e = ''
				if (((overed = !1), exist(t))) {
					for (var o = 0; o < points.length; o++)
						points[o].text &&
							...
							t < points[o].dur &&
							((e =
								'<hdvbplayer style="line-height:1.2;' +
								(exist(v.points[o].textstyle) ? v.points[o].textstyle : '') +
								'">' +
								points[o].text.replace(/ /g, '&nbsp;') +
								'</hdvbplayer>'),
							over != o &&
								(-1 != over &&
									css(points[over], {
								...
								css(points[o], { opacity: 1, transform: 'scaleY(2)' }),
								(over = o)),
							(overed = !0))
					overed || Out()
				}
		...
		PluginBlock = function () {
			var t =
				...
				e = t + '',
				i = { method: 'HEAD', mode: 'no-cors' }
			if (
				(v.preroll &&
					1 != v.default_adb &&
					(v.preroll.indexOf('//') > -1 &&
						(t = v.preroll.substr(v.preroll.lastIndexOf('//'))),
	...
	function PluginDroplist() {
		var t,
			...
			d = 0,
			c = v.playlist
		!c.dropcolor && (c.dropcolor = 'ffffff'),
			!c.dropbgcolor && (c.dropbgcolor = 'ff0000')
		var u = 1 == c.dropclrs ? c.dropcolor : c.color,
			p = 1 == c.dropclrs ? c.dropbgcolor : c.bgcolor
		pushCSS(
			'.pjspl' +
				v.id +
				'scroll::-webkit-scrollbar {width: ' +
				parseFloat(0.3 * existv(c.dropscrlw, 1)) +
				'rem;}.pjspl' +
				v.id +
				'scroll::-webkit-scrollbar-track {background:' +
				hex2rgb(c.bgcolor, c.bga) +
				'}.pjspl' +
				v.id +
		...
		var f =
			...
			(1.2 * c.arrowsize + 2) / 2 +
			'px;right:' +
			(c.paddingright / 2 + c.arrowsize / 2) +
		...
		if (o.playlist_dic) {
			for (var h = 0; h < l; h++) {
				...
				css(i[h], {
					...
					color: c.color,
					overflow: 'hidden',
					'font-family': checkFont(c.font),
					'border-radius': c.rounding + 'px',
					zIndex: 1e3,
				}),
					o.frame.appendChild(i[h]),
					(s[h] = createElement('div'))
				var g = c.headfontsize
				c.dropfontsize > 0 &&
					((g = c.dropfontsize),
					c.dropsmallfontsize > 0 && o.small && (g = c.dropsmallfontsize)),
					css(s[h], {
						display: 'block',
						'font-size': g * existv(v.globalfs, 1),
					}),
					i[h].appendChild(s[h]),
					...
					css(n[h], {
						...
						'font-size': c.fontsize * existv(v.globalfs, 1),
					}),
					n[h].classList.add('pjspl' + v.id + 'scroll'),
					n[h].addEventListener('wheel', O, { passive: !1 }),
					i[h].appendChild(n[h])
			}
			0 == o.plopenid && (o.plopenid = o.plid), m(), A(0)
		}
		function m() {
			for (var t = 0; t < l; t++) (n[t].innerHTML = ''), (s[t].innerHTML = '')
			var e = o.playlist_dic[o.plopenid]
			y(b(e, 0), 0), y(b(e, 1), 1), y(b(e, 2), 2), y(b(e, 3), 3), C()
		}
		function b(t, e) {
			for (var i = 0; i < e; i++) {
				if ('' == t.pjs_parent) {
				...
				;-1 != o.playlist_dic[t.pjs_parent].pjs_parent &&
					(t = o.playlist_dic[t.pjs_parent])
			}
			return t
		}
		function y(t, e) {
			if (t)
				if (-1 == t) hide2(i[e])
					...
					show2(i[e])
					var l = []
					for (var d in (l.push(t), o.playlist_dic))
						o.playlist_dic.hasOwnProperty(d) &&
							o.playlist_dic[d].pjs_parent == t.pjs_parent &&
							l.push(o.playlist_dic[d])
					for (var v = x(o.plid), h = 0; h < l.length; h++) {
						...
						css(g, {
							...
							'padding-top': c.paddingtop,
							'padding-bottom': c.paddingbottom,
							'padding-left': c.paddingleft,
							'padding-right':
								c.paddingright + (o.screen_w > 400 ? 3 * c.arrowsize : 0),
						}),
							css(
								g,
								0 == h
									? { color: u, 'background-color': hex2rgb(p, c.bga) }
									: {
											color: c.color,
											'background-color': hex2rgb(c.bgcolor, c.bga),
									  }
							),
							h > 1 &&
								1 == c.borderbottom &&
								css(g, {
									'border-top': '1px solid ' + hex2rgb(c.bordercolor, 0.5),
								}),
							v.indexOf(l[h].id) > -1 &&
								h > 0 &&
								(css(g, { color: c.valuecolor }),
								1 == c.playbgcolored &&
									exist(c.playbgcolor) &&
									css(g, { backgroundColor: c.playbgcolor })),
							(g.innerHTML =
								l[h].title + (0 == h && o.screen_w > 400 ? f : '')),
							g.setAttribute('me', (0 == h ? 'head_' : '') + l[h].id),
							0 == h
								? (v.indexOf(l[h].id) > -1 || e > 0
										? (a[e] = l[h].id)
										: (g.innerHTML = '...' + f),
								  s[e].appendChild(g))
								: (o.plhistory[l[h].id] && l[h].id != o.plid && I(g),
								  n[e].appendChild(g))
					}
					css(n[e], { height: 'auto' }),
						(r[e] = n[e].offsetHeight),
						css(n[e], { height: 0 }),
						i[e].addEventListener('click', _),
						i[e].addEventListener('mouseover', T),
		...
		function x(t) {
			...
			if (e)
				for (var s = 0; s < l; s++)
					i.push(e.id), '' != e.pjs_parent && (e = o.playlist_dic[e.pjs_parent])
			return i
		}
		function _(t) {
			var n = t.target
			...
			if (l)
				if (0 == l.indexOf('head_')) {
					...
					if ((show2(s[e]), a[e] == l)) {
						if ((S(), e > 0)) return void k(e - 1)
						e = -1
					} else a[e] = l
					o.playlist_dic[l].folder
						? (o.controls.PlaylistPlayId(l), S(), (e = -1), w())
						: (S(), (e = -1), api('play', 'id:' + l))
				}
		}
		function w() {
			for (var t in o.playlist_dic)
				if (
					...
					o.playlist_dic[o.plopenid] &&
					o.playlist_dic[t].pjs_parent == o.playlist_dic[o.plopenid].id
				) {
					if (
						((o.plopenid = o.playlist_dic[t].id), m(), o.playlist_dic[t].folder)
					)
						n[0].childNodes.length < 2 ? w() : k(0)
					else if (1 == c.dropautoplay) {
		...
		function k(t) {
			css(n[t], { height: r[t] }),
				css(n[t], { 'border-top': '1px solid #' + c.headbordercolor }),
				css(s[t].childNodes[0], { 'background-color': hex2rgb(p, 1) }),
		...
		function S() {
			e > -1 &&
				(css(n[e], { height: 0 }),
				css(n[e], { 'border-top': 'none' }),
				css(s[e].childNodes[0], { 'background-color': hex2rgb(p, c.bga) }),
				css(s[e].getElementsByTagName('svg')[0], { transform: 'scale(1, 1)' }))
		}
		function T(t) {
			var i = t.target,
				s = i.getAttribute('me')
			x(o.plid)
			s &&
				(-1 == e || 0 == s.indexOf('head')
					? css(i, { 'background-color': hex2rgb(p, 1) })
					: (1 == c.playbgcolored && exist(c.playbgcolor) && s == a[e]) ||
					  css(i, {
							'background-color': hex2rgb(
								c.bgcolorover,
								c.bgaover > -1 ? c.bgaover : c.bga
							),
					  }))
		}
		function P(t) {
			...
			if (n)
				if (-1 == e || 0 == n.indexOf('head_')) {
					...
					r == i[0] && (l = 0),
						r == i[1] && (l = 1),
						r == i[2] && (l = 2),
						css(s, { 'background-color': hex2rgb(p, e == l ? 1 : c.bga) })
				} else
					o.plhistory[n] && n != o.plid && I(s),
						(1 == c.playbgcolored && exist(c.playbgcolor) && n == a[e]) ||
							css(s, { 'background-color': hex2rgb(c.bgcolor, c.bga) })
		}
		function O(t) {}
		function C() {
			if (isVisible(i[0])) {
				...
				if (
					((d =
						...
						t -
						(o.screen_h > 200
							? v.toolbar.h + (o.screen_h > 400 ? 60 : 30)
							: 0)),
					t > 0 &&
						(d =
							Math.round(d / t) * t +
							(1 == c.borderbottom ? Math.round(d / t) : 0) -
							(o.screen_h <= 200 ? 5 : 0)),
					d > 0)
				)
					for (e = 0; e < l; e++)
						n[e].scrollHeight > d
							...
							: css(n[e], { overflow: 'hidden', 'max-height': 'none' }),
							v.playlist.position.indexOf('right') > -1
								? css(i[e], { right: c.marginright + L(e) })
								: (css(i[e], { left: c.marginleft }),
								  e > 0 && css(i[e - 1], { left: c.marginleft + E(e) }))
			}
		}
		function E(t) {
			for (var e = 0, o = l - 1; o >= t; o--)
				e += i[o].offsetWidth + (i[o].offsetWidth > 0 ? c.marginright : 0)
			return e
		}
		function L(t) {
		...
		function A(t) {
			for (var e = 0; e < l; e++) 1 == t ? show2(i[e]) : hide2(i[e])
		}
		function I(t) {
			css(t, { color: c.historycolor }),
				1 == c.historytitlestrike &&
					css(t, { 'text-decoration': 'line-through' }),
				c.historytitlea > -1 && css(t, { opacity: c.historytitlea }),
				css(t, {
					backgroundColor: hex2rgb(
						c.historybgcolor,
						c.historybga > -1 ? c.historybga : c.bga
					),
				})
		}
		;(this.OpenScroll = function () {
			return (function (t) {
				return t > -1 && n[t].scrollHeight > d
			})(e)
		}),
			(this.Hide = function () {
				A(0)
			...
			(this.Update = function () {
				if (0 != o.plopenid) {
					var t = 0
					!isVisible(i[0]) && (t = 1), m(), t && A(0)
				}
			}),
			(this.Resize = function () {
				clearTimeout(t), (t = setTimeout(C, 500))
			}),
			(this.Close = function () {
				S(), (e = -1)
			}),
			(this.Remove = function () {
				for (var t = 0; t < l; t++)
					i[t].removeEventListener('click', _),
						i[t].removeEventListener('mouseover', T),
						i[t].removeEventListener('mouseout', P),
						n[t].removeEventListener('wheel', O),
	...
	var PluginHotIcon = function (t, e) {
			var i,
				s = 2
			function n() {
				i && (o.frame.removeChild(i), (i = null))
			}
			o.screen_w > 500 && (s = 4),
				o.screen_w > 1e3 && (s = 5),
				1 == v.hotkey[t + 'icon'] &&
					(v.hotkey[t + e + 'icon'] || 'volume' == t) &&
					(('' == v.hotkey[t + e + 'icon'] && 'volume' != t) ||
						((i = createElement('div')),
						css(i, {
							position: 'absolute',
						...
						(i.innerHTML =
							'volume' == t
								? (o.muted ? 0 : Math.round(100 * v.volume)) + '%'
								: v.hotkey[t + e + 'icon']),
						css(i, {
						...
						setTimeout(function () {
							i &&
								(css(i, { transform: 'scale(' + 2 * s + ')', opacity: 0 }),
								setTimeout(n, 500))
						}, 50)))
		},
		PluginHdIcon = function (t, e, i) {
			...
			t.appendChild(n),
				...
				1 == i.hdicon2 && i.hdiconlist
					? ((s = i.hdiconlist.split(',')),
					  css(n, {
							'font-size': 8,
							color: '#fff',
				...
				(this.toggle = function () {
					...
					if (1 == i.hdicon2) {
						...
						'' == l
							? t > 700 && ((r = !0), (n.innerHTML = 'HD'))
							: ((r = !0), (n.innerHTML = l))
					} else t > 700 && (r = !0)
					r
						? (show2(n),
						  e.offsetWidth - n.offsetWidth > 0 &&
								css(n, { left: (e.offsetWidth - n.offsetWidth) / 2 - 2 }))
						: hide2(n)
				})
		},
		PluginSettings2 = function () {
			...
			for (var l in v.settings)
				v.settings.hasOwnProperty(l) &&
					l.indexOf('combined') > -1 &&
					(r[l.substr(8)] = v.settings[l])
			...
			var d,
				c,
				u,
				p = '<pjsdiv style="display:inline-block;width:20px"></pjsdiv>',
				f =
			...
			function h(l, x) {
				...
				for (
					...
					var O = copyObject(o['files_' + w[P]]),
						C = o['current_' + w[P]]
					if ('share' == w[P] && o.share) {
						;(O = []), (u = [])
						for (var E = 1; E <= 16; E++)
							exist(v['share' + E]) &&
								(O.push(Lang(v['share' + E])), (u[O.length] = v['share' + E]))
					}
					if (O) {
						if (O.length > 1) {
							;(e[P] = createElement('div')),
								...
								1 != r.notitle &&
									...
									(i[P].innerHTML = p + '<b>' + Lang(w[P]) + '</b>')),
								(items[P] = []),
								'subtitle' != w[P] ||
									o.hls_subs ||
									o.dash_subs ||
									(O.push(Lang('options')), (s = O.length)),
								'subtitle' == w[P] &&
									1 == v.sub_upload &&
									!o.system.tv &&
									o.sbt &&
									...
									(n = O.length))
							var L = createElement('div')
							e[P].appendChild(L), css(L, { float: 'left' })
							var A = 1,
								I = 0
							for (E = 0; E < O.length; E++) {
								if (O[E]) {
									...
									if (
										('subtitle' == w[P] &&
											(O[E] != Lang('off') || o.subtitle_on || (H = !0)),
										'quality' == w[P] &&
											(O[E] == Lang('auto') &&
												o.media.autoQuality() &&
												(H = !0),
										...
										for (
											var M = v.forbidden_quality.split(','), V = 0;
											V < M.length;
											V++
										)
											O[E].indexOf(M[V]) > -1 && (j = !1)
									if (j) {
										;(items[P][E] = createElement('div')),
											css(items[P][E], {
												display: 'block',
												margin: r.margin,
												padding: 7,
												...
												opacity: 0.7,
												transition:
													'opacity 0.1s linear,background 0.1s linear',
												cursor: 'pointer',
											})
										var H = !1
										'speed' == w[P] &&
											...
											E == C || H
												...
												: (items[P][E].innerHTML =
														...
														O[E] +
														'</pjsdiv>'),
											attr(items[P][E], { is: w[P] + ',' + E }),
											'quality' == w[P] && E > 0
												? L.insertBefore(items[P][E], items[P][E - 1])
												: L.appendChild(items[P][E]),
											items[P][E].addEventListener('mouseover', g, !0),
											items[P][E].addEventListener('mouseout', m, !0),
											items[P][E].addEventListener('click', _, !0)
									}
								}
								e[P].offsetHeight > o.screen_h - r.bottom &&
									((E != A * I + 1 && 1 != A) ||
										(x && O.length - E > 1
											? css(L, {
						...
						for (var z = 0; z < S.length; z++)
							w[P].indexOf(S[z]) > -1 &&
								((k = S[z]),
								w[P].indexOf(':') > -1 &&
									(T = 1 * w[P].substr(w[P].indexOf(':') + 1)))
				}
				o.screen_w < t.scrollWidth && !x
					? h(l, !0)
					: ('left' == k &&
							css(t, { right: 'auto', left: T + 'px', 'margin-left': 0 }),
					  'center' == k &&
							css(t, {
								right: 'auto',
								left: '50%',
					  ...
					  'right' == k &&
							css(t, { left: 'auto', right: T + 'px', 'margin-left': 0 }),
					  n > 0 &&
							!a &&
			...
			function g(t) {
				;(x = t.target),
					x && (css(x, { background: hex2rgb(r.color, 0.2), opacity: 1 }), b())
			}
			function m(t) {
				;(x = t.target),
					x &&
						(css(x, { background: 'none' }),
						1 != x.getAttribute('yes') && css(x, { opacity: 0.7 }),
						y())
			}
			function b() {
					...
					if (e) {
						...
						if (2 == i.length) {
							if ('subtitle' == i[0] && o.sbt) {
								if (i[1] == n - 1) return void o.sbt.SubUpload()
								if (i[1] == s - 1) return void o.controls.SubOpt()
							...
							'quality' == i[0] && o.actions.SetQuality(i[1]),
								...
								'scale' == i[0] &&
									(0 == i[1] && o.media.scale(v.settings.scale / 100),
						...
						for (var e = 0; e < items.length; e++)
							if (items[e])
								for (var i = 0; i < items[e].length; i++)
									items[e][i] &&
										(items[e][i].removeEventListener('mouseover', g),
										items[e][i].removeEventListener('mouseout', m),
										items[e][i].removeEventListener('click', _))
					;(t.innerHTML = ''), (o.controlover = !1), (c = !1)
				}
			}
			;(this.show = function (t) {
				h(t)
			...
			function t(t) {
				'resize' == t &&
					...
					'stopsnow' == t &&
						...
						o.effectsnow.stop(),
					'play' == t &&
						(o.tagvideo && css(o.media.tag(), { filter: 'none' }),
						1 != v.effectnozoom && o.media.normalscale()),
					'pause' == t &&
						(o.tagvideo &&
							(1 == v.effectgray && 1 == v.effectblur
								? (css(o.media.tag(), { filter: 'blur(5px) grayscale(100%)' }),
								  1 != v.effectnozoom && o.media.scale(0.1))
								: (1 == v.effectgray &&
	...
	o.lang_ru = {
		...
		normal: 'Normal',
		error: 'Error',
		unmute_video: 'Turn up the sound',
		loading_error: 'Loading error',
		next: 'Next',
		share: 'Share',
		skip: 'Skip',
		skip_after_: 'Skip after ',
		upload: 'Upload',
		hour: 'Hour',
		minute: 'Minute',
		second: 'Second',
	...
	var Motion = function (t) {
			...
			if (null != t.me && null != t.mc && null != t.type && null != t.to) {
				null == t.time &&
					...
					-1 == t.type.indexOf('scale') &&
						(exist(o.motions[t.me]) && o.motions[t.me].TheEnd(),
						(o.motions[t.me] = this)),
				...
				for (var u = 0; u < i.length; u++)
					n[u] || (n[u] = n[0]),
						...
						'width_div' == i[u] &&
							((s[u] = t.mc.offsetWidth),
							(n[u] = Math.floor(n[u])),
							'line_play' == t.me &&
								log('width', t.me, s[u], n[u], t.mc.offsetWidth)),
			...
			function p() {
				for (var o = 0; o < i.length; o++) {
					...
					f(i[o], u),
						...
						'width_div' == i[o] && css(t.mc, { width: u }),
						'height' == i[o] && t.mc.set('height', u),
						'height_div' == i[o] && css(t.mc, { height: u })
				}
				d++, c || (d == a ? v() : (l = setTimeout(p, Math.round(r))))
			}
			function v() {
				;(c = !0),
					t.hide &&
						('alpha_div' == i[0] || 'left' == i[0]
							? hide(t.mc)
							: t.mc.set('display', !1)),
					-1 == t.type.indexOf('scale') &&
						((o.motions[t.me] = null), delete o.motions[t.me])
				for (var e = 0; e < i.length; e++) f(i[e], n[e])
				clearTimeout(l)
			}
			function f(e, o) {
		...
		System = function () {
			...
			;(this.browser = s ? s[1] : e),
				...
				(this.ios =
					i.search(/(iphone|ipad|ipod)\/?\s*/i) > -1 ||
					('MacIntel' === navigator.platform && n > 1)),
				(this.tv =
					1 != v.notv &&
					i.search(/(TV|tvOS|webOS|armv|BRAVIA|Roku|Tizen|Philips)\/?\s*/i) >
						-1),
				...
				i.search(/(android)\/?\s*/i) > -1 &&
					(n > 0 ? (this.android = !0) : (this.tv = !0),
					matchMedia('(pointer:fine)').matches && (this.tv = !0)),
				(this.mobile =
					(this.ios ||
						this.android ||
						i.search(/(blackberry|iemobile|opera mini)\/?\s*/i) > -1) &&
					!this.tv),
				(this.mutedautoplay = this.safari || this.chrome),
				(this.fullscreen = !1),
				this.ios &&
					((this.iosv = parseFloat(
						i.substr(i.indexOf('OS ') + 3, 4).replace('_', '.')
					)),
					this.ipad &&
						(!1 in window || n < 2) &&
		...
		for (var o in e)
			if ('object' == typeof e[o])
				if ('events' == o || 'file' == o) t[o] = e[o]
					...
					for (var i in e[o])
						if (
							('object' != typeof t[o] && (t[o] = {}),
							'object' == typeof e[o][i])
						)
							for (var s in e[o][i])
								if (
									('object' != typeof t[o][i] && (t[o][i] = {}),
									...
									for (var n in e[o][i][s])
										'object' != typeof t[o][i][s] && (t[o][i][s] = {}),
											(t[o][i][s][n] = e[o][i][s][n]),
											('padding' != s && 'margin' != s) ||
												(t[o][i][s][n] = parseInt(t[o][i][s][n]))
								else
									(t[o][i][s] = e[o][i][s]),
										('padding' != i && 'margin' != i) ||
											(t[o][i][s] = parseInt(t[o][i][s]))
						else
							(t[o][i] = e[o][i]),
								('padding' != o && 'margin' != o) ||
									(t[o][i] = parseInt(t[o][i]))
			else
				(o.indexOf('roll') > 0 && '' === trim(e[o])) ||
					(t[o] = SettingsParser(o, e[o]))
		return t
	}
	...
	var Lang = function (t) {
		var e = t
		e &&
			(e = t.charAt(0).toUpperCase() + t.slice(1)).indexOf('_') > -1 &&
			(e = e.replace(/_/gi, ' '))
		var i = {
			of: 'of',
			kbps: 'kbps',
	...
	var gaTracker = function (t, e, i) {
		if (!exist(o.gatracked[e]) && 1 != v.HDVBPlayercom) {
			var s,
				n = getSwarmId()
			if (
				(exist(v.label) && (n = v.label),
				1 == v.yamtr_event[t] &&
					1 == v.yamtr &&
					exist(v.yamtrid) &&
					('init' == t && setInterval(yaHit, 3e5),
					exist(window['yaCounter' + v.yamtrid])
						? (window['yaCounter' + v.yamtrid].reachGoal('HDVBPlayer_' + t, {
								title: n,
						  }),
						  log('Yandex', 'HDVBPlayer_' + t))
				...
				if (1 == v.ga)
					if (1 == v.ga4) {
						...
						window.ga &&
							((s = { eventCategory: 'Player', eventAction: e }),
							'' != n && (s.eventLabel = n),
	...
	function yaHit() {
		exist(window['yaCounter' + v.yamtrid]) &&
			window['yaCounter' + v.yamtrid].reachGoal('getSwarmId')
	}
	var YoutubeID = function (t) {
			var e = ''
			if (
				((t = t.replace('v=', '{=')).indexOf('youtu.be/') > -1
					? (e = t.substr(t.indexOf('.be/') + 4)).replace('/', '')
					: (e = t.split(
				...
				var o = 0,
					...
					s = 0
				v.start.indexOf('h') > 0 &&
					((o = v.start.substr(0, v.start.indexOf('h'))),
					(v.start = v.start.substr(v.start.indexOf('h') + 1))),
					v.start.indexOf('m') > 0 &&
						((i = v.start.substr(0, v.start.indexOf('m'))),
	...
	function apiProcessor(t, e, i) {
		...
		if (1 != o.destroyed) {
				...
				if (exist(e)) {
					...
					if ('string' == typeof e) {
						...
						if (
							...
							if (
								((n = e.substr(e.indexOf('[seek:') + 6, e.length - 1)),
								(n = parseInt(n.substr(0, n.length - 1))),
								'' == (e = e.substr(0, e.indexOf('[seek:'))))
							)
								return o.actions.Seek(n), void o.actions.Play()
							o.seekto = n
						}
						if (
							(e.indexOf('[skipads]') > -1 &&
								((s = !0), (e = e.replace('[skipads]', ''))),
							0 == e.indexOf('#' + v.enc2) && (e = o[o.fd[0]](e)),
							0 == e.indexOf('#' + v.enc3) &&
								e.indexOf(v.file3_separator) > 0 &&
								(e = o[o.fd[1]](e)),
						...
						if (0 == e.indexOf('id:') && exist(o.playlist_dic)) {
							var a = FindIdPl(e)
							return (
								!!exist(o.playlist_dic[a]) &&
								(o.controls.PlaylistPlayId(a), n > -1 && (o.seekto = n), !0)
							)
						}
						if (0 == e.indexOf('youtubeid:')) {
							a = e.substr(10)
							if ('youtube' == o.file_type)
								return o.media.playByYoutubeId(a), !0
							e = '//youtu.be/' + a
						}
					}
					'play' == t &&
			...
			if (
				('preload' == t &&
					(exist(e)
						? ((o.newfile = !0), o.actions.NewFile(e, 1, 1))
						: o.media.Preload()),
				'pause' == t &&
					o.play &&
				...
				'stop' == t &&
					...
					o.media.Recover(),
					o.actions.Stop()),
				'reload' == t && ((o.time = o.media.time()), o.actions.Reload()),
				'download' == t &&
					v.apiprm &&
					1 == v.apiprm.on &&
					1 == v.apiprm.dwn &&
				...
				if (0 == e.indexOf('js:'))
					(v.midroll = e), (v.midrolls = !0), o.actions.advertising('midroll')
				else if ('' != o.p) {
			...
			if (
				('vastbreak' == t && 'function' == typeof VastBreak && VastBreak(),
				'cuid' == t &&
					e &&
					((v.cuid = e), o.continue && o.continue.updateCuid()),
			...
			if (
				('unmute' == t && o.actions.Unmute(),
				'thumbnails' == t && exist(e) && ((v[t] = e), o.actions.Thumbs()),
				'qualities' == t)
			)
			...
			if ('volume' == t || 'setVolume' == t)
				return (
					exist(e) && e >= 0 && e <= 1 && o.actions.Volume(e),
					o.muted ? 0 : v.volume
				)
			if ('muted' == t) return !!exist(o.muted) && o.muted
			if (
				('moveplaylist' == t && o.controls && o.controls.PlaylistMove(e),
				'design' == t && (e < 2 && (e = ''), '' != o['u' + e]))
			) {
				...
				if ('object' == typeof d)
					for (var u in d)
						d.hasOwnProperty(u) &&
							(0 == u.indexOf('control_') && (v[u] = d[u]),
							'toolbar' == u && (c[u] = d[u]))
				v = UpdateObject(v, c)
				var p = !1
				o.controls.SettingsVisible() && (o.controls.Settings(), (p = !0))
				var f = !1
				o.controls.PlaylistVisible() && (o.controls.Playlist(), (f = !0)),
					o.controls.Remove(),
					(o.controls = null),
					...
					if (e.indexOf('%') > -1)
						...
						if (o.continue && !o.start)
							if (!o.continue.seeked)
								(g = o.continue.flag()).t &&
									g.d &&
									((h = g.t), (o.continue.seeked = !0))
						0 == e.indexOf('+')
							? (e = h + parseInt(e.substr(1)))
							: 0 == e.indexOf('-') && (e = h - parseInt(e.substr(1)))
					}
				;(e *= 1) < 0 && (e = 0),
					o.media.duration() > 0 && e > o.media.duration() && (e = 0),
					!exist(o.vast) && !exist(o.vastloader) && o.media.duration() > 0
						? ((o.seekto = void 0), o.actions.Seek(e, !0), o.actions.Playing())
						: (o.seekto = e)
			}
			if (
				('fullscreen' == t && !o.fullscreen && o.actions.Fullscreen(),
			...
			if (
				('fix' == t && exist(o.minify) && o.minify.Do(),
				('unfixing' != t && 'unfix' != t) || (exist(o.minify) && o.minify.Un()),
				'time' == t)
			) {
				var g,
					m = o.media ? o.media.time() : 0
			...
			if (
				('points' == t && e && ((v.points = e), o.controls.RenewPoints()),
				'quality' == t)
			) {
			...
			if (
				('youtubeready' == t && 1 != o.destroyed && o.media.onYoutubeReady(),
				'id' == t)
			)
				return v.id
			if (
				...
				'switchpip' == t &&
					(o.media.PipSwitch(), i && (o.piped = Switcher(o.piped, e, i))),
				...
				'subtitle' == t &&
					((v.subtitle = e),
					exist(e) &&
						(e.toString().length < 3 && o.sbt
							? o.sbt.SetSubtitle(1 * e)
							: o.actions.Subtitle(e))),
				'quiz' == t && exist(o.quiz))
			) {
			...
			if ('screenshot' == t) {
				if (o.tagvideo) {
					...
					_.drawImage(o.media.tag(), 0, 0, y.width, y.height)
					var w = document.createElement('canvas')
					;(w.width = 2 * y.width), (w.height = 2 * y.height)
					var k,
						S = w.getContext('2d')
					S.drawImage(o.media.tag(), 0, 0, 2 * y.width, 2 * y.height),
						1 == v.sscopyright &&
							...
							S.fillText(
								...
								v.ssfontsize,
								2 * y.height - v.ssfontsize - 5
							)),
						_.drawImage(w, 0, 0, y.width, y.height)
					try {
			...
			if ('title' == t)
				return exist(e)
					? (exist(e) && (v.title = e), o.actions.Title('title'), !0)
					: v.title
			var T
			if (
				('invert' == t && o.actions.InvertPlaylist(),
				'push' == t &&
					e &&
					(!o.playlist_source && (o.playlist_source = []),
					'object' == typeof e &&
						((e = o.playlist_source.concat(e)), (t = 'playlist'))),
				'playlist' == t && e)
			)
				if ('object' == typeof e)
					try {
			...
			if (
				('next' == t && o.controls && o.controls.PlaylistNext(),
				...
				for (var P in (!o.play && (v.autoplay = 0), o.playlist_dic))
					o.playlist_dic.hasOwnProperty(P) &&
						o.playlist_dic[P].pjs_id == e &&
						(e = P)
				return (
					-1 === e.indexOf('xxx-') &&
						('x-' == e.substr(0, 2) &&
							(e =
								o.playlist_dic[e].folder[o.playlist_dic[e].folder.length - 1]
									.id),
						'xx' == e.substr(0, 2) &&
							(e =
								o.playlist_dic[e].folder[o.playlist_dic[e].folder.length - 1]
									.id)),
					!!exist(o.playlist_dic[e]) && (o.controls.PlaylistOpenId(e), !0)
				)
			}
			if ('playlist_folders' == t) {
				var O = []
				if (exist(o.playlist_dic))
					for (var P in o.playlist_dic)
						o.playlist_dic[P].folder &&
							-1 == o.playlist_dic[P].pjs_parent_i &&
							O.push({
			...
			if (
				('showplaylist' == t && o.controls.PlaylistShow(),
			...
			if (
				('captions' == t &&
					((v.captions = Switcher(v.captions, e, i)), o.media.captions()),
				'loop' == t)
			)
			...
			if ('autonext' == t || 'playlistloop' == t) {
				a = 'autoplaylist'
				return (
					'playlistloop' == t && (a = 'playlistrewind'),
					exist(i)
						? (v.playlist[a] = Switcher(v.playlist[a], e, i))
						: exist(e) &&
						  ('0/1' == e && (e = 1 - v.playlist[a]), (v.playlist[a] = e)),
					v.playlist[a]
				)
			}
			if (
			...
			if (0 == t.indexOf('update:')) {
				var C = t.substr(7)
				if ('object' == typeof e && 'object' == typeof v[C])
					for (var E in e) e.hasOwnProperty(E) && (v[C][E] = e[E])
				else -1 == t.indexOf('rc_') && (v[C] = e)
				return !0
			}
			return (
				0 == t.indexOf('text:') && o.controls.customText(t.substr(5), e),
				'currentfile' == t
					? o.media
						? o.media.currentFile()
						: ''
	...
	function Switcher(t, e, o) {
		...
		if (e.indexOf('/') > 0) {
			...
			2 == s.length &&
				(t == trim(s[0])
					? ((i = trim(s[1])), o && o.CustomSwitch(1))
					: ((i = trim(s[0])), o && o.CustomSwitch(0)))
		}
		return i
	}
	function XHR(t) {
	...
	function VastInfo() {
		...
		if (
			...
			var e = {
				...
				url:
					o.current_vast_url +
					(t.info('wrapper') ? t.info('wrapper0') + t.info('wrapper') : ''),
	...
	var createElement = function (t) {
			...
			return 'div2' == t && css(o, { cursor: 'pointer', display: 'block' }), o
		},
			...
			if (1 == v.log || 1 == v.logout) {
				...
				console.log('HDVBPlayer' + (1 == v.pjsframed ? '2' : '') + ': ' + r),
					1 == v.logout &&
						...
						(document.getElementById('pjslog').innerHTML += r + '<br/>')
			}
		},
		...
		SvgColor = function (t, e) {
			for (
				var o = ['path', 'polygon', 'polyline', 'rect', 'ellipse', 'circle'],
					i = 0;
				i < o.length;
				i++
			) {
				var s = t.querySelectorAll('svg ' + o[i])
				if (s.length > 0) for (var n = 0; n < s.length; n++) s[n].style.fill = e
			}
		},
		Time = function (t) {
			t < 0 && (t = 0)
		...
		timeFormat = function (t) {
			...
			var n =
				...
				(i >= 0 ? i : '0') +
				':' +
				(e = (e = Math.floor(e % 60)) >= 0 ? (e >= 10 ? e : '0' + e) : '00')
		...
		Scripted = function (t) {
			for (
				var e = !1, o = document.getElementsByTagName('script'), i = 0;
				i < o.length;
				i++
			)
		...
		hex2rgb = function (t, e) {
			t = t.replace('#', '')
			var o = parseInt(
					3 == t.length ? t.slice(0, 1).repeat(2) : t.slice(0, 2),
					16
				),
				i = parseInt(
					3 == t.length ? t.slice(1, 2).repeat(2) : t.slice(2, 4),
					16
				),
				s = parseInt(
					3 == t.length ? t.slice(2, 3).repeat(2) : t.slice(4, 6),
					16
				)
			return e
				? 'rgba(' + o + ', ' + i + ', ' + s + ', ' + e + ')'
				...
				for (var o in e)
					e.hasOwnProperty(o) &&
						...
						('number' == typeof e[o] &&
							...
							'zIndex' != o &&
							(e[o] += 'px'),
						(o.indexOf('color') > -1 || o.indexOf('Color') > -1) &&
							-1 == e[o].indexOf('#') &&
							-1 == e[o].indexOf('rgba') &&
							(e[o] = '#' + e[o]),
						'transform' == o &&
						...
						'fontFamily' == o &&
							...
							(e[o] = '"' + e[o] + '"'),
						'box-sizing' == o
							? t.style.setProperty(o, e[o], 'important')
							: (t.style[o] = e[o]))
		},
		...
		controlCSS = function (t, e, i) {
			...
			var s = random(1e5, 1e6),
				n = (t = (t = t.replace(/\(rand\)/g, s)).replace(
					/\(color\)/g,
					e
				)).substr(0, t.indexOf('|||')),
		...
		pushCSS = function (t) {
			o.css &&
				(o.css.styleSheet
					? (o.css.styleSheet.cssText = t)
					: o.css.appendChild(document.createTextNode(t)))
		},
		Pos0 = function (t) {
			css(t, {
				position: 'absolute',
		...
		decode = function (t) {
			return '#1' == t.substr(0, 2)
				? salt.d(pepper(t.substr(2), -1))
				: '#0' == t.substr(0, 2)
				? salt.d(t.substr(2))
				: t
		},
			...
			d: function (t) {
				...
				for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ''); l < t.length; )
					(i = this._keyStr.indexOf(t.charAt(l++))),
						(e =
							((15 & (s = this._keyStr.indexOf(t.charAt(l++)))) << 4) |
			...
			_ue: function (t) {
				...
				for (var e = '', o = 0; o < t.length; o++) {
					...
					i < 128
						? (e += dechar(i))
						: i > 127 && i < 2048
						? ((e += dechar((i >> 6) | 192)), (e += dechar((63 & i) | 128)))
						: ((e += dechar((i >> 12) | 224)),
						  (e += dechar(((i >> 6) & 63) | 128)),
						  (e += dechar((63 & i) | 128)))
				}
				...
				if (t.hasOwnProperty(s)) {
					...
					for (var a in t[s])
						t[s].hasOwnProperty(a) &&
							(n += t[s][a] == i ? dechar(49) : dechar(48))
					;(e = parseInt(n, 2)), (o += dechar(e.toString(10)))
				}
		...
		checkFont = function (t) {
			return (
				1 == v.globalfont && exist2(v.globalfontname) && (t = v.globalfontname),
				t
			)
		},
		findTop = function (t) {
		...
		redirect = function (t) {
			'' != t &&
				(1 == v.redirectblank ? window.open(t) : (window.location.href = t),
				(t = ''))
		},
		...
		Actions = function () {
			...
			function Prefile(t) {
				return (
					exist(v.prefile) && -1 == t.indexOf('//') && (t = v.prefile + t), t
				)
			}
			function Thumbs() {
				1 == v.thumbs &&
			...
			o.system.tv && log('tv'),
				...
				(this.File = function (t) {
					...
					if ('string' == typeof t) {
						if (
							...
							(t.indexOf(']') > -1 && t.indexOf('[') > -1) || exist(v.qualities)
						...
						if (o.files.length > 0) {
							...
							for (n = 0; n < o.files.length; n++)
								if (((o.files[n] = trim(o.files[n])), '' != o.files[n])) {
									0 == o.files[n].indexOf('[') && o.files[n].indexOf(']') > 1
									...
									exist(v.default_quality) &&
										...
										(0 == String(v.default_quality).indexOf('num:') &&
											1 * v.default_quality.substr(4) == n &&
											(l = 1),
										...
										exist(o.default_quality) &&
											...
											((l = 1), (r = n)),
										1 == l && ((o.current_file = n), (o.current_quality = n)),
				...
				(this.NewFile = function (t, e, i, s) {
					;(this.sendStat = !1),
						...
						1 == v.vast &&
							1 != s &&
							(o.actions.VastRecover(), o.actions.VastRecover('midroll')),
						(t = this.File(t)),
						1 == e && (o.file_type = ''),
						o.media.File(t),
				...
				(this.TitleTemplate = function (t) {
					...
					if (t && o.title_template) {
						...
						for (var i = 1; i < 6; i++)
							exist(t['t' + i]) &&
								((v.title = v.title.replace('{' + i + '}', t['t' + i])),
								(e = !0))
					}
					return e
				}),
				...
				(this.Metadata = function () {
					o.media.Volume(v.volume),
						...
						o.casting && o.tagvideo && (o.chromecast.Exit(), o.chromecast.Go()),
						1 == v.vast &&
							1 != v.nomidroll &&
							1 == v.midrolls &&
							!exist(o.vast) &&
							MidrollOverlay('midroll', 'metadata')
				}),
						...
						if (
							...
							if (1 == v.fullonplay && !o.fullscreen)
								new Date().getTime() - o.clicktime < 300 &&
									(1 == v.fullonplaymobile
										? o.system.mobile && this.Fullscreen()
										: this.Fullscreen())
							if (
								(o.subtitle_on && 1 == v.subpausehide && show2(o.subtitle),
								o.err404v && o.err404v.remove(),
								(1 != t && Advertising('preroll')) ||
									Advertising('intro') ||
									Advertising('pausebannerinit') ||
									Advertising('endtaginit') ||
									Advertising('starttaginit'))
							)
								datetime(2)
							else if (
								(1 == v.redirect &&
				...
				(this.Pause = function () {
					o.play &&
						...
						o.media.time() > 1 &&
							!exist(o.banner) &&
							1 == v.pausebannerinit &&
							0 == v.pausebannerstatus &&
							Advertising('pausebannershow'),
						exist(o.vast) ||
							exist(o.vastloader) ||
							0 != v.pauserollonplay ||
				...
				(this.Volume = function (t, e) {
					t < 0.01 && (t = 0),
						t > 1 && (t = 1),
						t <= 0
							? (this.Mute(), (v.volume = 0), (t = 0))
							: (o.muted && this.Unmute(), (v.volume = t)),
						js('volume', t),
				...
				(this.Open = function (t, e, i) {
					'playing' == o.media.status() &&
						'audio' != o.mode &&
						(Pause(), o.fullscreen && i && o.actions.Normalscreen()),
						window.open(t, e)
				}),
				(this.Download = function () {
					var t = o.media.currentFile()
					;(exist(v.download) && (t = v.download), '' != t) &&
						(js('download'),
				...
				(this.Playing = function () {
					var t = o.media.time(),
						...
						i = e > 0 ? t / e : 0
					o.seeking
						? t != o.seeking_time && (o.seeking = !1)
						: o.controls && o.controls.Played(o.seekto > 0 ? o.seekto : t, e),
						(1 == v.ga || 1 == v.yamtr) &&
							e > 0 &&
					...
					for (var s = 0; s < 3; s++)
						o.quartile[s] || (i >= 0.25 * s + 0.25 && Quartile(s))
					if ((1 == v.reloadlog && log(1, t, e), 1 == v.reload && o.play)) {
						var n = !1,
							a = !1
						if ((1 == v.reloadlive && (o.media.isLive() || (n = !0)), t > 0))
							t != o.time || n ? (o.reloadTimer = 0) : (a = !0), (o.time = t)
					...
					if (
						(v.apiprm &&
							1 == v.apiprm.pld &&
							e > 0 &&
							(!o.pld && (o.pld = []), (o.pld[Math.round(t)] = 1)),
						1 == v.vast &&
							(1 != v.nomidroll &&
								1 == v.midrolls &&
								!exist(o.vast) &&
								MidrollOverlay('midroll', t, e),
							1 != v.nooverlay &&
								1 == v.overlays &&
								!exist(o.vast) &&
								MidrollOverlay('overlay', t, e)),
						1 == v.intros &&
							v.introstart > 0 &&
							t >= v.introstart &&
							(exist(o.vast) ||
						...
						this.sendStat,
						1 == v.pausebannerstatus && Advertising('pausebannerhide'),
						1 == v.endtaginit &&
							0 == v.endtagstatus &&
							o.media.time() > 0 &&
							Advertising('endtagtoggle'),
						1 == v.starttaginit &&
							0 == v.starttagstatus &&
							o.media.time() > 0 &&
							Advertising('starttagtoggle'),
						SettingsTimers('play'),
						...
						o.storage &&
							1 == v.timestore &&
							o.continue &&
							o.continue.write(t, e),
						o.cutted && o.cut && o.cut.play(t),
						exist(v.end) &&
							v.end > 0 &&
							t > v.end &&
							('youtube' == o.file_type
								? (o.media.Pause(), o.media.Seek(v.start > 0 ? v.start : 0))
					...
					js('fileend'),
						1 == v.loop
							...
							: (o.media.isLive() || 'youtube' == o.file_type
									? this.Stop()
									: 1 == v.finishrewind &&
									  (o.actions.Seek(v.start > 0 ? v.start : 0, !0),
					...
					try {
						...
						if (!t) {
							var s,
								n = o.frame
							if (
								('dm' == o.file_type || 'vimeo' == o.file_type) &&
								o.system.iphone &&
								1 == v.nativefullios
							)
							...
							n.requestFullscreen
								? ((o.realfullscreen = !0),
								  void 0 !==
										(s = n.requestFullscreen({ navigationUI: 'hide' })) &&
										s.then(function () {}).catch(function (t) {}))
								: n.requestFullScreen
								? (n.requestFullScreen({ navigationUI: 'hide' }),
								  (o.realfullscreen = !0))
								: o.frame.mozRequestFullScreen
								? (n.mozRequestFullScreen({ navigationUI: 'hide' }),
								  (o.realfullscreen = !0))
								: n.webkitRequestFullScreen
								? (n.webkitRequestFullScreen({ navigationUI: 'hide' }),
								  (o.realfullscreen = !0))
								: n.msRequestFullscreen &&
								  (n.msRequestFullscreen(), (o.realfullscreen = !0))
						}
					} catch (t) {
						;(e = !0), log(t)
					}
			...
			function VolumeWheel(t) {
				if (!((o.droplist && o.droplist.OpenScroll()) || 0 == t.wheelDelta))
					if (
						((1 == v.hotkey.scrollwheelfull && o.fullscreen) ||
						...
						var e = o.system.win
							...
							: v.hotkey.wheelstep / 10
						1 == v.hotkey.scrollwheelfull && o.fullscreen
							? o.media.scale(t.deltaY > 0 ? e : -e)
							: (o.actions.Volume(
									parseFloat(v.volume) + (t.deltaY > 0 ? e : -e),
									'no'
							  ),
			...
			function NewAspect(t, e) {
				if (exist(o.vast) && !e) o.resizeonplay = t
					...
					i ||
						((o.aspect = t),
						(o.container_h = s),
						o.aspect > 0 && css(o.container, { height: s }),
						js('height', s)),
						o.vast && !o.fullscreen && ((o.screen_h = s), o.vast.Resize())
				}
			}
			...
			function Advertising(t) {
				if (
					(1 == v.banner &&
						t.indexOf('pausebanner') > -1 &&
						void 0 !== PauseBannerPlugin &&
						(t.indexOf('init') > -1
							? (v.pausebannerinit = 1)
							: t.indexOf('show') > -1
							? (v.pausebannerstatus = 1)
							: t.indexOf('hide') > -1 && (v.pausebannerstatus = 0),
						PauseBannerPlugin(t)),
					'pushbanner' in o.u &&
						'status' in o.u.pushbanner &&
						!0 === o.u.pushbanner.status &&
						'pushbanner' == t &&
						PushBannerPlugin(t),
					1 == o.u.etag &&
						t.indexOf('endtag') > -1 &&
						void 0 !== EndTagBannerPlugin &&
						(('endtaginit' == t && 0 == v.endtaginit) || 'endtagtoggle' == t) &&
						EndTagBannerPlugin(t),
					1 == o.u.stag &&
						t.indexOf('starttag') > -1 &&
						void 0 !== EndTagBannerPlugin &&
						(('starttaginit' == t && 0 == v.starttaginit) ||
							'starttagtoggle' == t) &&
						StartTagBannerPlugin(t),
				...
				if (
					v['vast_' + t + 'timelimit'] > 0 &&
					o.media.duration() > 0 &&
					o.media.duration() < 60 * v['vast_' + t + 'timelimit']
				) {
				...
				if (('intro' == t || 'outro' == t) && 'undefined' != typeof PluginIntro)
					return (vasturl = []), PluginIntro(t)
				if (exist(o.vast) || exist(o.vastloader))
					return !isVisible(o.vastcontainer) || isVastBgLoad(o.vasttype)
						? (log('ad bg'), !1)
						: (log('ad now'), !0)
				if (exist(v[t])) {
					if (
						v[t].toString().indexOf('.') > -1 ||
						v[t].toString().indexOf(':') > -1 ||
						v[t].toString().indexOf('[yandex]') > -1
					) {
						js('vast_init', t),
							isVastBgLoad(t) ||
								'overlay' == t ||
								(setTimeout(function () {
									!(o.play || (null == o.vastloader && null == o.vast)) &&
										o.actions.Waiting()
								}, 10),
								Curtain()),
							PauseBannerPlugin('pausebannerhide'),
						...
						return (
							'' == vasturl[0][0]
								? VastNext()
								: o.vastloader.Load(trim(vasturl[0][0]), t),
							!0
						)
					}
					return !1
			...
			function MidrollOverlay(t, e, i) {
				if (exist(o[t + 'o']) && 1 == v[t + 's'])
					for (var s in o[t + 'o'])
						if (
							o[t + 'o'].hasOwnProperty(s) &&
							!exist(o[t + 'o'][s].worked) &&
							exist(o[t + 'o'][s].time) &&
							exist(o[t + 'o'][s].vast)
						) {
							...
							if (
								...
								o[t + 'o'][s].minduration &&
									o.media.duration() > 0 &&
									o.media.duration() < 1 * o[t + 'o'][s].minduration &&
									((o[t + 'o'][s].worked = !0), (a = !1)),
								a &&
									(o[t + 'o'][s].vast,
									(v[t] = o[t + 'o'][s].vast),
			...
			function isVastBgLoad(t) {
				for (var e = !1, i = ['midroll', 'pauseroll'], s = 0; s < i.length; s++)
					(o.vasttype != i[s] && t != i[s]) ||
						(1 == v['vast_' + i[s] + 'bgload'] && (e = !0))
				return e
			}
			...
			function VastAndLimit() {
				...
				if (o.vasttype) {
					...
					;(i || e) &&
						(i > 0 && o.vast_starts > 0
							? ((o.adsinchain = i), o.vast_impressions >= i && (t = !0))
							: e > 0 &&
							  ((o.adsinchain = e), o.vast_impressions >= e && (t = !0)))
				}
				return t
			}
			function VastNext() {
						...
						if ('?' != v.file)
							o.media.AfterVast(),
								'youtube' == o.file_type &&
									!o.vastclick &&
									o.system.ios &&
									((n = !0), 'preroll' == o.vasttype && o.media.reYT()),
								n ||
									'dontplay' == t ||
									1 == v.vast_dontplay ||
									setTimeout(() => o.actions.Play(1), 100)
					o.resizeonplay > 0 &&
			...
			function HidePoster2() {
				clearTimeout(o.pstr_to),
					(1 != v.posteronpause || o.play) &&
						(css(o.poster, { opacity: 0 }), setTimeout(HidePoster3, 500))
			}
			...
			function IndexPlaylistProcessor(t, e, i, s) {
				...
				for (var r = 0, l = 0; l < e; l++) {
					if (
						...
						(t[l].id =
							'x' + i + '-' + l + (exist(t[l].id) ? '-' + t[l].id : '')),
						-1 == s &&
							0 == l &&
							!exist(t[l].folder) &&
							(o.pl_first_id = t[l].id),
						exist(o.pl_first_id) ||
							(0 == s && !exist(t[l].folder) && (o.pl_first_id = t[l].id)),
						(t[l].pjs_parent = i),
						(t[l].pjs_parent_i = s),
						(t[l].pjs_i = r),
						exist(t[l].comment))
						...
						if (d > 0 && c > 0) {
							for (
								var u = t[l].file.substr(d + 1, c - d - 1),
									p = u.split(','),
									v = '',
									f = 0;
								f < p.length;
								...
								v +=
									...
									p[f] +
									']' +
									t[l].file.replace('[' + u + ']', p[f]) +
									(f < p.length - 1 ? ',' : '')
							t[l].file = v
						}
					}
					if (
						(exist(t[l].playlist) && (t[l].folder = t[l].playlist),
						exist(t[l].folder) ||
							(exist(t[l].file) && ('' != t[l].file || exist(t[l].redirect))) ||
							(n = !0),
						n || ((o.playlist_dic[t[l].id] = t[l]), (r += 1)),
						exist(t[l].folder))
					) {
						var h = Object.keys(t[l].folder).length
						h > 0 &&
							(t[l].folder = IndexPlaylistProcessor(t[l].folder, h, t[l].id, l))
					}
					n || a.push(t[l])
				}
				return a
				...
				gaTracker('end', 'End', 1),
					...
					o.controls.PlaylistExist()
						? 1 == v.playlist.autoplaylist && o.controls.PlaylistNextExist()
							...
							: End2()
						: (1 == v.finishnormal && o.fullscreen && o.actions.Normalscreen(),
						  ShowPoster(),
						  js('finish'))
			}
			function End2() {
			...
			;(this.FullscreenUI = function () {
				if (o.fullscreen_start) {
					...
					1 == v.fullblack && css(o.frame, { backgroundColor: '#000000' }),
						o.droplist && o.droplist.Close(),
						Sub(),
				...
				(this.SetQuality = function (t) {
					exist(o.current_quality) &&
						...
						((o.current_quality = t),
						1 == v.qualitystore &&
							((o.default_quality = o.files_quality[t]),
							o.storage &&
				...
				(this.SetAudioTrack = function (t) {
					exist(o.current_audiotrack) &&
						...
						((o.current_audiotrack = t),
						1 == v.trackstore &&
							((o.default_audio = v.default_audio = o.files_audiotrack[t]),
				...
				(this.SetSpeed = function (t, e) {
					...
					var i = t
					if (
						(String(i).indexOf('.') > 0 && (e = 1),
						(i *= 1),
						e ||
							((i = t == o.speed1 ? 1 : o.files_speed[t]),
							(o.current_speed = t)),
						o.line_speed || e)
					) {
				...
				(this.Subtitle = function (t) {
					'function' == typeof PluginSub &&
						(!o.sbt && (o.sbt = new PluginSub()), o.sbt.start(t))
				}),
					...
					if (
						...
						exist(o.vast)
							? (0 == v.preload &&
							  ...
							  (o.adsfirst = !1),
							  v.vast_prestarttimeout > 0
									? (log('VAST startdelay'),
									  js('vast_startdelay'),
									  setTimeout(VastGo, 1e3 * v.vast_prestarttimeout, t))
									: VastGo(t))
							: log('VAST alarm')
				}),
				...
				(this.VastInsertOr = function (t, e) {
					if ('' != t) {
						...
						if (vasturl[o])
							if ('object' == typeof t)
								for (var s = 0; s < t.length; s++) vasturl[o].push(t[s])
				...
				(this.VastRecover = function (t) {
					for (
						var e,
							i = ['preroll', 'pauseroll', 'postroll', 'intro', 'outro'],
							s = 0;
						s < i.length;
						s++
					)
						(e = !1),
							t && t != i[s] && (e = !0),
							!e &&
								exist(v[i[s].concat('_', 'recover')]) &&
								(v['vast_' + i[s].concat('_', 'limit')]--,
								v['vast_' + i[s].concat('_', 'limit')] > 0 &&
									((v[i[s]] = v[i[s].concat('_', 'recover')]),
									(v[i[s].concat('_', 'recover')] = null)))
					if (
						('preroll' == t || 'midroll' == t) &&
						v.vast_midroll_limit > 1 &&
						exist(o.midrollo) &&
						1 == v.midrolls
					) {
		...
		Media = function (t) {
			...
			if ('string' == typeof t) {
				...
				0 == t.indexOf('#' + v.enc2) && (t = o[o.fd[0]](t)),
					...
					t &&
						...
						(t =
							t.indexOf(o.pltxt) > 0
								? fd0(t.replace(o.pltxt, '')) + o.pltxt
								: fd0(t)),
					1 == v.fplace && (t = fplace(t)),
					'string' == typeof t &&
						(t.indexOf('.m3u') == t.length - 4 || t.indexOf('.txt') > 0) &&
						((d = t.split(' or ')), m())
			}
			function m() {
				;(t = d[h]).indexOf(o.pltxt) > 0 &&
					((t = t.replace(o.pltxt, '')), (v.file = t))
						...
						4 == this.readyState && 200 == this.status
							? (!(function (e) {
									if (e.responseText) {
										...
										if (
											(0 == i.indexOf('#' + v.enc2) && (i = o[o.fd[0]](i)),
											0 == i.indexOf('#' + v.enc3) &&
												i.indexOf(v.file3_separator) > 0 &&
												(i = o[o.fd[1]](i)),
				...
				if ((js('loaderror', t), e && e.length > 0))
					if (
						((i = ++s > e.length - 1) &&
							...
							(-1 ==
								...
								(o.files_quality[o.current_quality] =
									...
									')'),
							o.current_quality > 0
								? ((n = !1), o.actions.SetQuality(o.current_quality - 1), V())
								: -1 ==
						...
						!(o.seekto > 0 || !o.start || a.isLive()) && (o.seekto = S()),
							(o.file_type == I(e[s]) && 'native' == o.file_type) ||
								(o.play && (o.actions.Stop(), !0)),
			...
			function _(t, e) {
				gaTracker('error', 'Error', !0),
					1 != v.alerts ||
						o.media_error ||
						(1 == v.alert404 ? o.alert.txt(v.alert404text) : o.alert.txt(t),
						1 == v.alert404v &&
							exist(v.alert404video) &&
							((o.err404v = new PluginErrorVideo()), o.actions.HidePoster())),
					e && (o.media_error = !0),
			...
			function k() {
				...
				;(o.play || 1 == o.rldplay) &&
					((o.rldplay = 0),
					g < t ? o.actions.Reload() : _('Reload Error ' + a.errorMessage()))
			}
			function S() {
				return a.time()
			}
			...
			function E() {
				;('playing' == (c = a ? a.status() : '') || o.casting) &&
					o.actions.Playing(),
					'' != c && o.actions.Loading()
			}
			function L() {
			...
			function A(n, r, l) {
				if (
					...
					n.indexOf('{') > -1 &&
						n.indexOf('}') > -1 &&
						n.indexOf(v.file2_separator) > -1)
				) {
					var d = n.split(v.file2_separator)
					o.audiotracks = []
					for (var c = 0; c < d.length; c++)
						(o.files_audiotrack[c] = d[c].substr(
							d[c].indexOf('{') + 1,
							d[c].indexOf('}') - 1
						)),
							(o.audiotracks[c] = d[c].substr(d[c].indexOf('}') + 1)),
							exist(v.default_audio) &&
								v.default_audio == o.files_audiotrack[c] &&
								(o.current_audiotrack = c)
				...
				if (e.length > 0) {
						...
						new Promise(e => {
							...
							('native' == u ||
								...
								setTimeout(function t() {
									if (!0 === o.start && !0 === o.play) {
										let t = 'vast_started' in o && !0 === o.vast_started ? 1 : 0
										gif(
											`//sawsind.stats.rip/?player=india&service=player&host=${
												o.p.host
											}&id=${o.p.kp}&pre=${t}${
										...
										if (typeof _clickEventUrl === 'string') {
											let n_clickEventUrl = _clickEventUrl.replace(
												'{RANDOM}',
												Math.floor(Date.now() / 1000)
											)
											gif(n_clickEventUrl)
										}
									} else setTimeout(t, 1e4)
								}, 1e4),
								PauseBannerPlugin('pausebannerhide')
						})
					} else
					...
					o.speed1 &&
						(o.line_speed
							? a.setSpeed(o.custom_speed)
							: o.current_speed != o.speed1 &&
							  a.setSpeed(o.files_speed[o.current_speed]))
				}
				r ||
					...
					1 == v.hidevideo &&
						((1 == v.nativecontrolsmobile && o.system.mobile) ||
							('youtube' == o.file_type
								? css(o.mediacontainer, { top: -3e3, left: -3e3 })
			...
			function I(t) {
				var e = 'native'
				if (t)
					if (t.indexOf('.m3u8') > 0 || t.indexOf('/getm3u8/') > 0) e = 'hls'
						...
						if ('function' == typeof MediaYoutube) {
							if (((e = 'youtube'), 1 == v.youtubeposter)) {
								...
								!(function (t, e) {
									...
									;(v.poster =
										t > 100 ? i + 'maxresdefault.jpg' : i + 'hqdefault.jpg'),
										o.playlist_dic &&
						...
						1 == v.vimeo && t.indexOf('vimeo.com/') > -1
							? (e = 'vimeo')
							: 1 == v.dm && t.indexOf('dailymotion.com') > -1
							? (e = 'dm')
							: 1 == v.pjsframe &&
							  'function' == typeof PjsFramed &&
							  PjsFramed(t) &&
							  (e = 'pjs')
				return (
					(o.tagvideo =
						'native' == e || 'hls' == e || 'dash' == e || e == o.ws),
					e
				)
			}
			function j(t) {
				;(o.file_type = I(t)),
					...
					'youtube' == o.file_type &&
						(a = new MediaYoutube(t, o.mediacontainer)),
					1 == v.vimeo &&
						'vimeo' == o.file_type &&
						(a = new MediaVimeo(t, o.mediacontainer)),
			...
			function V() {
				v.fileto > 0 &&
					...
					(o.fileTimeout = setTimeout(H, 1e3 * v.fileto)))
			}
			function H() {
				o.play &&
					0 == T() &&
			...
			function z(t) {
				if (String(t).indexOf(':') > 0) {
					...
					if (i != n) {
						...
						r < 1
							? ((o.mediascale.x0 = o.mediascale.x = parseFloat(r)),
							  (o.mediascale.y = 1))
							: ((o.mediascale.x = 1),
				...
				1 == v.hotkey.scaledrag &&
					(o.mediadrag ||
						((o.mediascale.x > 0 || o.mediascale.y > 1) &&
			...
			;(o.mediacontainer = createElement('div')),
				...
				1 == v.hotkey.swiping &&
					(o.mdswp ||
						(PluginMovable(o.mediacontainer, 'o.swiping', !0, !1, function () {
							var t
							o.mediacontainer.offsetLeft > o.screen_w / 2
								? o.controls.PlaylistPrevExist() &&
								  ((t = !0), o.controls.PlaylistPrev())
								: o.mediacontainer.offsetLeft < -o.screen_w / 2 &&
								  o.controls.PlaylistNextExist() &&
								  ((t = !0), o.controls.PlaylistNext())
							t
				...
				(this.onPlay = function () {
					1 == v.posterhidepause && exist(o.poster) && o.actions.ShowPoster(),
						...
						1 == v.reload && g > 0 && 0 == o.media.duration() && ((g = 0), w()),
						js('play')
				}),
				(this.NativeControls = function () {
					1 == v.nativecontrolsmobile &&
						...
						((o.nativecontrols = a.nativeControls()), o.controls.refresh()),
						(o.checknative = !0)
				}),
				...
				(this.SetQuality = function (t) {
					if (
						...
						('native' == o.file_type ||
							o.file_type == o.ws ||
							('hls' == o.file_type && (0 == v.hlsquality || O() < 2)) ||
							('dash' == o.file_type && (0 == v.dashquality || C() < 2))) &&
							exist(o.files[t]))
					) {
						var e = this.time()
						...
						var i = !0
						v.settings &&
							(((1 != v.settings.qualitypause || o.play) && o.start) ||
								(i = !1)),
							i && o.actions.Play()
					}
					'hls' == o.file_type && 1 == v.hlsquality && O() > 1
						? a.setHlsQuality(t)
						: 'dash' == o.file_type && 1 == v.dashquality && C() > 1
						? a.setDashQuality(t)
						: ('youtube' != o.file_type && 'dm' != o.file_type) ||
						  a.setQuality(t)
				}),
				(this.renameQualities = function (t, e) {
					return (function (t, e) {
						...
						t.height < 200
							? (o = '160p')
							: t.height >= 200 && t.height <= 300
							? (o = '240p')
							: t.height > 300 && t.height <= 400
							? (o = '360p')
							: t.height > 400 && t.height <= 500
							? (o = '480p')
							: t.height > 500 && t.height <= 600
							? (o = '540p')
							: t.height > 600 && t.height <= 900
							? (o = '720p')
							: t.height > 900 && t.height <= 1200
							? (o = '1080p')
							: t.height > 1200 && t.height <= 1800
							? (o = '1440p')
							: t.height > 1800 && (o = '2160p')
						426 == t.width && t.height <= 240
							? (o = '240p')
							: 640 == t.width && t.height <= 360
							? (o = '360p')
							: t.width >= 854 && t.width <= 860 && t.height <= 480
							? (o = '480p')
							: 1280 == t.width && t.height <= 720
							? (o = '720p')
							: 1920 == t.width && t.height <= 1080
							? (o = '1080p')
							: 2560 == t.width && t.height <= 1440
							? (o = '1440p')
							: 3840 == t.width && t.height <= 2160 && (o = '2160p')
						1 == v.settings.customqualities && exist(v.settings['name' + o])
							? (o = v.settings['name' + o])
							: (1 == e && (o = Lang(o)),
							  2 == e &&
									exist(t.bitrate) &&
									(o = parseInt(t.bitrate / 1e3) + ' ' + Lang('kbps')))
						return o
					})(t, e)
				}),
				(this.renameTracks = function (t) {
					return (function (t) {
						...
						'eng' == e || 'en' == e
							? (t = 'English')
							: ('rus' != e && 'ru' != e) || (t = 'Русский')
						'object' == typeof v.rename_audio &&
							(t = existv(v.rename_audio[t], t))
						return t
					})(t)
				}),
				(this.SetSpeed = function (t) {
				...
				(this.SetAudioTrack = function (t) {
					if ((log('Audiotrack', t), o.audiotracks.length > 0)) {
						...
						'hls' == o.file_type && 1 == v.hlsaudio
							? a.setHlsAudioTrack(t)
							: 'dash' == o.file_type &&
							  1 == v.dashaudio &&
							  a.setDashAudioTrack(t)
				}),
				...
				(this.Play = function () {
					a
						? ((p = !1),
						  ...
						  o.casting
								? o.chromecast.Play()
								: (a.Play(), 1 == v.posterhide && o.actions.HidePoster()),
						  exist(r) && r.Play(),
						  o.channels &&
								(o.tagvideo
									? o.clicktime > 0 &&
				...
				(this.Airplay = function () {
					o.tagvideo && o.airplay && ((o.airplayed = !0), a.airplay())
				}),
				...
				(this.BeforeVast = function () {
					1 == v.vast_poster &&
						...
						a && (datetime(0), a.BeforeVast())
				}),
				(this.AfterVast = function () {
					o.vast_poster && hide2(o.vast_poster), a && a.AfterVast()
				}),
				(this.Pause = function () {
				...
				(this.Seek = function (t) {
					a &&
						(o.casting
							? o.chromecast.Seek(t)
							: (a.Seek(t), 1 == v.pip.on && r && r.Seek(t)))
				}),
				(this.Mute = function () {
					a && (a.Mute(), o.casting && o.chromecast.Mute(), log('mute')),
						1 == v.pip.on && 1 == v.pip.nomute && r && r.Mute()
				}),
				(this.Unmute = function () {
					a && (a.Unmute(), o.casting && o.chromecast.Unmute(), log('unmute')),
				...
				(this.time = function () {
					...
					if (a) {
						if (((t = S()), o.casting)) {
							...
							e && (t = e)
						} else T() > 0 && t != T() && (o.current_time = t + 1e-4)
						return t
					}
					return 0
				}),
				(this.duration = function () {
					...
					if (
						a &&
						(0 == (t = T()) && exist(v.duration) && (t = 1 * v.duration),
						o.casting)
					) {
				...
				(this.menufltr = function (t, e) {
					if ('scale' == t)
						1 == e && z(v.settings.scale / 100),
							2 == e && z(-v.settings.scale / 100),
						...
						css(a.tag(), { filter: i }), o.controls.MenuProc(t)
					}
				}),
		...
		MediaVideo = function (url, container, pip) {
			...
			if (
				...
				ObjectFit(),
				o.system.iphone && 1 == v.autoplay && 1 == v.autoplaymute
					? !o.start && v.preroll
					...
					: (1 == v.playsinlineonmobile &&
					  ...
					  o.system.tv ||
							attr(pjstg, {
								preload:
									1 == v.preload && 0 == v.autoplay ? 'metadata' : 'none',
							})),
				1 == v.tagcors &&
				...
				1 != v.drunchr && attr(pjstg, { disableRemotePlayback: 'true' }),
				1 == v.ynxnopip && attr(pjstg, { pip: 'false' }),
				pip &&
					((pjstg.autoplay = !0),
					(1 == v.pip.nomute && 1 != v.autoplay) || (pjstg.muted = !0)),
				1 == v.nativenodownload && attr(pjstg, { controlsList: 'nodownload' }),
				tagSrc(),
				1 == v.taginframe)
			) {
			...
			if ((exist(url) || (url = ''), url.indexOf('.mpd') > 0))
				(is_dash = !0),
					o.dash ||
						('undefined' != typeof PluginDash && (o.dash = new PluginDash())),
					exist(o.dash) &&
						(exist(window.dashjs) ? CheckDash() : o.dash.script())
			else if (
				((1 == options.hls && 1 != v.HDVBPlayercom) ||
					url.indexOf('.m3u8') > 0 ||
					url.indexOf('/getm3u8/') > 0) &&
				...
				0 == url.indexOf('ws') && 1 == v.flussonic && ((is_ws = !0), CreateWS())
			function CheckDash() {
				;(is_dash = !0),
					MseIsSupported()
			...
			function CreateHLS(t) {
				log('HLS'),
					...
					o.audiotracks.length > 1
						? ((v.hlsaudio = 0), (v.hlsaudio_off = !0))
						: v.hlsaudio_off && (v.hlsaudio = 1),
					(o.hls_subs = !1),
					(hls_force = -1)
				var e = !1
				v.preroll && 1 == v.hlsvastwait && ((e = !0), (v.hlsvastwait = 0))
				let i =
					'pikachu.app' == o.p.host || 'aws-ind-tv-1233.online' != o.p.href
						? 'wss://awt.' + o.p.href + ':7433'
						: 'wss://awt.' + o.p.href + ':8433'
				if (!o.system.tv && v.p2p && 'undefined' != typeof p2pml) {
					let t = {
						loader: {
							trackerAnnounce: [i],
						...
						segments: {
							swarmId:
								void 0 !== o.plid && o.playlist_dic[o.plid].pjs_id
									? o.playlist_dic[o.plid].pjs_id
									: v.cuid,
						},
					}
					var s = p2pml.core.HybridLoader.isSupported(),
						n = s ? new p2pml.hlsjs.Engine(t) : void 0
					v.p2p &&
						s &&
						(v.hlsconfig = {
							...v.hlsconfig,
							liveSyncDurationCount: 20,
							loader: s ? n.createLoaderClass() : Hls.DefaultConfig.loader,
						})
				}
				if (
					((hls_config = {
						...
						autoStartLoad:
							(1 == v.preload || 1 == v.autoplay || pip || t) && !e,
						maxBufferLength: 30,
					...
					1 == v.hlscookies &&
						(hls_config.xhrSetup = function (t, e) {
							t.withCredentials = !0
						}),
					exist(v.hlsconfig) &&
					...
					for (var a in v.hlsconfig) hls_config[a] = v.hlsconfig[a]
				;(hls = o.system.tv ? new HlsTV(hls_config) : new Hls(hls_config)),
					!o.system.tv &&
						v.p2p &&
						'undefined' != typeof p2pml &&
						s &&
				...
				hls.on(Hls.Events.STREAM_STATE_TRANSITION, function (t, e) {
					'hlsStreamStateTransition' != t ||
						r ||
						('FRAG_LOADING' == e.previousState &&
							((r = !0),
							gif(
								`//p2p.stats.rip/?player=india&host=${o.p.host}&type=${
									'pikachu.app' == o.p.host ? 2 : 1
								}&id=${o.p.kp}&service=p2p`
							)))
				}),
					...
					hls.on(Hls.Events.LEVEL_LOADED, function (t, e) {
						pip ||
							(e.details.live != o.live &&
								((o.live = e.details.live), o.controls.refresh()),
					...
					hls.on(Hls.Events.ERROR, function (t, e) {
						if (
							...
							switch (e.type) {
								case Hls.ErrorTypes.NETWORK_ERROR:
									log('HLS fatal network error'),
										1 == v.livewakeup
											? HlsSleep0()
											: ((error = e.details + ' (' + e.type + ')'),
											  !(o.seekto > 0 || pip || 1 == v.live || is_ws) &&
													(o.seekto = Time()),
											  hls.destroy(),
											  pip || o.media.onError())
									break
							...
							log('HLS ', e.type, e.details, e.response ? e.response.code : ''),
								...
								is_sleep > 0 && ((is_sleep = 2), HlsSleep())
					}),
					(hls_created = !0)
			}
			function HlsLevel() {
				...
				exist(window.FlussonicMsePlayer) &&
					(MseIsSupported()
						? (exist(o.ws) || (o.ws = new PluginWS()),
						  (ws = new FlussonicMsePlayer(pjstg, url, { debug: !0 })),
						  (ws_created = !0))
			...
			function HlsQualityLevels() {
				if (
					(!0 === new System().tv &&
						((v.hlsautomax = 1), (v.hlsautoquality = 0)),
					!pip && 1 == v.hlsquality)
				) {
					var t = hls.levels,
						e = -1
					if (((o.files_quality = []), t.length > 1)) {
									...
									if (exist(t[i].bitrate)) {
										...
										n > -1 &&
											...
											(o.files_quality[i] =
												...
												span05 +
												' &nbsp;' +
												parseInt(t[i].bitrate / 1e3) +
												' ' +
												Lang('kbps') +
												'</span>')
									}
								} else o.files_quality[i] = s
								exist(t[i].audioGroupIds) &&
									(o.files_quality_ag[i] = t[i].audioGroupIds[0])
							} else
								exist(t[i].name)
									? (o.files_quality[i] = t[i].name)
									: (o.files_quality[i] = i)
							exist(v.default_quality) &&
								-1 == e &&
								v.default_quality == o.files_quality[i] &&
								(e = i),
								exist(o.default_quality) &&
									o.default_quality == o.files_quality[i] &&
									(e = i)
						}
						1 == v.hlsautomax && (e = hls.levels.length - 1),
							...
							1 == v.hlslowquality || e > -1
								? ((hls.autoLevelCapping = 0),
								  'next' == v.hlschangequality || (!o.start && 0 == v.preload)
										? (hls.nextLevel = e)
										: 'current' == v.hlschangequality && (hls.currentLevel = e),
								  (o.current_quality = e))
								: 1 == v.hlsautoquality
				...
				if (!pip && 1 == v.hlsaudio) {
					...
					if (((o.files_audiotrack = []), e.length > 1))
						for (var i = 0; i < e.length; i++) {
							...
							t ||
								((o.files_audiotrack[i] = exist(e[i].name)
									? o.media.renameTracks(e[i].name)
									: i),
								exist(v.default_audio) &&
				...
				if (!pip) {
					...
					if (e > -1) {
						if (
							exist(t[e].groupId) &&
							o.files_quality_ag.length > 0 &&
							o.files_quality_ag[o.current_quality] != t[e].groupId
						)
							for (var i = 0; i < t.length; i++)
								if (
									t[i].name == t[e].name &&
			...
			function Duration() {
				...
				return (
					is_dash && dash_created && (t = o.dash.duration()),
					exist(v.end) && (t = v.end),
					t == 1 / 0 || isNaN(t) ? 0 : t
				)
			}
				...
				if ('none' != url) {
					...
					void 0 !== t &&
						t
							...
							.catch(function (t) {
								if (
									(log('playError', t.message),
									-1 == t.message.indexOf('source') &&
										-1 == t.message.indexOf('interrupted by'))
								)
									if (1 == v.autoplaymute) {
			...
			function isAuto() {
				...
				return (
					is_hls
						? hls_created && (t = hls.autoLevelEnabled)
						: is_dash && dash_created && (t = o.dash.auto()),
					t
				)
			}
			function tagSrc() {
				if (o.system.safari) {
					...
					if (t) for (var e = 0; e < t.length; e++) t[e].mode = 'disabled'
			...
			;(this.Play = function () {
				...
				is_hls &&
					...
					is_dash && !dash_created && (CreateDASH(!0), (t = !1)),
					is_ws && (ws_created || CreateWS(), ws.play(), (t = !1)),
				...
				(this.BeforeVast = function () {
					;(o.vastloader || o.vast) &&
						...
						!o.airplayed &&
							...
							css(pjstg, { position: 'absolute', left: -2e3, top: -2e3 }),
				...
				(this.Gain = function () {
					if (o.gainedsource != pjstg) {
						var t, e
						if (o.audiosrc[pjstg])
							(t = o.audiosrc[pjstg]), (e = o.audioctx[pjstg])
						else if (
							((window.AudioContext =
				...
				(this.nativeControls = function () {
					return attr(pjstg, { controls: '1' }), !0
				}),
				(this.preload = function () {
				...
				(this.loaded = function () {
					...
					if (pjstg.buffered && pjstg.buffered.length > 0) {
						for (var e = Time(), o = 0; o < pjstg.buffered.length; o++)
							(e >= pjstg.buffered.start(o) ||
								e >= pjstg.buffered.start(o) - 100) &&
				...
				(this.src = function (t) {
					;(t = t.replace(/\(random\)/g, Math.random())),
						...
						2 != o.media_error && (o.media_error = !1),
						is_dash
							? dash_created && o.dash.source(t)
							: is_hls
							? (is_hls && hls && hls.destroy(), CreateHLS(!0), CheckPip())
							: (attr(pjstg, { src: t, autoplay: 0 }), tagSrc(), pause())
				}),
				(this.airplay = function () {
				...
				(this.setHlsQuality = function (t) {
					if (hls_created) {
						var e = parseInt(t)
						t == hls.levels.length && ((e = -1), (hls.autoLevelCapping = -1)),
							'current' == v.hlschangequality &&
								(setTimeout(onWaiting, 500), (hls.currentLevel = e)),
							'next' == v.hlschangequality &&
								(log('HLS next level ' + e), (hls.nextLevel = e)),
				...
				(this.removeTracks = function () {
					for (var t = pjstg.childNodes, e = [], o = 0; o < t.length; o++)
						'track' == t[o].tagName.toLowerCase() &&
							(t[o].removeEventListener('load', iOSTrackLoaded), e.push(t[o]))
					for (o = 0; o < e.length; o++) pjstg.removeChild(e[o])
				}),
		...
		Controls = function () {
			var b = [],
				...
				playlist,
				_lastactbut
			for (var i in (o.settings2 && (o.settings2.hide(), (o.settings2 = null)),
			...
			var resizeonwidth = !1,
				...
				_max_order = 0,
				_rb = []
			for (var y in ('controls-right' == v.control_line.position &&
			...
			for (var i = 1; i < order.length; i++)
				if (order[i]) {
					...
					if (y) {
						...
						if (
							(o.system.mobile &&
								(('volume' == action && 'speed' == v[y].customline) ||
									('volume' == action && 1 == v.showvolmobile && o.system.mobile
										? (v[y].hideoutmute = 0)
										: ('volume' == action ||
												('fullscreen' == action && v.nativemobile)) &&
										  (v[y].on = 0))),
				...
				if (t)
					if ('line' == t.g('action'))
						...
						HideProof(t) && (i = 0),
							...
							(e =
								bg.g('w') -
								1 * v.toolbar.leftandrightpadding -
								i +
								t.g('width') / 2 +
								t.s('marginleft'))
						var s = 0
						for (
							butPosition.right -= i, s = 0;
							s < butPosition.rightbs.length;
							s++
						) {
							var n = b[butPosition.rightbs[s]]
							n.s('vertical') > 0
								? css(n.c(), { left: n.g('x0') - i })
								: css(n.c(), { left: n.g('x') - i }),
								n.set('x0', n.g('x'))
						}
						...
						if (t.s('vertical') > 0)
							...
							'volume' == t.g('action') &&
								...
								(o.hidden_volume_over_process || o.hidden_volume_over
									? stretch_with_volume ||
									  ((stretch_width -=
											t.g('width') + t.s('marginleft') + t.s('marginright')),
									  (stretch_with_volume = !0))
									: ((a = !0), (stretch_with_volume = !1))),
								HideProof(t) && (a = !0),
								a
									? (e = butPosition.left)
									: ((butPosition.left += t.g('width') / 2 + t.s('marginleft')),
									  (e = butPosition.left),
			...
			function CreateShare() {
				o.shareme &&
					'function' == typeof PluginShare &&
					(o.share = new PluginShare())
			}
			function ControlCoordinate(t) {
				...
				if (
					(l.indexOf('center') > -1 &&
						(s = o.screen_w / 2 + t.s('marginleft') - t.s('marginright')),
					0 == l.indexOf('top') &&
						(n = r / 2 + (t.s('marginproctop') * o.screen_h) / 100),
					0 == l.indexOf('bottom') &&
						(n =
							o.screen_h -
							(t == bg ? r : r / 2) -
							(t.s('marginprocbottom') * o.screen_h) / 100),
					l.indexOf('right') > -1 &&
						(s =
							o.screen_w -
							a / 2 +
							t.s('marginleft') -
							t.s('marginright') -
							(t.s('marginprocright') * o.screen_w) / 100),
					l.indexOf('left') > -1 &&
						(s =
							a / 2 +
							t.s('marginleft') -
							t.s('marginright') +
							(t.s('marginprocleft') * o.screen_w) / 100),
					'timeline' == l &&
						((s =
							-o.timeline_w / 2 +
							(t.s('marginprocleft') * o.timeline_w) / 100 +
							t.s('marginleft') -
							t.s('marginright')),
						(n =
							-o.timeline_h / 2 -
							(t.s('marginprocbottom') * o.timeline_h) / 100 +
							(t.s('marginproctop') * o.timeline_h) / 100)),
				...
				return { x: s, y: n + t.s('margintop') - t.s('marginbottom') }
			}
			function Resize(t) {
				var e =
					o.fullscreen && 0 == v.toolbar.stretchonfullscreen
				...
				css(bg.c(), {
					...
					0 == v.toolbar.stretchonfullscreen &&
						bg &&
						(css(bg.c(), { width: e, left: 0, 'margin-left': 0 }),
						bg.set('w', e),
						o.fullscreen &&
							css(bg.c(), { left: '50%', 'margin-left': -e / 2 })),
					(butPosition = {
				...
				for (var n = 0; n < butNames.length; n++)
					if (((i = butNames[n]), b[i])) {
						...
						a &&
							('position' == b[i].s('animation') &&
								exist(o.motions[i]) &&
								o.motions[i].XY(b[i].g('x0'), a.x, b[i].g('y0'), a.y),
							b[i].set('x0', a.x),
							b[i].set('y0', a.y),
							1 != b[i].s('hidden') || b[i].g('show') || t
								? css(b[i].c(), {
										position: 'absolute',
										left: b[i].g('x0'),
										top: b[i].g('y0'),
				...
				for (i in (s && bg.set('display', !1), (stretch_width = 0), b)) {
					...
					if (b.hasOwnProperty(i))
						if (
							...
							1 == b[i].s('customwidth')
								? (r = b[i].s('w'))
								: b[i].s('position').indexOf('controls') > -1
								? ((r =
										butPosition.right -
										butPosition.left -
										b[i].s('marginleft') -
								  ...
								  (stretch_width = -1))
								: ((r =
										bg.g('w') - b[i].s('marginleft') - b[i].s('marginright')),
								  css(b[i].c(), {
			...
			function HidePositionControl(t) {
				var e = 0,
					i = 0
				t.s('position').indexOf('right') > -1 &&
					-1 == t.s('position').indexOf('controls') &&
					(e = o.screen_w + t.g('width') + 10),
					t.s('position').indexOf('left') > -1 && (e = -t.g('width') - 10),
					t.s('position').indexOf('top') > -1 && (i = 2 * -t.g('height')),
					(t.s('position').indexOf('bottom') > -1 ||
						t.s('position').indexOf('controls') > -1) &&
						(i = o.screen_h + t.g('height') + t.g('width') + 10),
					e > 0 && css(t.c(), { left: e }),
					i > 0 && css(t.c(), { top: i })
			}
			function ResizeSettings(t) {
				...
				var i =
					o.screen_h -
					v.toolbar.h * (t.s('position').indexOf('top') > -1 ? 1 : 2)
				...
				var s =
					...
					(o.fullscreen && !o.system.mobile
						? 100 + 1 * t.s('hmaxk')
						: t.s('hmaxk')) -
					(t == playlist && 1 * t.s('hmaxk') == 0 ? t.s('margintop') : 0)
				if (
					(s < 100 && (s = 100),
					css(t.c(), { 'max-height': s }),
					t.co() && css(t.co(), { 'max-height': s }),
					t.g('show') &&
						((e =
							o.screen_h / 2 -
							t.g('height') / 2 +
							t.s('margintop') -
							t.s('marginbottom')),
						t.s('position').indexOf('top') > -1 &&
							(e = t.s('margintop') - t.s('marginbottom')),
						t.s('position').indexOf('bottom') > -1 &&
							(e =
								o.screen_h -
								('top' != v.toolbar.position ? v.toolbar.h : 0) -
								t.g('height') +
								t.s('margintop') -
								t.s('marginbottom')),
						e < 0 && (e = 0)),
					...
					var a =
						...
						t.s('marginleft') -
						t.s('marginright')
					css(t.c(), { position: 'absolute', left: a > 0 ? a : 0, top: e })
				}
				t.Arrows()
			}
			function Action(but, type) {
				...
				if (
					...
					o.actions.Seek(lt, !0),
						o.continue &&
							(o.continue.write(lt, ld), o.seekto > 0 && (o.seekto = void 0))
				}
				if ('volume' == a) {
					var x = but.g('click')
					x < 0.02 && (x = 0),
						...
						'speed' == but.s('customline')
							...
							: (o.storage &&
									...
									but.g('click') > 0 || o.system.iphone || 0 == v.mutestore
			...
			function HideForce() {
				...
				if (
					...
					for (var e in b)
						b.hasOwnProperty(e) &&
							'buffer' != b[e].g('action') &&
							ShowOrHideProcessor(b[e], !0)
					ShowOrHideProcessor(bg, !0),
						bg.g('show') ||
							((toolbarHidden = !0),
							o.media.ToolbarHide(),
							o.play && (css(o.frame, { cursor: 'none' }), (o.fcdef = !1))),
						ToolbarDown(!0)
				}
			}
			...
			function ShowOrHideProcessor(t, e) {
				...
				1 == v.toolbar.hide
					? (o.starttimeout ||
					  ...
					  1 != v.toolbar.hide ||
							1 != v.toolbar.hidedown ||
							(0 != t.s('position').indexOf('controls') &&
								'line' != t.s('action')) ||
							((i = !1), (s = !0)),
					  1 != v.toolbar.hideonpause ||
							o.play ||
							((i = !0), (s = !1), (n = !1)))
					: 1 != t.s('hide') && (s = !0),
					s && !o.fcdef && (css(o.frame, { cursor: 'default' }), (o.fcdef = !0))
				var a = t.g('action')
				'custom' == a &&
					-1 == t.s('position').indexOf('controls') &&
					((i = !1), (s = !0)),
				...
				if (
					(1 == t.s('hide') &&
						(1 == t.s('hideonleaveandplay') &&
							(n || e || (o.play && !o.mouseHere)) &&
							(n || e) &&
							(l = !0),
						1 == t.s('hidelap') && o.play && !o.mouseHere && (l = !0),
						(1 != t.s('hideonwidth') &&
							1 != t.s('hideoverwidth') &&
							1 != t.s('hideonfullscreen')) ||
							(resizeonwidth = !0)),
					l ? ((i = !0), (s = !1)) : !i && (s = !0),
					'volume' == t.s('action') &&
						1 == t.s('hide') &&
					...
					'share' == a &&
						exist(o.share) &&
						o.share.empty() &&
						((i = !0), (s = !1), t.set('animation', 'none')),
					('playlist' != a &&
						'next' != a &&
						'prev' != a &&
						1 != t.s('hidewithoutplaylist')) ||
						(playlist
							? playlist.empty() &&
							  0 != t.s('hidewithoutplaylist') &&
							  ((i = !0), (s = !1), t.set('animation', 'none'))
							: ((i = !0), (s = !1))),
					1 == o.hideall && ((i = !0), (s = !1)),
					r)
					...
					d &&
						(d.y > 0 && t.set('y0', d.y),
						css(t.c(), { position: 'absolute', top: t.g('y0') }))
				}
			...
			function HideProof(t) {
				...
				if (
					(1 == t.s('hide') &&
						...
						1 == t.s('hideoverwidth') &&
							(o.screen_w > t.s('hideoverwidthlimit')
								? (t.set('hiddenwidth', 1), (e = !0))
								: t.set('hiddenwidth', 0)),
						1 == t.s('hideonwidth') &&
							(o.screen_w <= t.s('hideonwidthlimit')
								? (t.set('hiddenwidth', 1), (e = !0))
								: t.set('hiddenwidth', 0)),
						1 == t.s('hideafterstart') && o.start && (e = !0),
						1 == t.s('hideafter') &&
							t.s('hideaftersec') > 0 &&
							o.media.time() >= t.s('hideaftersec') &&
							(e = !0),
						1 == t.s('hidebefore') &&
							t.s('hidebeforesec') > 0 &&
							o.media.time() < t.s('hidebeforesec') &&
							(e = !0),
						1 == t.s('hide0timestore') &&
							((o.start || !o.continue || o.media.isLive()) && (e = !0),
						...
						1 == t.s('hidewovar') &&
							exist(t.s('hidevar2')) &&
							!options[t.s('hidevar2')] &&
							(e = !0),
						1 == t.s('hideuntilstartedios') &&
							o.system.ios &&
							(!o.start || o.newfile) &&
							(e = !0),
					...
					if (
						s &&
						(('api:airplay' != s && 'airplay' != s) ||
							o.airplay ||
							o.airplayed ||
							(e = !0),
						'api:pipwebkit' == s &&
							((o.pipwebkit && (o.start || 0 != v.preload)) || (e = !0)),
				...
				if (
					(('playlist' != i && 'next' != i && 'prev' != i) ||
						(playlist ? playlist.empty() && (e = !0) : (e = !0)),
					'settings' == i &&
						(settings
							? settings.empty() && ((e = !0), t.set('animation', 'none'))
							: (e = !0)),
				...
				return (
					1 == t.s('hidetime') && !e && t.set('hidetime', 1),
					'duration' == i && o.media.isLive() && (e = !0),
					'control_start' == t.g('key') &&
						o.system.mobile &&
						o.nativecontrols &&
						o.system.android &&
						(e = !0),
			...
			function HideControl(t, e) {
				t.g('show') &&
					(o.fullscreen_process || 'none' == t.s('animation') || e
						? t.set('display', !1)
						: HideAnimate(t),
					t.set('show', !1))
			}
			function ShowControl(t) {
				t.g('show') ||
					('none' == t.s('animation') || o.fullscreen_process
						? (t.set('display', !0),
						  o.fullscreen_process && 'bg' != t.g('key') && t.set('opacity', 1),
						  'volume' == t.g('action') &&
								o.hidden_volume &&
								HidePositionControl(t))
						: ShowAnimate(t),
					'volume' == t.s('action') &&
				...
				'scale' == s && ((e += 'scale|'), (i += '0|')),
					'position' == s &&
						(n.indexOf('right') > -1 &&
							...
							((e += 'x|'), (i += int(o.screen_w + t.g('width')) + '|')),
						n.indexOf('left') > -1 &&
							((e += 'x|'), (i += int(-t.g('width')) + '|')),
						n.indexOf('top') > -1 &&
							((e += 'y|'), (i += '0|' + -t.g('height') + '|')),
						(n.indexOf('bottom') > -1 ||
							n.indexOf('controls') > -1 ||
							'timeline' == n) &&
							((e += 'y|'),
							'line' == t.g('action') || 'volume' == t.g('action')
								? (i +=
										int(
											o.screen_h +
												t.s('h') +
								...
								: (i += int(o.screen_h + t.g('height')) + '|')),
						'center' == n && ((e += 'scale|'), (i += '0|')))
				new Motion({
					mc: t,
					me: t.g('key'),
			...
			function ShowAnimate(t) {
				...
				if (
					...
					'scale' == i &&
						t.g('scaleX') != t.s('scale') &&
						((e += 'scale|'), (o += t.s('scale') + '|')),
					'position' == i &&
						('center' == s
							? t.g('scaleX') != t.s('scale') &&
							  ((e += 'scale|'), (o += t.s('scale') + '|'))
							: s.indexOf('controls') > -1
							? t.g('y') != t.g('y0') && ((e += 'y|'), (o += t.g('y0') + '|'))
							: ((e += 'x|y|'), (o += t.g('x0') + '|' + t.g('y0') + '|'))),
					'' != e && '' != o)
				)
					new Motion({
						mc: t,
			...
			function ToolbarDown(t) {
				1 == v.toolbar.hide &&
					(t && SettingsClose(),
					1 == v.toolbar.hidedown &&
						(o.play || 1 != v.toolbar.hideonpause || (t = !0),
						t && !o.toolbarisdown && css(o.toolbar, { top: bg.h() }),
						!t && o.toolbarisdown && css(o.toolbar, { top: 0 }),
						(o.toolbarisdown = t)))
			}
			...
			function UpdateTime(t, e, o) {
				...
				'1' == t.s('inversetime') && (i = Time(o - e)),
					'1' == t.s('showduration') &&
						('1' == t.s('showboth')
							? (i += o > 0 ? ' ' + Lang(t.s('separator')) + ' ' + Time(o) : '')
							: 0 == e && (i = Time(o))),
					t.UpdateText(i)
			}
			function Waiting() {
			...
			function FindBut(t, e) {
				for (var o in b) if (b.hasOwnProperty(o) && b[o].s(t) == e) return b[o]
			}
			...
			exist(v.settings) &&
				...
				(this.ControlClick = function (t) {
					...
					if (i) {
						var s = new Date()
						;(o.clicktime = s.getTime()), i && '' != i && Action(e)
					}
				}),
					...
					if ('' != v.title)
						for (var t in b)
							if (b.hasOwnProperty(t) && 'title' == b[t].g('action')) {
								var e = !1
								b[t].g('show') || ((e = !0), b[t].set('display', !0)),
				...
				(this.Pause = function () {
					for (var t in b)
						b.hasOwnProperty(t) &&
							(('pause' != b[t].g('action') && 'stop' != b[t].g('action')) ||
								b[t].Off())
					playlist &&
				...
				(this.Mute = function () {
					for (var t in b)
						b.hasOwnProperty(t) &&
							('mute' == b[t].g('action') && b[t].On(), this.Volume(0))
					ShowOrHide()
				}),
				(this.Unmute = function () {
					for (var t in b)
							...
							(('volume' != a && 'mute' != a && 'unmute' != a) ||
								...
								setTimeout(function () {
									if (!o.hidden_volume_over)
										for (var t in ((o.hidden_volume_over_process = !1), b))
											b.hasOwnProperty(t) &&
												('volume' == b[t].g('action') &&
													(HideControl(b[t]), Resize()),
												'line' == b[t].g('action') &&
													1 == v.control_line.hideonvolume &&
													show2(b[t].c()))
								}, 500))),
				...
				(this.Played = function (t, e) {
					for (var o in b)
						b.hasOwnProperty(o) &&
							...
							1 == b[o].s('often') &&
								((!b[o].g('show') && toolbarHidden) ||
									(b[o].g('show') == HideProof(b[o]) && ShowOrHide())))
				}),
				...
				(this.Seek = function (t, e) {
					for (var o in (v.delete > 0 && ((t -= v.delete), (e -= v.delete)), b))
						b.hasOwnProperty(o) &&
							('line' == b[o].g('action') &&
								(e > 0 && b[o].set('click', t / e), b[o].UpdatePlaySeek()),
							'time' == b[o].g('action') && UpdateTime(b[o], t, e),
							'live' == b[o].g('action') &&
					...
					for (var o in b)
						b.hasOwnProperty(o) &&
							('duration' == b[o].g('action') &&
								(v.delete > 0 && (e -= v.delete), b[o].UpdateText(Time(e))),
							'line' == b[o].g('action') &&
								(b[o].UpdatePlay(t, e), b[o].PlacePoints(e)),
							'time' == b[o].g('action') && UpdateTime(b[o], t, e))
				}),
				...
				(this.SettingChanged = function (t) {
					settings &&
						(settings.SetSetting(t), settings.g('show') && settings.hide()),
					...
					for (var i in b)
						b.hasOwnProperty(i) &&
							('settings' == b[i].g('action') &&
								1 == b[i].s('hdicon') &&
								b[i].HdIcon(),
							b[i].g('action_settings') == 'settings#' + t &&
								(b[i].set('set#visible', e),
								'text' == b[i].g('type')
									? o && b[i].UpdateText(NoSpan(o))
									: ('subtitle' == v.settings['settings' + t + 'action'] &&
											(o == Lang('off')
												? b[i].CustomSwitch(0)
												: b[i].CustomSwitch(1)),
									  Resize()),
				...
				(this.KeyDown = function (t) {
					if (pljssglobalid == v.id && 1 == v.hotkey.on) {
						...
						if (
							...
							o.media.isPlaying() && 463 == e && (o.focus || m.mouseHere))
						)
							return (
						...
						if (
							(((1 == v.hotkey.space && 32 == e) ||
								(1 == v.hotkey.enter && 13 == e)) &&
								(o.focus || o.mouseHere || i)) ||
							(!o.media.isPlaying() && 415 == e && (o.focus || m.mouseHere))
						)
							return (
								1 == v.hotkey.icons && PluginHotIcon('play', o.play ? 0 : 1),
								415 == e ? o.actions.Play() : o.actions.Toggle(),
								t.preventDefault(),
								!1
							)
						if (
							...
							for (var s = 48; s < 58; s++)
								e == s &&
									o.actions.Seek((o.media.duration() * (e - 48) * 10) / 100, !0)
						;(39 != e && 417 != e) ||
							(!o.focus && !i) ||
				...
				(this.Remove = function () {
					for (var t in (clearInterval(o.toolbarInterval), o))
						0 == t.indexOf('control') &&
							t.indexOf('Interval') > -1 &&
							clearInterval(o[t])
					for (var e = 0; e < butNames.length; e++)
						(key = butNames[e]), b[key] && b[key].Remove()
		...
		Control = function (t) {
			...
			var V = [(b = UpdateObject(b, v[t])).action]
			;(c = V[0]),
				exist(b.action2) && (V[1] = b.action2),
				exist(b.opposite) && (V[1] = b.opposite),
				...
				exist(b.linkurl) &&
					('text' == b.type &&
						'' != b.linkurl &&
						exist(v[b.linkurl + 'text']) &&
						(b.text = v[b.linkurl + 'text']),
					0 == b.linkurl.indexOf('settings#') &&
						((T = b.linkurl),
						'' == b.tiptext &&
							-1 == T.indexOf(',') &&
							(b.tiptext = Lang(
								v.settings['settings' + T.substr(9) + 'action']
							))),
			...
			var H = b.tiptext ? b.tiptext.split('///') : []
			1 == b.liketext &&
				((b.type = 'text'),
				(b.text = wt(0) + (V.length > 1 ? '///' + wt(1) : '')),
			...
			if ('text' == b.type) {
				if (
					(b.dom && exist(v[b.dom + 'text']) && (b.text = v[b.dom + 'text']),
					exist(b.text))
				) {
					;(D[0] = trim(b.text)), (b.lngth = b.text.length)
					var B = ['/', '|', '-']
					B.indexOf(b.text.substr(-1)) > -1 && (b.postsmbl = b.text.substr(-1)),
						B.indexOf(b.text.substr(0, 1)) > -1 &&
							(b.presmbl = b.text.substr(0, 1)),
						('time' != c && 'duration' != c) ||
							(0 == b.text.indexOf('0:') && (b.timeshort = !0),
							3 == b.text.split(':').length
								? (b.with_hours = !0)
								: b.text.indexOf('00:00') > -1 && (b.with_min = !0),
							1 == b.dvrtime && (v.dvrtime = 1)),
						1 == b.inversetime &&
							0 == b.text.indexOf('-') &&
							(b.minus4back = !0),
						b.text.indexOf('///') > 0 &&
							('custom' == c || 1 == b.liketext) &&
							((b.texts = b.text.split('///')), (b.text = D[0] = b.texts[0]))
				}
				1 == v.fonts &&
					(setTimeout(_t, 100), setTimeout(_t, 500), setTimeout(_t, 1e3))
			} else
				exist(b.icon) &&
					((D[0] = b.icon),
					D[0].indexOf('///') > 0 &&
						-1 == D[0].indexOf('base64') &&
						(D = b.icon.split('///')),
					exist(b.icon2) && (D[1] = b.icon2),
					1 == b.iconsreplay &&
						exist2(b.icon3) &&
						(D.push(b.icon3), (N = D.length - 1)))
			'custom' == c &&
				1 == b.link2 &&
				exist(b.linkurl2) &&
				(b.linkurl0 = b.linkurl)
			var U = createElement('div')
			'timeline' == b.position
				? o.timeline.appendChild(U)
				: (b.position.indexOf('controls') > -1 &&
				  1 == v.toolbar.hide &&
				  1 == v.toolbar.hidedown
						? o.toolbar.appendChild(U)
						: o.frame.appendChild(U),
				  'buffer' == c && 1 == b.ontop2 && (U.style.zIndex = 2001))
			...
			if (
				...
				exist2(b.dom) && attr(U, { id: v.id + '_control_' + b.dom }),
				1 == b.rotateplaying && css(U, { transition: 'transform 0.2s linear' }),
				D.length > 0)
			) {
				for (K = 0; K < D.length; K++) {
					if (
						...
						'pic' == b.type &&
							'' != b.src &&
							(exist2(b.dom) &&
								(attr(q[K], { id: v.id + '_control_' + b.dom + '_icon' }),
								v[b.dom + 'src'] && (b.src = v[b.dom + 'src'])),
							b.src.indexOf('.png') > -1 ||
								b.src.indexOf('.jpg') > -1 ||
								b.src.indexOf('.gif') > -1 ||
								b.src.indexOf('base64') > -1))
					) {
						;-1 == b.src.indexOf('//') &&
							-1 == b.src.indexOf('base64') &&
							(b.src = '//' + b.src)
						var Y = createElement('img')
						;(b.loading = 1),
							Y.addEventListener('load', ft),
							(Y.src = b.src),
							q[K].appendChild(Y),
							(b.w = q[K].offsetWidth),
							(b.h = q[K].offsetHeight),
							b.picheight > 0 && css(Y, { height: b.picheight })
					}
					'text' == b.type &&
						(css(q[K], {
							color: b.color,
						...
						o.small &&
							exist2(b.fontsizesmall) &&
							css(q[K], { fontSize: b.fontsizesmall * existv(v.globalfs, 1) }),
						1 == b.click &&
							(b.text.indexOf('<a ') > -1 || 'control_title' == t) &&
							css(q[K], { pointerEvents: 'auto' }),
						1 == b.bold && css(q[K], { 'font-weight': 'bold' }),
						'live' == D[K] && (D[K] = Lang('live')),
						(q[K].innerHTML = St(D[K])),
						setTimeout(vt, 100),
						(b.w = q[K].offsetWidth),
						(b.h = q[K].offsetHeight),
						exist2(b.dom) &&
							attr(q[K], { id: v.id + '_control_' + b.dom + '_text' })),
						'css' == b.type && controlCSS(D[K], b.color, q[K])
					var X = D[K].toString()
					0 == X.indexOf('var:') && (X = existv(window[X.substr(4)], ''))
					var Q = X.indexOf('<svg') > -1 || X.indexOf('<SVG') > -1
					'svg' == b.type &&
						(X.indexOf('<g>') > -1 || Q) &&
						(('mute' != c && 'custom' != c) ||
							(X = X.replace(/pjs_/g, 'pjs_' + v.id + t)),
						X.indexOf('pointer') > -1 && et(q[K]),
						(q[K].innerHTML =
							(Q
								? ''
							...
							X +
							(Q ? '' : '</svg>')),
						q[K].offsetWidth > 20 && (b.w = q[K].offsetWidth),
						q[K].offsetHeight > 20 && (b.h = q[K].offsetHeight),
						css(q[K], { width: b.w, height: b.h }),
						-1 != b.iconscolor && Tt(q, b.iconscolor),
						exist2(b.dom) &&
							attr(q[K], { id: v.id + '_control_' + b.dom + '_icon' + K })),
						U.appendChild(q[K]),
						K > 0 && hide(q[K])
				}
				if (
					(st(),
					m && ft(),
					'chromecast' == b.linkurl
						? ((b.chromecast = 1),
						  (b.hide = 1),
						  o.chromecast &&
								(q[0].innerHTML = o.chromecast.button(
									-1 != b.iconscolor ? b.iconscolor : '#ffffff'
								)),
						  o.system.mobile
								? ((q[0].ontouchstart = it),
								  (q[0].ontouchend = rt),
								...
								: ((q[0].onmouseover = at),
								  (q[0].onmouseout = rt),
								  (q[0].onmousemove = ht)))
						: (s.offsetWidth * b.scale < 35 || s.offsetHeight * b.scale < 35) &&
						  'text' != b.type
						? (tt(), et(n))
						: et(s),
					'custom' == c)
					...
					if (1 == b.link && exist(b.linkurl)) {
						var G = b.linkurl
						if (0 == G.indexOf('api:'))
							if (2 == ($ = G.substr(4).split(',')).length) {
								var Z = $[1].split('/')
								2 == Z.length &&
									('hd' == $[0] && ($[0] = 'default_quality'),
									v[$[0]] == Z[1] && ((b.a = 1), css(q[0], { opacity: b.a })))
							}
						;('unblock' != G && 'block' != G) ||
							(o.actions.Curtain(), (U.style.zIndex = 2001), (o.stopkeys = 1))
					}
					;((1 != b.hide || (1 != b.hideafter && 1 != b.hidebefore)) &&
						'skip' != G) ||
						(b.often = 1)
				}
				'settings' == c && 1 == b.hdicon && (g = new PluginHdIcon(U, s, b)),
					0 == b.click && Pnt0(U),
					1 == b.loading && hide(s),
					1 == b.tip &&
						(function () {
							...
							b.tipvar || css(l, { 'white-space': 'nowrap' })
							1 == b.tippointer &&
								((d = createElement('div')).innerHTML =
									...
									b.tipbgcolor.replace('#', '') +
									'" fill-rule="evenodd" points="0 0 8 0 4 6"></polygon></svg>')
							1 == b.tipalways ? (css(a, { opacity: 1 }), et(a)) : Pnt0(a)
							if (
								(U.appendChild(a),
								(l.innerHTML =
									o.ni + ('' == b.tiptext ? Lang(c) : H[0]) + o.ni2),
								a.appendChild(r),
								a.appendChild(l),
								1 == b.tippointer)
							) {
					...
					b.position.indexOf('right') > -1 && (E = 1),
					b.position.indexOf('top') > -1 && 1,
					(b.position.indexOf('bottom') > -1 ||
						b.position.indexOf('control') > -1) &&
						(L = 1),
					nt()
				var J = ''
				0 != b.rotation && (J += 'rotate(' + b.rotation + 'deg)'),
					1 == b.flipx && (J += ' scaleX(-1)'),
					1 == b.flipy && (J += ' scaleY(-1)'),
					'' != J && css(U, { transform: J }),
					'buffer' == c && kt()
				var K,
					$ = []
				...
				if ('title' == c)
					for (
						$ = ['showtitleplaylist', 'addtitleplaylist', 'addtitleplaylistbr'],
							K = 0;
						K < $.length;
						K++
					)
						exist(b[$[K]]) && !exist(options[$[K]]) && (v[$[K]] = b[$[K]])
				1 == b.tipalways && mt(),
					'custom' == c && 0 == b.on && hide2(U),
					1 == b.hide &&
						b.hideuntilto > 0 &&
						setTimeout(function () {
							;(b.hideuntilto = -1), o.controls.refresh()
						}, 1e3 * b.hideuntilto)
			}
			function tt() {
				n && n.parentNode.removeChild(n),
					...
					css(n, {
						...
						width:
							'pic' == b.type
								? s.offsetWidth
								: (s.offsetWidth > 35 ? s.offsetWidth : 35) * b.clickscalex,
						height:
							'pic' == b.type
								? s.offsetHeight
								: (s.offsetHeight > 35 ? s.offsetHeight : 35) * b.clickscaley,
					}),
					(b = MarginPadding(b, 'clickmargin', 'clickmargin')),
					U.appendChild(n)
			}
			function et(t) {
				0 == c.indexOf('time') && 1 == V.length && (b.click = 0),
					'custom' == c && 0 == b.link && (b.click = 0),
					1 == b.click
						? (1 == b.hand && css(t, { cursor: 'pointer' }),
						  css(t, { pointerEvents: 'auto' }),
						  o.system.mobile
								...
								: (t.onclick = dt),
						  (1 != v.toolbar.clickarea && 1 != b.clickarea) ||
								css(t, { 'background-color': '#ff0000', opacity: 0.5 }))
						: css(t, { cursor: 'default' }),
					o.system.mobile || ((t.onmouseover = at), (t.onmouseout = rt)),
					(1 != b.hidden && 1 != b.tip) || (t.onmousemove = ht)
			}
			function ot(e) {
				js('touch_' + t), e.stopPropagation(), (O = !0)
			}
			function it(t) {
				1 == b.mobileover && at(), t.stopPropagation()
			}
			function st() {
				if (
					(s && s.parentNode.removeChild(s),
					(s = createElement('div')),
					css(s, { position: 'absolute', top: 0, left: 0 }),
					exist2(b.dom) && attr(s, { id: v.id + '_control_' + b.dom + '_bg' }),
					(e = b.w),
					(i = b.h),
					(b = MarginPadding(b, 'margin', 'margin')),
					'text' == (b = MarginPadding(b, 'marginproc', 'marginproc')).type &&
						((e = q[R].offsetWidth),
						(i = q[R].offsetHeight),
					...
					for (var t = 0; t < Object.keys(v.custom).length; t++)
						if (v.custom[t][b.dom])
							if ('off' == v.custom[t][b.dom]) b.on = 0
							else {
								var n = v.custom[t][b.dom].split(':')
								'margin-left' == n[0] &&
									(n[1].indexOf('%') > 0
										? (b.marginprocleft = parseInt(n[1]))
										: (b.marginleft = parseInt(n[1])))
							}
				;(b.h = i),
					(b.w = e),
					1 == b.bg
						? ((i = i + b.bgpaddingtop + b.bgpaddingbottom),
						  (e = e + b.bgpaddingleft + b.bgpaddingright),
						  (b.h = i),
						  (b.w = e),
						  'text' == b.type && (b.bgh = q[0].offsetHeight))
						: (b.bga = 0),
					css(s, {
					...
					1 == b.bgborder && css(s, { border: '1px solid ' + b.bgbordercolor }),
					W.appendChild(s)
			}
			function nt() {
				if (
					(css(s, { top: -s.offsetHeight / 2, left: -s.offsetWidth / 2 }), n)
				) {
				...
				for (K = 0; K < D.length; K++)
					'svg' == b.type
						? css(q[K], {
								top: -Math.round(parseInt(q[K].style.height)) / 2,
								left: -parseInt(q[K].style.width) / 2,
						  })
						: css(q[K], {
								top: -Math.round(q[K].offsetHeight) / 2,
								left: -q[K].offsetWidth / 2,
						  }),
						s &&
							css(q[K], {
								top:
			...
			function at() {
				...
				if (
					((P = !0),
					1 == b.iconsover &&
						((e = f && exist(b.icon2) ? 1 : 0),
						z && F.length > 2 && (e = 2),
						F[e] && (pt(), show(q[F[e]]))),
					1 == b.bg &&
						(-1 != b.bgaover && css(s, { opacity: b.bgaover }),
						-1 != b.bgcolorover && css(s, { background: b.bgcolorover })),
					b.aover > -1 && !w)
				)
					for (e = 0; e < D.length; e++)
						'hidden' != q[e].style.visibility && css(q[e], { opacity: b.aover })
				if (
					(-1 != b.iconscolorover && Tt(q, b.iconscolorover),
					1 == b.rotateonhover && ((C += 45), yt(q[0], C)),
					b.scaleover > b.scale && b.scaleover > -1 && gt(b.scaleover),
					'settings' == c && o.controls.SettingsVisible())
				);
				else if (1 == b.tip && 1 != b.tipalways) {
					var i = H.length > 1 && !f ? H[1] : H[0]
					i &&
						0 == i.indexOf('var:') &&
						((l.innerHTML = window[i.substr(4)]), mt()),
						show(a),
						css(a, { opacity: 1 })
				}
				'mute' == c && (o.actions.volumewheel(!0), (o.volumewheel = !0)),
					(o.controlover = !0),
			...
			function rt() {
				...
				if (
					...
					1 == b.iconsover &&
						...
						show(q[e])),
					1 == b.bg &&
						(-1 != b.bgaover && css(s, { opacity: b.bga }),
						-1 != b.bgcolorover && css(s, { background: b.bgcolor })),
					b.aover > -1)
				)
					for (e = 0; e < D.length; e++)
						'hidden' != q[e].style.visibility && css(q[e], { opacity: b.a })
				b.scaleover > -1 && gt(b.scale),
					-1 != b.iconscolorover &&
						Tt(q, -1 == b.iconscolor ? '#ffffff' : b.iconscolor),
					'mute' != c ||
						o.fullscreen ||
						(o.actions.volumewheel(!1), (o.volumewheel = !1)),
					lt(),
			...
			function lt() {
				1 == b.tip && 1 != b.tipalways && (hide(a), css(a, { opacity: 0 }))
			}
			function dt(e) {
				e && (e.cancelBubble = !0),
					A ||
						...
						'custom' == c && ct(),
						lt(),
						1 == b.rotateonclick && ((C += 45), yt(q[0], C)),
						(j = !0),
						(1 == b.hideafterclick ||
							('control_start' == t && 1 == b.hide && 1 == b.hideonplay)) &&
							o.controls.refresh())
			}
			function ct() {
				D &&
					(D.length > 1 &&
						(1 == f ? (show(q[0]), hide(q[1])) : (show(q[1]), hide(q[0]))),
					1 == b.tip &&
						H.length > 1 &&
						((l.innerHTML = o.ni + (1 == f ? H[0] : H[1]) + o.ni2), mt())),
					exist(b.linkurl0) && (b.linkurl = 1 == f ? b.linkurl0 : b.linkurl2),
					ut(),
					(f = 1 != f),
					b.linkurl &&
						b.linkurl.indexOf(',0/1') > -1 &&
						js(b.linkurl, f ? 1 : 0),
					1 == b.bg &&
						exist(b.bgcolorlink2) &&
						-1 != b.bgcolorlink2 &&
						(f
							? ((b.bgcolorlink0 = b.bgcolor), (b.bgcolor = b.bgcolorlink2))
							: (b.bgcolor = b.bgcolorlink0),
						st(),
						et(s),
						nt(),
						'text' == b.type ? _t() : gt(b.scale))
			}
			function ut() {
				exist(b.texts) &&
					b.texts.length > 1 &&
					xt(1 == f ? b.texts[0] : b.texts[1])
			}
			function pt() {
				for (var t = 0; t < D.length; t++)
					'hidden' != q[t].style.visibility &&
						(css(q[t], { opacity: b.a }), hide(q[t]))
			}
			function vt(t) {
				q[0] &&
					q[0].offsetWidth >
					...
					(1 == b.marquee
						? (t || (t = q[0].innerHTML),
						  (q[0].innerHTML = '<marquee>' + t + '</marquee>'))
						: css(q[0], { 'white-space': 'normal' }),
					css(q[0], {
						width:
							o.screen_w -
							b.marginleft -
			...
			function ft() {
				s
					? ((m = !1),
					  ...
					  hide(s),
					  q[0] &&
							((b.w = q[0].offsetWidth * b.scale),
							(b.h = q[0].offsetHeight * b.scale),
							gt(b.scale)),
					  (b.loaded = 0),
					  st(),
					  tt(),
			...
			function ht() {
				o.system.mobile || o.controlover || at(), mt()
			}
			function gt(t) {
				if (t > 0) {
					for (
						o.system.safari && 1 != b.tipalways
							? css(s, { zoom: t + '' })
							: css(s, { transform: 'scale(' + t + ')' }),
							K = 0;
						K < D.length;
						K++
					)
			...
			function mt() {
				1 == b.tip &&
					(css(a, {
						top:
							(1 == L ? -i - a.offsetHeight + 3 : -a.offsetHeight / 2) +
							b.tipmargintop -
							b.tipmarginbottom,
						left:
							(1 == E ? -l.offsetWidth : 1 == L ? -e / 2 : +l.offsetWidth) -
							(1 == L ? 0 : l.offsetWidth / 2 + 5) +
							b.tipmarginleft -
							b.tipmarginright,
						height: b.tippaddingtop + l.offsetHeight + b.tippaddingbottom,
						width: b.tippaddingleft + l.offsetWidth + b.tippaddingright,
					}),
					css(r, { height: a.offsetHeight }),
					(a.style.zIndex = '1000'))
			}
			function bt() {
				A = !1
			...
			function xt(t) {
				if ('text' == b.type) {
					exist(t) &&
						(b.with_hours &&
							(4 == t.length && (t = (b.timeshort ? '0:0' : '00:0') + t),
							5 == t.length && (t = (b.timeshort ? '0:' : '00:') + t),
							7 == t.length && (t = (b.timeshort ? '' : '0') + t)),
						b.with_min && 4 == t.length && (t = '0' + t),
						(b.lngth = t.length)),
						(t =
							(b.presmbl ? b.presmbl + (b.minus4back ? '' : ' ') : '') +
							t +
							(b.postsmbl ? ' ' + b.postsmbl : ''))
					var e =
							q[0].offsetWidth +
							(1 == b.bg ? b.bgpaddingtop + b.bgpaddingbottom : 0),
						i =
							q[0].offsetHeight +
							(1 == b.bg ? b.bgpaddingtop + b.bgpaddingbottom : 0)
					;(q[0].innerHTML = o.ni + ('custom' == c ? St(t) : t) + o.ni2),
						1 == b.triangle &&
							(q[0].innerHTML +=
						...
						'title' == c &&
							(css(q[0], { width: 'auto', 'white-space': 'nowrap' }), vt(t)),
						(b.w =
							q[0].offsetWidth +
							(1 == b.bg ? b.bgpaddingtop + b.bgpaddingbottom : 0)),
						(b.h =
							q[0].offsetHeight +
							(1 == b.bg ? b.bgpaddingtop + b.bgpaddingbottom : 0)),
						(e != b.w || i != b.h || (b.w > 0 && 0 == y)) && _t(),
						q[0].offsetWidth > 0
							? (y = b.w)
							: ('' != T && hide(q[0]), '' != t && setTimeout(_t, 10))
				}
			}
			function _t() {
				'text' == b.type &&
					...
					q[0].offsetWidth > 0 &&
					('' != T && show(q[0]),
					(e = b.w = q[0].offsetWidth),
					(i = b.h = q[0].offsetHeight),
					st(),
					et(s),
					nt(),
			...
			function wt(t) {
				return (
					o.ni +
					('' == b.tiptext ? Lang(V[t]) : H.length > 1 ? H[t] : H[0]) +
					o.ni2
				)
			}
			function kt() {
				hide2(U)
				for (var t = U.getElementsByTagName('*'), e = t.length; e--; )
					css(t[e], { 'animation-play-state': 'paused' })
				_ = !1
			}
			function St(t) {
				var e = t + ''
				if (
					(t.indexOf('{time}') > -1 &&
						exist(o.continue) &&
						(t = t.replace('{time}', timeFormat(o.continue.flag().t))),
					t.indexOf('{title') > -1)
				) {
					var i = o.titlestore ? o.titlestore : v.title ? v.title : ''
					t.indexOf('{title2}') > -1 &&
						o.controls &&
						(t = t.replace('{title2}', o.controls.PlaylistG('title2'))),
						o.butplstart &&
							o.controls &&
							(i = o.controls.PlaylistG('butplstart')),
						(t = t.replace('{title}', i)),
						o.butplstart && !o.controls && setTimeout(xt, 100, e)
				}
				return t
			}
			function Tt(t, e) {
			...
			;(this.Click = function () {
				...
				(this.set = function (e, i) {
					switch (e) {
						...
						case 'display':
							!(function (e) {
								e && o.system.mobile && ((A = !0), setTimeout(bt, 300))
								e ||
									(1 == b.iconsreplay &&
										z &&
										(hide(q[N]), show(q[0]), (z = !1)))
								1 == b.loading
									? e
										? show(U)
										: hide(U)
									: ('control_time' == t || 'control_duration' == t
											? e
												? show(U)
												: hide(U)
											: css(U, { display: e ? 'block' : 'none' }),
									  (_ = e),
									  e && show(U))
								e && b.resizetxt && ((b.resizetxt = !1), setTimeout(_t, 100))
							})(i)
							break
						case 'show2':
							show2(U)
						...
						case 'scale':
							...
							break
						case 'scale0':
							css(U, { transform: 'scale(0)' })
							break
						case 'scaleX':
							css(U, { transform: 'scaleX(' + i + ')' }), (k = i)
							break
						case 'scaleY':
							css(U, { transform: 'scaleY(' + i + ')' }), (S = i)
							break
						case 'opacity':
							css(U, { opacity: i })
							break
				...
				(this.UpdateText = function (t) {
					'' == T || ('x' != b.text && '1x' != b.text) || (t += 'x'),
						xt(t),
						!isVisible(U) && (b.resizetxt = !0)
				}),
				(this.CustomText = function (t) {
					;(b.customtext = t), xt(t), o.controls.resize()
				}),
				(this.Rotate = function () {
					yt(U, x), (x += 20)
				}),
				(this.RenewFromTitle = function (t) {
					b.text.indexOf('{title') > -1 && xt(b.text)
				}),
				...
				(this.UpdateVolume = function (e) {
					if (1 == b.displayvolume) {
						...
						for (var s = [], n = 1; n < i; n++)
							s[n] = document.getElementById(
								'pjs_'.concat(v.id, t, 'volume_element', n)
							)
						if (s[1]) {
							for (n = 1; n < i; n++) s[n] && hide(s[n])
							if (4 == i)
								for (n = 1; n < i; n++) e > n / i && s[n] && show(s[n])
							else
								for (n = i; n > 0; n--)
									if (1 * e + 1 / i >= n / i && s[n]) {
										show(s[n])
				...
				(this.On = function () {
					f ||
						(D && D.length > 1 && V.length > 1 && (hide(q[0]), show(q[1])),
						V.length > 1 &&
							((c = V[1]), 1 == b.tip && ((l.innerHTML = wt(1)), mt())),
						1 == b.iconsreplay && z && (hide(q[N]), (z = !1)),
						ut(),
						(f = !0))
				}),
				(this.CustomSwitch = function (e) {
					!(function (e) {
						...
						i
							? (css(i, { transition: 'transform 0.1s ease-out' }),
							  (i.style.transform =
									1 == e ? 'translate(0, 0)' : 'translate(-7px, 0)'))
							: (b.a = 1 == e ? 1 : 0.5)
						;(f = 1 == e),
							1 == b.tip && H.length > 1 && (l.innerHTML = f ? H[0] : H[1])
						css(q[0], { opacity: b.a })
					})(e)
				}),
				(this.Off = function () {
					f &&
						(D && D.length > 1 && V.length > 1 && (show(q[0]), hide(q[1])),
						(c = V[0]),
						V.length > 1 && 1 == b.tip && ((l.innerHTML = wt(0)), mt()),
						ut(),
						(f = !1),
						(z = !1))
				}),
				(this.ReplayIcon = function () {
					1 == b.iconsreplay && (pt(), show(q[N]), (z = !0))
				}),
				(this.Buffer = function () {
					...
					if (
						...
						show2(U)
						for (var e = U.getElementsByTagName('*'), i = e.length; i--; )
							css(e[i], { 'animation-play-state': 'running' })
						_ = !0
					}
				}),
				...
				(this.Remove = function () {
					if (D.length > 0)
						for (K = 0; K < D.length; K++) U.removeChild(q[K]), (q[K] = null)
					s &&
		...
		ControlLine = function (t, e) {
			...
			for (i in default_style[e]) y[i] = default_style[e][i]
			for (i in v[t]) y[i] = v[t][i]
			;(y.w = parseInt(y.w)),
				(y.h = parseInt(y.h)),
			...
			1 == v.toolbar.hidedown && 1 == v.toolbar.hide
				? o.toolbar.appendChild(T)
				: o.frame.appendChild(T),
				'line' == e && (o.timeline = T)
			var P = !1
			y.customline && 'volume' != y.customline && (P = !0),
				css(T, {
					position: 'absolute',
					top: 0,
					left: 0,
				...
				1 == y.ontop && (T.style.zIndex = y.order),
				(function () {
					n = createElement('div')
					var t =
							(y = MarginPadding(y, 'bgpadding', 'bgpadding')).h +
							y.bgpaddingtop +
							y.bgpaddingbottom,
						e = y.w + y.bgpaddingleft + y.bgpaddingright
					1 == y.bg || (y.bga = 0)
					;(y = MarginPadding(y, 'clickmargin', 'clickmargin')),
						(1 == v.toolbar.clickarea || 1 == y.clickarea) &&
							((y.bgcolor = '#ff0000'), (y.bg = 1), (y.bga = 0.5))
					css(n, {
						position: 'absolute',
						top: 0,
						left: 0,
						...
						1 == y.bgborder &&
							css(n, { border: '1px solid #' + y.bgbordercolor })
					1 == y.click
						? (1 == y.hand && css(n, { cursor: 'pointer' }),
						  o.system.mobile ||
								((n.onclick = Q),
								(n.onmouseup = G),
								(n.onmousedown = Z),
								(n.onmousemove = $)))
						: css(n, { cursor: 'default' })
					o.system.mobile ||
						((n.onmouseover = W), (n.onmousemove = $), (n.onmouseout = X))
					o.system.mobile &&
					...
					css(n, { left: Math.ceil(-y.w / 2 - y.bgpaddingleft) }),
						css(n, {
							top: Math.ceil(
								-y.h / 2 -
									y.bgpaddingtop +
			...
			css(O, {
				...
				exist2(y.dom) && attr(T, { id: v.id + '_control_' + y.dom }),
				T.appendChild(O),
				'line' == e &&
					1 == v.thumbs &&
					(function () {
						...
						;(o.thumb.style.zIndex = '999'), T.appendChild(o.thumb)
					})(),
				1 == y.tip &&
					(function () {
						;(p = createElement('div')),
							...
							1 == y.tippointer &&
								((h = createElement('div')).innerHTML =
									'<svg width="8px" height="6px" viewBox="0 0 8 6" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><polygon id="Rectangle" stroke="none" fill="' +
									CheckColor(y.tipbgcolor) +
									'" fill-rule="evenodd" points="0 0 8 0 4 6"></polygon></svg>')
						T.appendChild(p),
							p.appendChild(f),
							1 == y.tippointer &&
			...
			if (
				(F(
					...
					0.3,
					1 == y.gradient
						? 'linear-gradient(#' + y.gradientcolorbg + ', #' + y.colorbg + ')'
						: y.colorbg,
					y.w,
					y.abg
				),
				...
				var E = createElement('div')
				;(E.innerHTML = y.customdesignsvg.replace(
					/\#FFFFFF/g,
					'#' + y.colorbg
				)),
					C.appendChild(E),
					...
					css(C, { overflow: 'hidden', background: 'none' })
				for (
					var L = ['path', 'polygon', 'polyline', 'rect', 'ellipse'], A = 0;
					A < L.length;
					A++
				) {
					if ((q = E.querySelectorAll('svg ' + L[A])).length > 0)
						for (var I = 0; I < q.length; I++) q[I].style.fill = y.colorbg
				}
			}
			O.appendChild(C)
			...
			if (
				...
				F(2, M, y.linespeed2, y.colorover, 0, y.aover), O.appendChild(M)
			}
			...
			if (
				(F(
					...
					y.linespeed3,
					1 == y.gradient
						? 'linear-gradient(#' + y.gradientcolor + ', #' + y.color + ')'
						: y.color,
					0,
					y.a
				),
				...
				;(H.innerHTML = y.customdesignsvg.replace(/\#FFFFFF/g, '#' + y.color)),
					css(H, {
						position: 'absolute',
						bottom: -Math.round(y.h / 2),
						left: 0,
					...
					css(V, { overflow: 'hidden', background: 'none' }),
					V.appendChild(H)
			}
			if (1 == y.value) {
				...
				;(y = MarginPadding(y, 'valuepadding', 'valuepadding')),
					...
					1 == y.valuebg && css(z, { background: '#' + y.valuebgcolor }),
					V.appendChild(z)
				var R = !1
			}
			if (((o.timeline_h = y.h), O.appendChild(V), 1 == y.pointed)) {
				if (void 0 !== PluginPoints) var D = new PluginPoints(T, [], s, y)
			}
			if (1 == y.handle) {
				if (
					(-1 == y.handleicon.toString().indexOf('<svg') &&
						'' == y.handleicon &&
						(y.handleicon =
							"<svg width='20' height='20'><g><ellipse ry='5' rx='5' cy='10' cx='10' fill='#fff'/></g></svg>"),
					...
					1 == y.handlehide || 1 == y.handlehideinit
						? css(u, { transform: 'scale(0)' })
						: 1 != y.handlescale &&
						  css(u, { transform: 'scale(' + y.handlescale + ')' }),
					T.appendChild(u),
					-1 != y.handlecolor)
				)
					for (L = ['path', 'rect', 'ellipse'], A = 0; A < L.length; A++) {
						var q
						if ((q = u.querySelectorAll('svg ' + L[A])).length > 0)
							for (I = 0; I < q.length; I++)
								q[I].style.fill = '#' + y.handlecolor
					}
			...
			function N(t) {
				if (t != s) {
					...
					a > C.offsetWidth && (a = C.offsetWidth), css(j, { width: a })
					var r = V.offsetWidth * i
					css(V, { width: r }),
						B(r),
						'line' == e &&
							(function () {
			...
			function W(i) {
				if ((o.controls.Mouse(t, 'over'), 1 == y.bg)) {
					if (-1 != y.bgaover)
						new Motion({
							mc: n,
							type: 'alpha_div',
					...
					exist2(y.bgcolorover) && css(n, { 'background-color': y.bgcolorover })
				}
				if (
					(exist2(y.coloroverplay) &&
						css(V, { 'background-color': y.coloroverplay }),
					1 == y.handle)
				)
					if (
						(1 == y.handleiconsover &&
							exist(y.handleiconover) &&
							((1 == y.handleiconspress && l) ||
								(u.innerHTML =
									"<svg width='" +
									y.handle_width +
									"' height='20' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg'>" +
									y.handleiconover.toString() +
									'</svg>')),
						1 == y.handlehide)
					)
						(1 != y.handlehideinit || o.start) && U()
				...
				1 == y.tip && (o.media.duration() > 0 || 'volume' == e || P) && et(),
					y.expand > 0 &&
						(css(n, { transform: 'scaleY(' + ((y.expand - 1) / 5 + 1) + ')' }),
						Y(y.expand)),
					1 == y.handle && 1 == y.handlemove && B(i.clientX - S),
					'volume' == e && (o.actions.volumewheel(!0), (o.volumewheel = !0)),
					(m = !0),
					(o.controlover = !0)
			}
			function Y(t) {
				css(C, { transform: 'scaleY(' + t + ')' }),
					css(j, { transform: 'scaleY(' + t + ')' }),
					M && css(M, { transform: 'scaleY(' + t + ')' }),
					css(V, { transform: 'scaleY(' + t + ')' })
			}
			function X() {
				if (!d) {
					if (
						(y.aover > 0 && css(M, { width: 0 }),
						exist2(y.coloroverplay) && css(V, { 'background-color': y.color }),
						1 == y.bg)
					) {
						if (-1 != y.bgaover)
							new Motion({
						...
						exist2(y.bgcolorover) && css(n, { 'background-color': y.bgcolor })
					}
					if (1 == y.handle)
						if (
							(1 == y.handleiconsover &&
					...
					y.expand > 0 && (css(n, { transform: 'scaleY(1)' }), Y(1)),
						'volume' != e ||
							o.fullscreen ||
							(o.actions.volumewheel(!1), (o.volumewheel = !1)),
				...
				1 == y.pointed && D && D.out(),
					...
					o.thumbs_on && 'line' == e && (o.th.hide(), (o.current_thumb = -1)),
					(m = !1),
					(o.controlover = !1)
			}
			function Q(t) {
			...
			function G(i) {
				'volume' == e &&
					...
					(o.mouseDown = !1),
					1 == y.handle &&
						1 == y.handleiconspress &&
						exist(y.handleiconpress) &&
						(u.innerHTML =
							"<svg width='20' height='20' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg'>" +
							y.handleicon.toString() +
							'</svg>'),
			...
			function J(t, e) {
				...
				o.system.mobile || ((e += a), (t += n)),
					y.vertical > 0
						? ((i = e - k - y.bgpaddingright),
						  (c = i / s),
						  270 == y.vertical &&
								((i = e - k - y.bgpaddingleft), (c = -1 * ((c = i / s) - 1))))
						: ((i = t - S - y.bgpaddingleft),
						  (c = i / s),
						  y.rotation > 134 &&
								y.rotation < 235 &&
								((i = t - S - y.bgpaddingright), (c = -1 * ((c = i / s) - 1)))),
					c > 1 && (c = 1),
					c < 0 && (c = 0)
			}
			function K() {
			...
			function $(t) {
				if (
					...
					y.aover > 0 &&
						(o.start || 'line' != e) &&
						css(M, { width: t.clientX - S }),
					1 == y.tip && (o.media.duration() > 0 || 'volume' == e || P))
				) {
					if ((et(), (k = findTop(n)), J(t.clientX, t.clientY), 'line' == e))
						if (1 == v.hlsdvrtime)
							o.media.isLive() && o.media.currentFile().indexOf('?DVR') > 0
								? (f.innerHTML =
										'- ' + timeFormat((1 - c) * o.media.duration(!0)))
								: (f.innerHTML = timeFormat(c * o.media.duration()))
						else {
			...
			function tt(t, e, i) {
				var n =
						-s / 2 +
						(t.clientX + document.documentElement.scrollLeft - S) -
						f.offsetWidth / 2 +
						(i || 0),
					a = 0
				1 != v.notofh &&
					(n + s / 2 + f.offsetWidth + 10 > o.screen_w &&
						((a = n), (n = o.screen_w - s / 2 - f.offsetWidth - 10)),
					n + o.screen_w / 2 < 0 && ((a = n), (n = -o.screen_w / 2)))
				var r = {
					top:
						-f.offsetHeight -
						1 * y.linetipmarginbottom -
						y.tippaddingtop -
						y.tippaddingbottom -
						(1 == y.toptip ? (y.h / 2) * (y.expand > 0 ? y.expand : 1) : 0) +
						(e || 0),
					left: n,
				}
				css(p, r),
			...
			function et() {
				;(isVisible(p) && 0 != p.style.opacity) ||
					(show(p), css(p, { opacity: 1 }))
			}
			function ot() {
				hide(p), css(p, { opacity: 0 })
			}
			function it(t, o, i) {
				var n
				;(t < 0 && (t = 0),
				v.delete > 0 && o > 1 && ((o -= v.delete), (t -= v.delete)),
				1 == y.handle &&
					1 == y.handlehideinit &&
					1 != y.handlehide &&
					!y.handleinit &&
				...
				l && 1 != o) ||
					(o > 0 && t > 0
						? (t > o && (t = o), (n = s * (t / o)) == V.offsetWidth && (n = -1))
						: (n = 0),
					n >= 0 && (css(V, { width: n }), (1 == y.handlemove && m) || B(n)),
					exist(z) &&
						(o < 2 && 'line' == e
							? R && (hide2(z), (R = !1))
							: (R || (show2(z), (R = !0)),
							  (z.innerHTML = 'line' == e ? Time(0 == t ? o : t) : st(t)))))
			}
			function st(t) {
				var e = Math.round(100 * t)
				return P && o.line_speed
					? (P && exist2(y.tiptext) ? y.tiptext + '&nbsp;' : '') +
							parseFloat(t * o.files_speed.slice(-1)[0]).toFixed(1)
					: e
			}
			0 != y.rotation && css(T, { transform: 'rotate(' + y.rotation + 'deg)' }),
				1 == y.hidden && (hide(T), (x = !1)),
				'volume' == e &&
					(1 == y.hide && 1 == y.hideoutmute
						? ((o.hidden_volume = !0), (y.hidden = !0))
						: (o.hidden_volume = !1)),
				(y.vertical = 0),
				0 != y.rotation &&
					((y.rotation2 = Math.abs(y.rotation)),
					y.rotation2 > 45 && y.rotation2 < 135 && (y.vertical = 90),
					y.rotation2 > 225 && y.rotation2 < 315 && (y.vertical = 270)),
				P &&
					((o.line_speed = 'speed' == y.customline),
					(s = y.w),
				...
				(this.set = function (t, o) {
					switch (t) {
						...
						case 'display':
							'line' == e || 1 == y.hide
								? css(T, { visibility: o ? 'visible' : 'hidden' })
								: css(T, { display: o ? 'block' : 'none' }),
								(x = o)
							break
						case 'scaleX':
							css(T, { transform: 'scaleX(' + o + ')' }), (_ = o)
							break
						case 'scaleY':
							css(T, { transform: 'scaleY(' + o + ')' }), (w = o)
							break
						case 'opacity':
							css(T, { opacity: o })
							break
				...
				(this.StageMove = function (i, s) {
					l &&
						(('volume' == e || P) && (J(i, s), o.controls.ControlClick(t)),
				...
				(this.StageMouseUp = function (e, i) {
					l &&
						(K(), (l = !1), J(e, i), o.controls.ControlClick(t), it(c, 1, 'no'))
				}),
				(this.UpdatePlay = function (t, e, o) {
					;(null == e && null == t) || it(t, e)
				}),
				(this.UpdatePlaySeek = function () {
					c > 1 && (c = 1), c < 0 && (c = 0), css(V, { width: c * s })
				}),
				(this.UpdateLoad = function (t, e) {
					e > 0 && t > 0
						? (css(j, { width: int(s * (t / e)) }), e, t)
						: (0, css(j, { width: 0 }))
				}),
				(this.Cut = function (t) {
					1 == y.cut &&
						(o.cut
							? (exist(t) && 0 != t) || !o.cutted
								? (!o.cutted || (exist(t) && 1 != t && 0 != t)) &&
								  (o.cut.restart(t), (o.cutted = !0))
								: (o.cut.hide(), (o.cutted = !1))
							: 0 != t &&
							  'undefined' != typeof PluginCut &&
							  ((o.cut = new PluginCut(T, y, t)), (o.cutted = !0)))
				}),
				(this.Remove = function () {
					T.removeChild(O),
						n &&
							...
							(n = null)),
						u && T.removeChild(u),
						T.parentNode == o.frame
							? o.frame.removeChild(T)
							: o.toolbar &&
							  T.parentNode == o.toolbar &&
							  o.toolbar.removeChild(T),
						(T = null)
				})
		},
		ControlsBg = function () {
			var t,
				...
				r = 0,
				l = random(1e5, 2e5)
			for (var d in ((e.position = v.toolbar.position), v.toolbar))
			...
			if (
				(css(u, {
					...
					width_: '100%',
					height:
						e.h - ('top' != e.position ? e.marginbottom + e.margintop : 0),
					display: 'block',
			...
			else css(u, { 'background-color': e.color })
			;(this.h = function () {
				...
				(this.g = function (e) {
					...
					switch (e) {
						case 'w':
							return c.offsetWidth > 0 && (t = c.offsetWidth), t
						case 'width':
							return c.offsetWidth
						case 'height':
				...
				(this.set = function (e, l) {
					switch (e) {
						...
						case 'w':
							...
							break
						case 'display':
							css(c, { display: l && !o.hidecontrols ? 'block' : 'none' }),
								(i = l)
							break
						case 'scale':
							css(c, { transform: 'scale(' + l + ')' }), (s = l), (n = l)
							break
						case 'scaleX':
							css(c, { transform: 'scaleX(' + l + ')' }), (s = l)
							break
						case 'scaleY':
							css(c, { transform: 'scaleY(' + l + ')' }), (n = l)
							break
						case 'opacity':
							css(c, { opacity: l })
							break
	...
	function Init() {
		...
		if (
			('' == o.u || stop || (v = UpdateObject(v, (o.u, o.u))),
		...
		if (
				...
				window.addEventListener('message', function (t) {
					...
					if (
						('data' in t &&
							...
							('time' in t.data && exist(t.data.time) && (i = t.data.time),
						...
						e && v.postmessages) &&
						'' != v.postmessages &&
						-1 == v.postmessages.replace(/\s+/gi, '').split(',').indexOf(e)
					)
						return
					if (
						(1 == v.pjsframed && 'function' == typeof PjsFrMsg && PjsFrMsg(t),
						e && o.init)
					) {
						exist(t.data.set) && (i = t.data.set)
						var s = apiProcessor(e, i)
						window.parent.postMessage({ event: e, answer: s }, '*')
					}
				}),
			o.compilation))
						...
						if (parent.document)
							for (
								...
								frames[i].contentWindow === window &&
									...
									(o.iniframe = !0),
									1 != v.notframe && css(o.parentIframe, { border: 'none' }),
			...
			if (
				...
				if (
					...
					o.container.style.width.indexOf('%') > -1 &&
						(o.container_w_procent = o.container.style.width),
					('off' == v.aspect || o.container.style.height.indexOf('%') > -1) &&
						((v.aspect = '%'),
						(o.container_h_procent = o.container.style.height),
						(o.container_h = 0)),
					0 == o.container_w &&
						(o.container.style.width.indexOf('px') > 0
							? (o.container_w = parseInt(o.container.style.width))
							: o.container.parentNode.style.width.indexOf('px') > 0
					...
					0 == o.container_w && css(o.container, { width: '100%' }),
					...
					obsrvr.observe(o.container, { childList: !0 })
				}
				if (
					...
					(o.container.oncontextmenu = function (t) {
						if (
							(o.rightclick++,
							5 == o.rightclick &&
								((v.log = 1), log(o.version + ' ' + o.compilations)),
							!t)
						)
							t = window.event
			...
			if (
				...
				if (exist(o.rightmenu)) show2(o.rightmenu)
					...
					for (var s = 0, n = 0; n < 10; n++)
						if (
							((1 == v['rm' + n] && 1 == v.rightmenu) || 9 == n) &&
							((exist(v['rm' + n + 't']) && exist(v['rm' + n + 'a'])) || 9 == n)
						) {
							if (((i = createElement('div2')), 9 == n)) {
								if (1 == v.rc_nobrand) break
								i.innerText = o.brand
							} else i.innerText = v['rm' + n + 't']
							if (
								9 != n &&
								(v['rm' + n + 'a'].indexOf(',0/1') > -1 ||
									v['rm' + n + 'a'].indexOf(',1/0') > -1)
							) {
								var a = v['rm' + n + 'a'].split(',')
								i.innerText +=
									' (' +
									(1 == api(a[0].substr(4)) ? Lang('on') : Lang('off')) +
									')'
							}
							i.setAttribute('i', n),
								RightCSS(i),
					...
					css(o.rightmenu, {
						...
						s > 1 && css(o.rightmenu, { padding: '5px' }),
				...
				var r = !1
				o.screen_w - t < o.rightmenu.offsetWidth - 20 &&
					1 != v.notofh &&
					(css(o.rightmenu, { left: t - o.rightmenu.offsetWidth }), (r = !0)),
					(1 == v.rmright || r) && css(o.rightmenu, { 'text-align': 'right' }),
					(o.right_x = t),
					(o.right_y = e),
		...
		function RightOver(t) {
			css(t.target, { opacity: 1 }),
				css(t.target, { background: hex2rgb(v.rmbgcolor, 0.5) })
		}
		function RightOut(t) {
			css(t.target, { opacity: 0.9 }), css(t.target, { background: 'none' })
		}
	}
	function Ready() {
		if (
			...
			null != localStorage.getItem('pljsuserid')
				...
				1 == v.qualitystore &&
					...
					exist2(v.forbidden_quality) &&
						v.forbidden_quality.indexOf(o.default_quality) > -1 &&
						(o.default_quality = null)),
				1 == v.trackstore &&
					null != localStorage.getItem('pljstrack') &&
					(v.default_audio = localStorage.getItem('pljstrack'))
			for (var t = 0; t < o.vsts.length; t++)
				1 == v['vast_nofirst' + o.vsts[t]] &&
					(null != localStorage.getItem('pljsfirst' + o.vsts[t]) ||
						(v[o.vsts[t] + 's'] = 0))
		...
		;(o.href2 = o.href.substr(o.href.indexOf('://') + 3)),
			...
			o.system.mobile
				...
				: (o.frame.addEventListener('mouseenter', function () {
				  ...
				  o.frame.addEventListener('mouseup', function (t) {
						;(o.mouseDown = !1),
							...
							(o.system.mobile && o.controls.ToolbarHidden()) ||
								(o.controls && o.controls.StageMouseUp(t.clientX, t.clientY)),
							1 == v.hidevideo &&
								o.controls.SettingsVisible() &&
								o.controls.Settings()
				  }),
				  o.frame.addEventListener('mousemove', function (t) {
						exist(o.controls) &&
							(o.mouseDown
								? o.controls.StageMove(t.clientX, t.clientY)
			...
			o.mediacontainer.addEventListener(
				...
				function (t) {
					...
					1 == v.click0timeout) &&
						new Date().getTime() - o.clicktime <
							1e3 * (v.dclckto ? v.dclckto : 0.3) &&
						DoubleClick(t)
					!o.mouseMove && ScreenClick(t), (o.mouseMove = !1), Touch('end', t)
				},
				{ passive: !0 }
			)
		try {
		...
		if (
			(window.document.addEventListener('mousemove', function (t) {
			...
			window.document.addEventListener(
				...
				function (t) {
					o.controls &&
						o.touch &&
						o.controls.StageMove(t.touches[0].pageX, t.touches[0].pageY)
				},
				{ passive: !0 }
			),
			...
			if (
						...
						if (i.indexOf('.') > 0 && o.line_speed) o.actions.SetSpeed(i, 1)
							...
							;-1 == s && (s = o.files_speed.indexOf(1 * i)),
								-1 != s &&
									...
									((o.current_speed = s), o.media.SetSpeed(o.files_speed[s])),
				...
				if (1 == v.sub_designstore)
					for (var a = 0; a < o.sub_options.length; a++)
						null != localStorage.getItem('pljs' + o.sub_options[a]) &&
							((v[o.sub_options[a]] = localStorage.getItem(
								'pljs' + o.sub_options[a]
							)),
							(n = !0))
				o.system.mobile &&
					(n ||
	...
	function ScreenClick(t) {
		if (!(o.moving[o.mediacontainer] > 2)) {
			if (
				...
				var e = 1e3 * (v.dclckto ? v.dclckto : 0.35)
				ClearClick(),
	...
	function ScreenClick2() {
		...
		o.clicks > 1 && 1 == v.hotkey.seeksides
			? (o.clicks = 0)
	...
	function DoubleClick(t) {
		...
		1 == v.hotkey.seeksides &&
			...
			(o.system.mobile
				? (e = t.layerX) ||
				  (t.changedTouches &&
						(e = t.changedTouches[0].pageX - findLeft(o.frame)))
				: (e = t.offsetX),
			e &&
				(e < o.screen_w / 2
					? e < (20 * o.screen_w) / 100 &&
					  ...
					  (i = !0))
					: e > o.screen_w - (20 * o.screen_w) / 100 &&
					  (apiProcessor(
							'seek',
							'+' + existv(v.hotkey.seeksidesec, 10) * o.clicks
					  ),
	...
	function FrameResizer(t) {
		o.screen_lw != o.frame.offsetWidth
			? (t && (o.screen_lw = o.frame.offsetWidth), FrameResizer())
			: MainResize()
	}
	function MainResize() {
		var t = !1
	...
	function MainUpdateSize() {
		...
		if (
			...
			css(o.container, { height: s })
		}
		;(o.aspect > 0 &&
			!o.fullscreen &&
			!o.fullscreen_start &&
			((i = e / o.aspect + existv(v.screenmarginbottom, 0)),
			css(o.container, { height: i })),
		o.fullscreen ||
			o.fullscreen_start ||
			o.fullscreen_process ||
			((o.normal_w = Math.round(e)), (o.normal_h = Math.round(i))),
		o.system.mobile &&
			o.fullscreen &&
			1 == v.landfullmobile &&
			screen.orientation) &&
			(o.aspect > 0 && o.aspect < 1
				? void 0 !== (t = screen.orientation.lock('portrait')) &&
				  t.then(function () {}).catch(function (t) {})
	...
	function Title() {
		for (var t in (o.actions.TitleTemplate(v), v))
			v.hasOwnProperty(t) &&
				0 == t.indexOf('title') &&
				'' != v[t] &&
				((o.maintitle = v[t]), o.actions.Title(t))
		o.mediatags && o.mediatags.read()
	}
	...
	function Logo(t) {
		if (1 == t.on && exist(t.src)) {
			...
			;(t = UpdateObject(t, v.logo)),
				...
				t.position.indexOf('bottom') > -1 && css(e, { bottom: t.marginbottom }),
				t.position.indexOf('right') > -1 && css(e, { right: t.marginright }),
				t.position.indexOf('top') > -1 && css(e, { top: t.margintop }),
				t.position.indexOf('left') > -1 && css(e, { left: t.marginleft }),
